# Checkpoint 28A Round 164 R6 Loop 10 Financial / Capital / Digital

## 목적

`docs/round/round_164.md`의 R6 Loop 10 내용을 별도 calibration pack으로 반영했다.
...
- `src/e2r/sector/round164_r6_loop10_financial_capital_digital.py`
- `src/e2r/cli/build_round164_r6_loop10_report.py`
- `tests/test_round164_r6_loop10_financial_capital_digital.py`
- `data/e2r_case_library/cases_r6_loop10_round164.jsonl`
- `data/sector_taxonomy/score_weight_profiles_round164_r6_loop10_v10.csv`
- `output/e2r_round164_r6_loop10_financial_capital_digital/`
...
- 원문 canonical target 27개와 보조 진단 target 5개를 분리해 보고한다.
...
```bash
PYTHONPATH=src python -m unittest tests/test_round164_r6_loop10_financial_capital_digital.py -v
PYTHONPATH=src python -m e2r.cli.build_round164_r6_loop10_report
```

결과:

- Round 164 전용 테스트 14개 통과
- target 32개 중 원문 canonical target 27개, 보조 overlay target 5개 분리
