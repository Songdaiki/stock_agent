# Checkpoint 28A Round 150 R5 Loop 9 Consumer / Retail / Brand

## 목적

`docs/round/round_150.md`의 R5 Loop 9 내용을 별도 calibration pack으로 반영했다.
...
- `src/e2r/sector/round150_r5_loop9_consumer_retail_brand.py`
- `src/e2r/cli/build_round150_r5_loop9_report.py`
- `tests/test_round150_r5_loop9_consumer_retail_brand.py`
- `data/e2r_case_library/cases_r5_loop9_round150.jsonl`
- `data/sector_taxonomy/score_weight_profiles_round150_r5_loop9_v9.csv`
- `output/e2r_round150_r5_loop9_consumer_retail_brand/`
...
- Stage 2~3 후보: `Samyang Buldak`, `K뷰티 미국 채널`, `APR/Medicube beauty device`, `K뷰티 OEM/ODM`
...
```bash
PYTHONPATH=src python -m unittest tests/test_round150_r5_loop9_consumer_retail_brand.py -v
PYTHONPATH=src python -m e2r.cli.build_round150_r5_loop9_report
```

결과:

- Round 150 전용 테스트 12개 통과
- v9 score profile 생성
- case JSONL 생성
