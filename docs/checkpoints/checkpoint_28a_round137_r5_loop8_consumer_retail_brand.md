# Checkpoint 28A Round 137 R5 Loop 8 Consumer / Retail / Brand

## 목적

`docs/round/round_137.md`의 R5 Loop 8 내용을 별도 calibration pack으로 반영했다.
...
- `src/e2r/sector/round137_r5_loop8_consumer_retail_brand.py`
- `src/e2r/cli/build_round137_r5_loop8_report.py`
- `tests/test_round137_r5_loop8_consumer_retail_brand.py`
- `data/e2r_case_library/cases_r5_loop8_round137.jsonl`
- `data/sector_taxonomy/score_weight_profiles_round137_r5_loop8_v8.csv`
- `output/e2r_round137_r5_loop8_consumer_retail_brand/`
...
```bash
PYTHONPATH=src python -m unittest tests/test_round137_r5_loop8_consumer_retail_brand.py -v
PYTHONPATH=src python -m e2r.cli.build_round137_r5_loop8_report
```

결과:

- Round 137 전용 테스트 12개 통과
- v8 score profile 생성
- case JSONL 생성
