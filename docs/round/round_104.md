좋아. **R11 Loop 5까지 끝났으니, 이번은 R12 Loop 5 — 농업·생활서비스·기타**로 넘어간다.
...
R12 = 농업·생활서비스·기타
Loop 5 목표 =
필수소비·농업·교육·렌탈·무인화·규제형 소비재를
반복 FCF형 사업과 질병/정책/AI/규제 이벤트로 완전히 분리
```
...
| `RIGHT_TO_REPAIR_REGULATORY_OVERLAY`     | RedTeam overlay. 수리 독점·FTC·소송·settlement                  |
...
| `SELF_CHECKOUT_LOCAL_REGULATION_OVERLAY` | RedTeam overlay. 지자체 item limit, 직원 배치 의무, shrink 규제      |
...
| `DISCLOSURE_CONFIDENCE_CAP`              | RedTeam cap. 계약금액·반복매출·해지율·규제승인 detail 부족 시 Stage 3 제한    |
...
## 4-2. Deere / CNH demand cycle — 농기계는 “AI/자율화”보다 농가 capex가 먼저

농기계 수요 둔화는 Deere만의 문제가 아니다. CNH Industrial도 2025년 full-year profit forecast를 낮췄고, 낮은 crop price와 높은 생산비 때문에 농가가 큰 장비 구매를 미루면서 dealer inventory가 높아졌다고 설명했다. 이 케이스는 농기계·정밀농업 관련주에서 기술 narrative보다 **farm income, crop price, financing cost, dealer inventory**를 먼저 봐야 한다는 기준이다. ([Reuters][2])
...
## 4-3. John Deere right-to-repair — software lock-in의 규제 리스크

농기계 software lock-in은 좋아 보이지만, 규제·소송으로 깨질 수 있다. Deere는 repair software와 장비 수리 접근권 문제로 제기된 class action을 해결하기 위해 9,900만 달러 settlement에 합의했고, 10년간 농기계 진단·수리용 digital tools를 제공하기로 했다. 별도로 FTC 소송도 남아 있다. ([Reuters][3])
...
## 4-4. Zoetis 조류독감 백신 — `ANIMAL_HEALTH_BIOSECURITY`

Zoetis는 미국 USDA로부터 가금류 조류독감 백신 조건부 승인을 받았다. 조건부 license는 emergency나 special circumstance에서 safety와 reasonable expectation of efficacy를 근거로 부여되며, USDA는 현재 유행 strain에 맞춘 poultry vaccine stockpile을 재구축하려 했다. 이건 단순 질병 뉴스가 아니라 **조건부 승인 + 정부 비축 가능성**이 붙은 Stage 1~2 후보로 볼 수 있다. ([Reuters][4])
...
## 4-5. Bayer Crop Science — `AGRI_INPUT_SEED_CROP_PROTECTION`

Bayer는 2026년 1분기 조정 EBITDA가 9% 증가한 44.5억 유로로 예상치를 크게 웃돌았고, Crop Science 부문 EBITDA는 soy seed licensing dispute 해결 효과로 17.9% 증가했다. 이 케이스는 종자·작물보호제도 단순 commodity가 아니라 **licensing, 지적재산권, 판가, 농가 ROI, 소송 리스크**가 결합된 구조라는 점을 보여준다. 동시에 Bayer는 Roundup 관련 소송 부담이라는 RedTeam도 갖고 있다. ([Reuters][5])
...
## 4-6. Nutrien / potash — `FERTILIZER_INPUT_COST_CYCLE`

Nutrien은 2025년 북미 농가들이 낮은 crop price에도 비료 사용을 늘릴 것으로 봤고, 2025년 상반기 record potash sales 이후 연간 potash sales 전망을 1,390만~1,450만 metric tons로 올렸다. 회사는 2026년 potash demand도 강할 것으로 봤지만, 이 구조는 Green이라기보다 **농가 yield 보호 수요 + potash supply discipline + crop price 민감도**가 섞인 cycle/Watch다. ([Reuters][6])
...
좋은 점:
- potash 수요 강함
- soil nutrient replenishment 필요
- 공급 증가가 쉽지 않음
- record sales / forecast raise 가능성

주의:
- crop price 약세
- 농가 margin 악화
- input cost spike
- nitrogen/phosphate와 potash 구조 차이
```
...
```text
FERTILIZER_INPUT_COST_CYCLE:
potash는 상대적으로 공급 discipline이 좋을 수 있다.
...
## 4-7. Cal-Maine / 계란 가격 cycle — `AGRI_LIVESTOCK_FOOD_COMMODITY`

계란·육계·양돈주는 질병과 가격 사이클로 이익이 폭발할 수 있지만, 구조적 Green과는 다르다. 2025년 미국에서는 조류독감과 record egg prices 속에서 DOJ가 Cal-Maine 등 주요 egg producers의 price-fixing 가능성을 조사하기 시작했고, 소비자·정책 반발도 같이 붙었다. 즉 가격 상승으로 이익이 좋아질 수는 있어도, 정부조사·가격 정상화·질병 one-off를 반드시 붙여야 한다. ([Político][7])
...
## 4-8. Duolingo — 교육 앱은 성공 후보지만 monetization gate가 핵심

Duolingo는 AI speaking 기능을 더 낮은 요금제와 무료 사용자에게 확대해 user growth를 우선하겠다고 밝혔지만, 2026년 Q1과 연간 bookings 전망이 시장 예상보다 낮아 주가가 23% 이상 하락했다. 이 사례는 교육 앱이 사용자 수와 AI 기능만으로 Green이 아니라, **bookings, paid conversion, AI 기능 비용, margin, FCF**를 통과해야 한다는 기준이다. ([Reuters][8])
...
```text
EDTECH_AI_MONETIZATION_TRADEOFF 신규 강화.
...
## 4-9. Juul FDA 승인 — `CONSUMER_REGULATED_PRODUCT`

Juul은 2025년 7월 FDA로부터 device와 tobacco·menthol flavored refill cartridges 판매 승인을 받았다. 이는 2022년 federal ban 이후 큰 반전이고, FDA가 Juul의 데이터를 검토해 public health 기준에서 marketing authorization이 적절하다고 판단한 사례다. 하지만 허가 범위는 tobacco/menthol 중심이고, youth vaping 논란과 public health regulation은 계속 RedTeam이다. ([Reuters][9])
...
AppHarvest는 hydroponics/vertical farming 기업으로 SPAC 상장했지만, 2023년 Chapter 11 파산보호를 신청했고 greenhouses를 매각했다. 이 사례는 친환경 농업·대형 온실·스마트팜 테마가 실제 생산성, 원가, 노동, 안전, cash flow를 통과하지 못하면 hard 4C가 된다는 기준이다. ([위키백과][12])
...
Chegg는 생성AI가 기존 교육 서비스 비즈니스모델을 직접 잠식한 대표 반례다. Chegg가 ChatGPT가 신규 고객 성장에 영향을 주고 있다고 인정하자 주가가 거의 절반 가까이 급락했고, 이후 교육주 전반에 AI disruption RedTeam 기준을 제공했다. ([Investopedia][13])
...
2U는 온라인 교육·OPM 모델의 대표 반례다. 2U는 2024년 Chapter 11을 신청했고, 부채를 약 9.45억 달러에서 4.59억 달러 수준으로 줄이는 구조조정을 추진했다. WSJ는 2U가 edX 인수, 경쟁 심화, 규제 변화, 높은 레버리지와 상환 압박에 시달렸다고 설명했다. 이 사례는 온라인 교육 플랫폼도 student ROI, CAC, 대학 파트너 집중, 부채, 규제 리스크를 통과하지 못하면 플랫폼이 아니라 credit distress가 된다는 기준이다. ([월스트리트저널][14])
...
Whirlpool은 2026년 1분기 이후 배당을 중단했고, 2026년 EPS 전망을 기존 7달러에서 3~3.50달러로 낮췄으며, free cash flow 전망도 4.5억 달러에서 3억 달러로 낮췄다. Barron’s는 주가가 2021년 고점 대비 80% 넘게 하락했다고 전했다. 이건 hardware 생활가전이 렌탈 반복매출과 전혀 다른 cycle이라는 기준이다. ([Barron's][15])
...
Target은 2024년 전국 약 2,000개 매장에서 self-checkout을 10개 품목 이하 express lane으로 제한하고 staffed lane을 늘리기로 했다. Axios는 self-checkout이 편의성과 인건비 절감을 주지만 mixed feedback과 theft 우려가 있고, 일부 retailer들이 self-checkout을 축소하고 있다고 설명했다. ([Axios][16])

여기에 2026년 Santa Ana 같은 지방정부는 self-checkout에 item limit, staffed lane 유지, 키오스크당 직원 배치 같은 규제를 도입했다. 즉 키오스크·무인화는 hardware 설치대수가 아니라 **retailer ROI, shrink 감소, 고객마찰, local regulation**을 통과해야 한다. ([The Sun][17])
...
WHO는 nicotine pouch 규제가 느슨하면 youth addiction을 키울 수 있다고 경고했고, social influencer, lifestyle branding, youth-oriented event sponsorship 같은 마케팅 리스크를 지적했다. 일부 pouch는 니코틴 함량이 높고 빠른 전달을 설계하며, WHO는 니코틴 함량 제한, 광고 제한, flavor restriction 등을 권고했다. 즉 전자담배·니코틴 대체재는 반복소비 구조가 있어도 public health, youth marketing, flavor regulation을 통과해야 한다. ([Reuters][18])
...
Bowery shutdown과 AppHarvest Chapter 11은 스마트팜이 기술 narrative만으로 Green이 될 수 없다는 기준 반례다. ([Axios][11])
...
Bayer의 soy licensing 효과와 Nutrien의 potash 수요는 좋은 Stage 2 근거가 될 수 있지만, 비료·작물보호제·종자는 각각 농가 ROI, 원재료, crop price, 소송·규제 리스크를 따로 봐야 한다. ([Reuters][5])

---

## 6-4. 조류독감·계란·육계·양돈 4B-watch
...
Cal-Maine 등 주요 계란 업체에 대한 DOJ 조사와 record egg price 논란은 축산 관련주를 구조적 Green으로 오분류하면 안 된다는 기준이다. ([Político][7])

---

## 6-5. AI 교육·성인교육 4B-watch
...
Duolingo는 AI 기능 확대와 user growth를 제시했지만 bookings 전망 부진으로 급락했고, Chegg는 ChatGPT가 핵심 서비스 수요를 훼손한 대표 반례다. ([Reuters][8])
...
Whirlpool 사례처럼 일반 생활가전 hardware cycle은 렌탈 반복매출과 완전히 다른 위험 구조다. ([Barron's][15])

---

## 6-7. 키오스크·셀프체크아웃 4B-watch
...
Target의 10-item self-checkout limit와 Santa Ana의 self-checkout 규제는 self-checkout이 항상 retailer ROI를 높이는 자동화가 아니라는 기준이다. ([Axios][16])

---

## 6-8. 규제형 소비재 4B-watch
...
Juul 승인과 cannabis rescheduling은 모두 Stage를 올릴 수 있는 정책 이벤트지만, public health·허가범위·state/federal conflict가 남아 있다. ([Reuters][9])
...
Bowery와 AppHarvest는 수직농장·스마트팜의 hard 4C 기준이다. ([Axios][11])
...
John Deere의 right-to-repair settlement는 농기계 소프트웨어 lock-in이 규제·소송으로 깨질 수 있음을 보여준다. ([Reuters][3])
...
Bayer Crop Science는 soy licensing 효과로 실적이 좋아질 수 있지만, Roundup litigation과 부채 부담이 동시에 존재한다. 종자·농약은 IP가 강점이지만, 그 IP와 규제·소송이 같은 칼날의 양면이다. ([Reuters][5])
...
Nutrien은 potash 수요가 강한 쪽이지만, 비료 전체는 crop price, farmer margin, nitrogen/phosphate 원재료, 지정학 공급차질에 매우 민감하다. 따라서 비료주는 “식량안보”가 아니라 volume·price·input cost·farmer ROI로 봐야 한다. ([Reuters][6])
...
Chegg는 ChatGPT 충격으로 core service가 직접 훼손된 사례이고, 2U는 온라인 교육 OPM 모델의 부채·규제·경쟁 문제로 Chapter 11에 들어간 사례다. ([Investopedia][13])
...
Whirlpool의 배당 중단과 EPS·FCF 전망 하향은 hardware 생활가전의 대표 4C다. ([Barron's][15])
...
Target의 self-checkout 제한과 Santa Ana의 self-checkout regulation은 키오스크 기업이 설치대수만으로 Stage 3-Green이 될 수 없다는 기준이다. ([Axios][16])
...
Juul은 2022년 ban에서 2025년 승인으로 바뀐 사례이고, cannabis rescheduling도 완전 합법화가 아니라 제한적 정책 변화다. 그래서 규제형 소비재는 승인 전후 모두 hard RedTeam이 필요하다. ([Reuters][9])
...
WHO의 nicotine pouch 경고는 “담배 대체재라서 반복소비 Green”이라는 단순 프레임을 막아야 하는 기준이다. 반복소비가 있어도 youth addiction·flavor·광고·public health gate를 통과해야 한다. ([Reuters][18])

---

# 8. 점수비중 보정표 — R12 Loop 5 / v5.0
...
```text
1. AGRI_MACHINERY_DEMAND_CYCLE을 추가.
   Deere/CNH 사례처럼 자율농기계 기술보다 농가 capex cycle이 먼저다.

2. RIGHT_TO_REPAIR_REGULATORY_OVERLAY를 gate로 강화.
   농기계 software lock-in은 규제·소송으로 깨질 수 있다.

3. EDTECH_AI_MONETIZATION_TRADEOFF를 추가.
   Duolingo처럼 AI 기능 확대가 user growth에는 좋지만 bookings·margin에는 단기 악재가 될 수 있다.

4. SELF_CHECKOUT_LOCAL_REGULATION_OVERLAY를 추가.
   Target 자체 제한뿐 아니라 지방정부 규제가 키오스크 economics를 바꿀 수 있다.

5. NICOTINE_POUCH_YOUTH_SAFETY_OVERLAY를 추가.
   nicotine pouch는 반복소비가 있어도 youth addiction·public health gate가 강하다.

6. CANNABIS_REGULATED_PRODUCT는 Watch 유지.
   Schedule III 부분 조치는 Stage 1~2지만 완전 합법화·FCF 전환은 아니다.

7. VERTICAL_FARMING_UNIT_ECONOMICS는 계속 Red/Watch.
   Bowery/AppHarvest가 hard counterexample이기 때문이다.

8. ANIMAL_HEALTH_BIOSECURITY는 조건부 승인·정부 비축이 붙을 때만 Watch-to-Green.
```
...
## 이번 R12 Loop 5에서 우선 검증할 가격 case
...
| `nutrien_potash_demand_cycle_case`          | 2025-08-07 | fertilizer demand watch, crop margin gate          |
| `calmaine_egg_price_regulatory_case`        | 2025-03~04 | cyclical success + regulatory watch                |
...
| `santa_ana_self_checkout_regulation_case`   |    2026-05 | local regulation overlay                           |
...
R12 Loop 5에서는 아래 필드를 채우게 해야 한다.
...
> Loop 5부터는 특히 `AGRI_MACHINERY_DEMAND_CYCLE`, `RIGHT_TO_REPAIR_REGULATORY_OVERLAY`, `EDTECH_AI_MONETIZATION_TRADEOFF`, `SELF_CHECKOUT_LOCAL_REGULATION_OVERLAY`, `NICOTINE_POUCH_YOUTH_SAFETY_OVERLAY`, `CANNABIS_REGULATED_PRODUCT`, `DISCLOSURE_CONFIDENCE_CAP`을 강한 보정축으로 넣어야 한다.

다음 순서는 **R13 — Cross-archetype RedTeam / 4B / 회계신뢰도 / 가격검증 총정리 Loop 5**다.
...
[2]: https://www.reuters.com/business/machinery-maker-cnh-cuts-full-year-profit-forecast-weak-demand-weighs-2025-11-07/?utm_source=chatgpt.com "Machinery maker CNH cuts full-year profit forecast as weak demand weighs"
[3]: https://www.reuters.com/sustainability/boards-policy-regulation/deere-settles-us-right-to-repair-lawsuit-with-99-million-fund-repair-commitments-2026-04-07/?utm_source=chatgpt.com "Deere settles US right-to-repair lawsuit with $99 million fund, repair commitments"
[4]: https://www.reuters.com/business/healthcare-pharmaceuticals/us-grants-conditional-clearance-zoetis-bird-flu-vaccine-poultry-2025-02-14/?utm_source=chatgpt.com "US gives conditional nod to Zoetis' bird flu vaccine for poultry"
[5]: https://www.reuters.com/business/bayer-q1-operating-profit-up-9-crop-protection-unit-gains-2026-05-12/?utm_source=chatgpt.com "Bayer Q1 operating profit jumps 9% on boost from soy business"
[6]: https://www.reuters.com/business/nutrien-expects-more-fertilizer-use-by-farmers-despite-low-crop-prices-2025-08-07/?utm_source=chatgpt.com "Nutrien expects more fertilizer use by farmers despite low crop prices"
[7]: https://www.politico.com/news/2025/03/07/doj-investigation-egg-price-fixing-bird-flu-00218785?utm_source=chatgpt.com "DOJ opens investigation into egg companies for price-fixing"
[8]: https://www.reuters.com/business/finance/duolingo-prioritizes-user-growth-over-monetization-forecasts-softer-bookings-2026-02-26/?utm_source=chatgpt.com "Duolingo shares drop after bookings outlook lags estimates amid strategy shift"
[9]: https://www.reuters.com/sustainability/boards-policy-regulation/fda-approves-juuls-tobacco-menthol-e-cigarettes-2025-07-17/?utm_source=chatgpt.com "FDA approves Juul's tobacco and menthol e-cigarettes"
[10]: https://www.reuters.com/legal/litigation/cannabis-rescheduling-arrives-with-limits-what-dojs-final-order-does-doesnt-do--pracin-2026-05-12/?utm_source=chatgpt.com "Cannabis rescheduling arrives, with limits: What the DOJ's final order does and doesn't do"
[11]: https://www.axios.com/2024/11/05/bowery-vertical-farming-close?utm_source=chatgpt.com "Vertical farming \"unicorn\" Bowery to shut down"
[12]: https://en.wikipedia.org/wiki/AppHarvest?utm_source=chatgpt.com "AppHarvest"
[13]: https://www.investopedia.com/chegg-shares-plunge-after-company-warns-that-chatgpt-is-impacting-growth-7487968?utm_source=chatgpt.com "Chegg Shares Plunge After Company Warns That ChatGPT Is Impacting Growth"
[14]: https://www.wsj.com/business/2u-ed-tech-company-files-chapter-11-bankruptcy-24ca1017?utm_source=chatgpt.com "2U, Once a Giant in Online Education, Files for Chapter 11 Bankruptcy"
[15]: https://www.barrons.com/articles/whirlpool-stock-falling-outlook-8d0bd413?utm_source=chatgpt.com "Whirlpool Stock Is Still Falling. Last Week's Earnings Might Be Why."
[16]: https://www.axios.com/2024/03/14/self-checkout-target-express-lanes-limit-change?utm_source=chatgpt.com "Exclusive: Target making a big change to self-checkout"
[17]: https://www.the-sun.com/money/16343669/target-self-checkout-limits-santa-ana-california/?utm_source=chatgpt.com "All Target locations hit with checkout change under city's new 'limits policy' - and shoppers have 60 days"
[18]: https://www.reuters.com/legal/litigation/who-warns-loosely-regulated-nicotine-pouches-risk-youth-addiction-2026-05-15/?utm_source=chatgpt.com "WHO warns loosely regulated nicotine pouches risk youth addiction"
