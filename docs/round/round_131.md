좋아. **R11 Loop 7까지 끝났으니, 이번은 R12 Loop 7 — 농업·생활서비스·기타**다.

R12는 양돈·육계·사료·대두, 농기계, 종자·비료·농약, 스마트팜, 참치 원양어업, 교육·취업, 키즈·유아용품, 전자담배, 주정, 생활가전, 키오스크·셀프체크아웃 같은 잡다하지만 테마성이 강한 영역을 흡수한다. Theme Tag Map 기준으로도 R12는 대부분 Watch/Red이고, 실제 수주·반복계약·판가전가·규제 승인·FCF 전환 전까지 Green을 제한해야 한다.

서생원 원칙으로 보면 R12의 질문은 “생활필수라서 좋다”, “농업이라 안정적이다”, “AI 교육이라 성장한다”가 아니다. 핵심은 **EPS/FCF 체급 변화가 실제로 생기고, 시장이 아직 그 변화를 과소평가하는가**다. 질병·곡물·규제·AI 교육·스마트팜·무인화 같은 뉴스는 Stage 1을 만들 수 있지만, 반복매출·unit economics·판가전가·해지율·CAC·규제승인 범위·FCF가 확인돼야 Stage 3다.
...
이번 R12 Loop 7의 핵심 질문은 이거다.

```text
이 기업은 반복계약·반복매출·판가전가·규제승인·FCF가 있는가?
아니면 질병, 날씨, 곡물가격, AI 교육, 무인화, 규제완화 뉴스로만 움직이는가?
```
...
```text
Stage 1:
질병 뉴스, 곡물·계란·육계 가격 급등, 스마트팜·AI 교육·무인화·규제완화·농기계 자율화 뉴스

Stage 2:
실제 수주, 정부계약, 조건부 승인, licensing revenue, B2B/B2G 계약, bookings, recurring service, 규제 승인 확인

Stage 3:
반복매출, unit economics, 판가전가, OPM/FCF, 해지율·CAC 안정, 규제·public health gate 통과, 실제 가격경로 동행

Stage 4B:
스마트팜, AI 교육, 조류독감, 비료, 니코틴 대체재, cannabis 규제완화가 모두에게 알려져 가격이 먼저 간 구간

Stage 4C:
농기계 수요 둔화, right-to-repair 소송, 수직농장 폐쇄, AI가 교육서비스 대체, bookings miss, hardware cycle 붕괴, self-checkout 규제, youth-safety backlash
```
...
### 4-1. Bayer Crop Science — seed licensing/IP가 EBITDA로 연결된 Stage 2 사례

Bayer는 2026년 1분기 adjusted EBITDA가 9% 증가한 44.5억 유로로 시장 예상 39.3억 유로를 크게 웃돌았다. 핵심은 Crop Science 부문이었다. Corteva와의 soy seed licensing dispute 해결 효과로 Crop Science EBITDA가 17.9% 증가해 30억 유로가 됐다. 이건 농업 input이 단순 commodity가 아니라 **seed/IP/licensing 구조**로 EBITDA를 만들 수 있음을 보여준다. 다만 Roundup litigation은 계속 RedTeam이다. ([Reuters][1])
...
가격경로 판정:
WSJ 보도 기준 Bayer 주가는 earnings beat 이후 장중 최대 6.9% 상승했다.
즉 licensing/IP stage가 실제 가격상승과도 맞았다. :contentReference[oaicite:4]{index=4}
```
...
하지만 비료·농약·종자는 한 덩어리가 아니다.
Seed/IP/licensing은 Visibility 가점 가능.
Crop protection은 litigation·regulation 감점.
Fertilizer는 input cycle과 farmer margin을 먼저 본다.
```
...
Nutrien은 2026년 global potash demand가 4년 연속 증가할 수 있다고 봤다. 2025년 큰 작황이 토양 영양분을 소모해 potash 수요를 지지한다는 설명이다. 동시에 phosphate 사업은 높은 북미 가격, 전략광물 지정 가능성, 사업 재편·파트너십·매각 option이 붙어 있다. 다만 이건 Green이라기보다 **비료 가격·작물가격·농가마진·supply discipline이 함께 움직이는 cycle/Watch**다. ([Reuters][2])
...
가격경로 판정:
이 답변에서 즉시 주가 반응은 확정하지 않는다.
하지만 cycle stage로 분류하는 점수표는 유지한다.
```
...
farmer margin과 crop price가 나쁘면 바로 cap.
```
...
Zoetis는 USDA로부터 poultry bird flu vaccine 조건부 승인을 받았다. 조건부 license는 emergency나 special circumstance에서 safety와 reasonable expectation of efficacy를 근거로 부여된다. USDA는 유행 strain에 맞춘 poultry vaccine stockpile을 재구축하려 했고, 이는 단순 질병 뉴스가 아니라 **조건부 승인 + 정부 비축 가능성**이 붙은 Stage 1~2 evidence다. ([Reuters][3])
...
조건부 승인과 정부 비축이 붙으면 Stage 2 후보로 격상한다.
```
...
Juul은 2025년 7월 FDA로부터 tobacco·menthol flavored e-cigarette device와 refill cartridges 판매 승인을 받았다. 이는 2022년 federal ban 이후 큰 반전이고, FDA가 Juul의 자료를 검토한 뒤 public health 기준에서 marketing authorization이 적절하다고 판단한 사례다. 다만 승인 범위는 tobacco/menthol 중심이고, youth vaping·public health risk는 계속 RedTeam이다. ([Reuters][4])
...
가격경로 판정:
규제 승인 자체는 Stage 2 evidence.
하지만 허가 범위와 public health gate 전까지 Stage 3 금지.
```
...
2026년 4월 DOJ와 DEA는 일부 cannabis-related substances를 Schedule I에서 Schedule III로 재분류했다. 하지만 이 조치는 FDA-approved cannabis products와 state-licensed medical cannabis 중심의 제한적 조치이고, 연방 차원의 완전 합법화가 아니다. 의료 cannabis 사업자에는 280E 세금 부담 완화 같은 효과가 있을 수 있지만, recreational operator는 직접 수혜가 제한되고 DEA registration과 state/federal conflict가 남는다. ([Reuters][5])
...
가격경로 판정:
규제완화 뉴스는 stage를 올릴 수 있지만,
완전 합법화로 오분류하면 false-positive.
```
...
### 5-1. Deere / CNH — 자율농기계 기술보다 농가 capex cycle이 먼저다

CNH Industrial은 2025년 full-year profit forecast를 낮췄고, 낮은 crop price와 높은 생산비 때문에 농가가 큰 장비 구매를 미루면서 dealer inventory가 높아졌다고 설명했다. 발표 후 주가는 7.1% 하락했다. 2026년에도 CNH는 농기계 수요 둔화로 조정 EPS 가이던스를 시장 예상보다 낮게 제시했고, retail demand가 2025년 대비 약 5% 감소할 것으로 봤다. ([Reuters][6]) ([Reuters][7])
...
farm_income, crop_price, financing_cost, dealer_inventory가 먼저다.
```
...
Deere는 농업장비 right-to-repair class action에서 9,900만 달러 settlement fund와 10년간 digital repair tools 제공을 약속했다. 별도로 FTC 소송도 남아 있다. 이건 농기계 software lock-in이 좋아 보여도 수리독점·dealer network·regulatory scrutiny가 thesis를 깨뜨릴 수 있음을 보여준다. ([Reuters][8])

더 나아가 right-to-repair 리스크는 농기계에서 건설·임업장비로 확장되고 있다. Chicago-based landscaping firm이 Deere의 construction/forestry equipment repair software 접근 제한을 문제 삼아 새 소송을 제기했고, 이는 농업장비 소송과 유사한 구조다. ([월스트리트저널][9])
...
Bowery는 7억 달러 이상을 조달한 vertical farming unicorn이었지만 2024년 폐쇄됐다. Axios는 Bowery가 AeroFarms와 AppHarvest 같은 실패 사례를 뒤따랐고, 소비자가 “cleaner produce”에 충분한 premium을 지불하지 않았다고 설명했다. 수직농장은 기술적으로 좋아 보여도 전력비·CAPEX·가격 프리미엄·수율·수요가 맞지 않으면 hard 4C로 간다. ([Axios][10])
...
Cal-Maine은 조류독감에 따른 record egg price 속에서 DOJ antitrust division의 가격조사 대상이 됐다. 3분기 매출은 계란가격 급등 덕분에 전년 대비 거의 두 배인 14.2억 달러였지만, EPS 10.38달러는 기대치를 살짝 밑돌았고, 조사 뉴스 이후 주가는 after-hours에서 4% 넘게 하락했다. ([AP News][11])
...
질병·가격 급등 후 price investigation flag가 켜지면 Stage 3-Green 차단.
```

---

### 5-5. Duolingo — AI 기능 확대가 bookings·margin과 충돌하면 stage 실패

Duolingo는 AI-powered speaking features를 더 낮은 요금제와 무료 사용자에게 확대해 user growth를 우선하겠다고 밝혔다. 하지만 Q1과 full-year 2026 bookings 전망이 시장 예상보다 낮았고, 주가는 23% 넘게 하락했다. Reuters는 AI access 비용과 마케팅 확대 때문에 adjusted core profit margin도 25%로 낮아질 것이라고 보도했다. ([Reuters][12])

```text
case_type:
EDTECH_AI_MONETIZATION_TRADEOFF_4C_WATCH

stage 포착:
Stage 1 = AI tutor / AI speaking / user growth narrative
Stage 2 = AI feature rollout
Stage 실패 = bookings miss, monetization 후퇴, margin 압박
가격경로 = -23% 이상

가격경로 판정:
AI 기능 확대가 실제 주가하락과 연결됐다.
AI 기능은 가점이 아니라 monetization gate를 통과해야 한다.
```

**정규화 결론**

```text
EDTECH_AI_MONETIZATION_TRADEOFF에서 AI 기능은 Stage 1.
Stage 3는 bookings, paid conversion, margin, FCF가 같이 유지될 때만.
```

---

### 5-6. Chegg / 2U — AI 대체와 OPM 부채모델 붕괴

Chegg는 ChatGPT가 신규 고객 성장에 영향을 준다고 인정한 뒤 주가가 거의 50% 급락했다. 이는 AI가 교육서비스의 핵심 기능을 직접 대체한 hard 4C다. ([Investopedia][13])

2U는 온라인 교육·OPM 모델의 대표 반례다. 2U는 Chapter 11을 신청했고, 부채를 9.45억 달러에서 약 4.59억 달러로 줄이는 구조조정을 추진했다. 한때 50억 달러 이상이던 market value는 약 1,150만 달러 수준까지 떨어졌다. ([월스트리트저널][14])
...
### 5-7. Whirlpool — 생활가전 hardware cycle은 렌탈 반복매출과 완전히 다르다

Whirlpool은 2026년 1분기 실적 부진 이후 분기 배당 90센트를 중단했고, 2026년 EPS 전망을 7달러에서 3~3.50달러로 낮췄으며, free cash flow 전망도 4.5억 달러에서 3억 달러로 낮췄다. 주가는 52주 신저가를 기록했고, 2021년 고점 대비 83.8% 하락한 상태였다. ([Barron's][15])

별도 보도 기준 실적 직후 주가는 약 12% 급락했다. ([Barron's][16])
...
Stage 4C = dividend suspension, EPS guide cut, FCF guide cut, 52-week low
가격경로 = 실적 후 약 -12%, 장기 고점 대비 -83.8%
...
```text
HOME_LIVING_APPLIANCE_RENTAL은 렌탈 계정·해지율·관리서비스가 있으면 Watch-to-Green.
HOME_APPLIANCE_HARDWARE_CYCLE은 교체수요·주택경기에 묶이면 Watch/Red.
```

---

### 5-8. 셀프체크아웃 — 설치대수보다 theft·고객불만·지자체 규제

Santa Ana는 2026년 6월부터 food/drug retailer에 self-checkout 15개 품목 제한, staffed checkout lane 유지, self-checkout 3대당 직원 1명 모니터링을 요구하는 ordinance를 시행한다. Target도 이미 self-checkout에 10개 품목 제한을 테스트한 바 있다. 이건 키오스크·무인화가 항상 ROI를 높이는 자동화가 아니라는 기준이다. ([The Sun][17])
...
Stage 3는 maintenance revenue, payment fee, shrink 감소, retailer retention이 필요하다.
```

---

### 5-9. Nicotine pouch youth-safety — 반복소비라도 public health gate를 통과해야 한다

WHO는 2026년 5월 nicotine pouch 규제가 느슨하면 youth addiction을 키울 수 있다고 경고했다. WHO는 social media influencer, lifestyle branding, youth-oriented event sponsorship, flavor·packaging, 높은 니코틴 함량을 핵심 리스크로 봤고, 니코틴 함량 제한, 광고 제한, flavor restriction을 권고했다. ([Reuters][18])
...
이번 R12 Loop 7부터 기본 점수표는 아래처럼 재정규화한다.
...
3. unit economics·판가전가·수요 지속성        18점
   ...
   - farmer margin
4. 시장 오해·리레이팅 gap                    8점
5. valuation room / 4B 여지                   6점
6. capital discipline / debt / cash runway     10점
7. 규제·소송·public health·disclosure          16점
...
Duolingo AI feature rollout, 단 bookings miss로 실패
```
...
예:
이번 R12 Loop 7에서는 확정 Stage 3 후보는 제한적.
...
| Nutrien potash/phosphate          | Stage 1~2 Watch |                         즉시 가격 미확정 | cycle 분류 유지                           | farmer margin gate 유지               |
| Zoetis bird flu vaccine           |       Stage 1~2 |                    price-path 미확정 | 조건부 승인·stockpile 후보                   | government order 전 Stage 3 제한       |
| CNH weak demand                   |        4C-watch |                          주가 -7.1% | 농기계 cycle RedTeam 잘 맞음                | farm income/dealer inventory 가중치 상향 |
| Deere right-to-repair             |        4C-watch |                   $99m settlement | software lock-in gate 강화              | right-to-repair hard overlay        |
...
| Duolingo                          |        4C-watch |                           -23% 이상 | AI 기능 vs monetization trade-off 잘 맞음  | bookings/margin 가중치 상향              |
| Chegg                             |         hard 4C |                            약 -50% | AI core-service disruption 매우 강함      | education AI disruption hard gate   |
| 2U                                |         hard 4C | Chapter 11, market value collapse | OPM debt model 반례                     | leverage/student ROI 가중치 상향         |
| Whirlpool                         |         hard 4C |         실적 후 약 -12%, 고점 대비 -83.8% | hardware cycle RedTeam 매우 잘 맞음        | hardware cycle 감점 강화                |
...
| Cannabis Schedule III             |       Stage 1~2 |              partial rescheduling | 완전합법화 오분류 방지                          | partial limit overlay 유지            |

---

### 6-3. R12 Loop 7 점수비중 재조정
...
### 6-4. R12 Loop 7 archetype별 최종 stage 규칙
...
Stage 4C = crop price 하락, demand deferral, input cost spike
```
...
Stage 2 = AI feature rollout·engagement
...
Duolingo = AI 기능 확대에도 bookings miss, -23% 이상
Chegg = ChatGPT core-service disruption, 약 -50%
2U = Chapter 11, OPM debt model 붕괴
Whirlpool = dividend suspension·guidance cut, 실적 후 약 -12%
Santa Ana = self-checkout local regulation
WHO nicotine pouch = youth-safety warning
```

**R12 Loop 7 점수정규화의 핵심 문장:**
...
> 이번 Loop 7에서는 `Bayer`, `Zoetis`, `Juul`, `Cannabis partial rescheduling`이 Stage 1~2 포착 사례이고, `CNH`, `Deere`, `Bowery`, `Cal-Maine`, `Duolingo`, `Chegg`, `2U`, `Whirlpool`, `self-checkout regulation`, `nicotine pouch warning`이 R12 RedTeam이 실제 가격·사업경로와 맞는 반례다.

다음 순서는 **R13 — Cross-archetype RedTeam / 4B / 회계신뢰도 / 가격검증 총정리 Loop 7**다.
...
[2]: https://www.reuters.com/business/nutrien-expects-higher-global-potash-demand-eyes-future-its-phosphate-business-2025-11-06/?utm_source=chatgpt.com "Nutrien expects higher global potash demand, eyes future of its phosphate business"
...
[4]: https://www.reuters.com/sustainability/boards-policy-regulation/fda-approves-juuls-tobacco-menthol-e-cigarettes-2025-07-17/?utm_source=chatgpt.com "FDA approves Juul's tobacco and menthol e-cigarettes"
[5]: https://www.reuters.com/legal/litigation/cannabis-rescheduling-arrives-with-limits-what-dojs-final-order-does-doesnt-do--pracin-2026-05-12/?utm_source=chatgpt.com "Cannabis rescheduling arrives, with limits: What the DOJ's final order does and doesn't do"
[6]: https://www.reuters.com/business/machinery-maker-cnh-cuts-full-year-profit-forecast-weak-demand-weighs-2025-11-07/?utm_source=chatgpt.com "Machinery maker CNH cuts full-year profit forecast as weak demand weighs"
[7]: https://www.reuters.com/business/cnh-industrial-flags-weak-2026-profit-sluggish-farm-machinery-demand-2026-02-17/?utm_source=chatgpt.com "CNH Industrial flags weak 2026 profit on sluggish farm machinery demand"
[8]: https://www.reuters.com/sustainability/boards-policy-regulation/deere-settles-us-right-to-repair-lawsuit-with-99-million-fund-repair-commitments-2026-04-07/?utm_source=chatgpt.com "Deere settles US right-to-repair lawsuit with $99 million fund, repair commitments"
[9]: https://www.wsj.com/business/right-to-repair-advocates-are-taking-on-deere-againthis-time-in-construction-a93aa654?utm_source=chatgpt.com "Right-to-Repair Advocates Are Taking On Deere Again-This Time in Construction"
[10]: https://www.axios.com/2024/11/05/bowery-vertical-farming-close?utm_source=chatgpt.com "Vertical farming \"unicorn\" Bowery to shut down"
[11]: https://apnews.com/article/62e581aca199912082c2a06b211248ab?utm_source=chatgpt.com "US egg giant Cal-Maine says government is investigating price increases"
[12]: https://www.reuters.com/business/finance/duolingo-prioritizes-user-growth-over-monetization-forecasts-softer-bookings-2026-02-26/?utm_source=chatgpt.com "Duolingo shares drop after bookings outlook lags estimates amid strategy shift"
...
[16]: https://www.barrons.com/articles/whirlpool-stock-price-earnings-dividend-suspended-95e6cf39?utm_source=chatgpt.com "Whirlpool Earnings Were So Bad It Suspended Its Dividend"
