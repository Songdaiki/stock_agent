좋아. **R6 Loop 7까지 끝났으니, 이번은 R7 Loop 7 — 바이오·헬스케어·의료기기**다.
...
서생원식으로 보면 R7의 질문은 “허가를 받았나?”, “임상이 좋았나?”, “AI 모델 성능이 높나?”가 아니다. 핵심은 **허가·임상·논문·AI 성능이 실제 처방, 보험, 수가, 반복시술, 계약, 매출, FCF로 넘어가서 EPS 체급과 밸류에이션 프레임을 바꾸는가**다. 즉 승인과 논문은 시작점이고, 상업화와 반복 현금흐름이 없으면 Stage 3가 아니다.
...
medical AI external validation / device safety를

stage 포착 + 실제 가격경로 + 점수비중 재조정으로 다시 정규화
```

이번 R7 Loop 7의 핵심 질문은 이거다.
...
```text
Stage 1:
임상 결과, FDA/EMA 승인 기대, AI 의료 논문, CDMO capacity, GLP-1 TAM, 바이오시밀러 허가, 의료기기 출시 뉴스

Stage 2:
승인, 고객계약, 생산시설, PBM/보험 등재, 처방량, procedure growth, hospital adoption, 매출 가이던스 확인

Stage 3:
실제 처방·매출·OPM·FCF·반복소모품·보험/수가·재주문이 확인되고 가격경로가 동행

Stage 4B:
모두가 GLP-1, 수술로봇, CDMO, 의료AI, 바이오시밀러 수혜를 인정해 valuation이 먼저 간 구간

Stage 4C:
승인 후 uptake 실패, 보험·수가 실패, cash crunch, funding crunch, 가격전쟁, compounded drug 단속, patent litigation, safety issue
```
...
| `CRO_FUNDING_CYCLE_OVERLAY`                 | hard/soft RedTeam    | biotech funding crunch, forecast cut                      |
...
Samsung Biologics는 GSK로부터 미국 Maryland Rockville 소재 Human Genome Sciences 생산시설을 2.8억 달러에 인수하기로 했고, 이 시설은 60,000L drug substance capacity를 보유한다. 이 인수는 Samsung Biologics의 첫 미국 생산거점이고, 미국 수요 대응과 potential tariff hedge 의미가 있다. 다만 발표 직후 Samsung Biologics 주가는 0.4% 하락해, 같은 날 broader market의 2% 상승을 밑돌았다. 즉 이건 **전략적 Stage 2 evidence는 강하지만 가격경로는 아직 Stage 3로 확인되지 않은 케이스**다. ([Reuters][1])
...
### 4-2. Intuitive Surgical — 수술로봇 installed base가 반복소모품으로 넘어간 Stage 2→3 정석 사례

Intuitive Surgical은 R7에서 서생원식 구조에 가장 가까운 의료기기 사례다. 2026년 1분기 da Vinci와 Ion procedure가 전년 대비 17% 증가했고, 매출은 23% 증가한 27.7억 달러, 조정 EPS는 2.50달러로 예상치를 웃돌았다. 회사는 2026년 procedure growth guidance도 13.5~15.5%로 올렸고, 실적 후 주가는 7.2% 상승했다. Procedure growth는 instruments/accessories 반복매출과 직접 연결되기 때문에, 이 케이스는 **installed base → procedure growth → recurring consumables → EPS/FCF visibility**가 맞물린다. ([Investors][2])
...
Stage 3 = instruments/accessories 반복매출 + guidance 상향 + 주가 +7.2%
Stage 4B-watch = medtech valuation, GLP-1에 따른 bariatric slowdown risk

가격경로 판정:
점수표가 Stage 2→3를 잘 잡았다.
procedure growth가 실제 주가 상승과 맞았다.
```
...
Eli Lilly의 oral GLP-1 비만치료제 Foundayo, 즉 orforglipron은 2026년 4월 FDA 승인을 받았고, trial participants는 12~15% 체중감량을 보였다. Foundayo는 LillyDirect에서 월 149달러부터 시작하고, 승인 뉴스 후 Lilly 주가는 6% 상승했다. 하지만 이건 아직 Stage 2다. Stage 3는 weekly scripts, insurance coverage, gross-to-net, refill rate, OP/EPS revision으로 확인해야 한다. ([Reuters][3])

이후 유지요법 데이터도 Stage 2 근거를 강화한다. Reuters는 Wegovy에서 Foundayo로 전환한 환자가 1년 뒤 평균 2파운드만 회복했고, Zepbound에서 전환한 환자는 평균 11파운드 회복했다고 보도했다. 52주차 기준 semaglutide 전환군은 기존 감량의 79.3%, tirzepatide 전환군은 74.7%를 유지했다. 이 데이터는 “injection-to-pill maintenance therapy” thesis를 강화하지만, 여전히 실제 처방량과 보험·가격이 Stage 3 gate다. ([Reuters][4])
...
Stage 2 = FDA approval, launch price, Lilly +6%, maintenance data
...
Humira biosimilar는 R7에서 “허가만으로 부족하고 PBM·보험·처방전환이 핵심”이라는 기준을 만든다. Cigna는 Accredo specialty pharmacy를 통해 Humira biosimilar를 eligible patients에게 out-of-pocket $0로 제공하겠다고 했고, biosimilar 가격은 Humira 월 list price 대비 약 85% 낮은 수준이었다. Reuters는 Humira 시장에서 AbbVie가 biosimilar 출시 이후에도 98% 이상 점유율을 유지했고, biosimilar adoption이 느렸다고 보도했다. ([Reuters][5])

GoodRx와 Boehringer Ingelheim도 Humira biosimilar를 list price 대비 92% 할인된 현금가로 제공했다. 그러나 Reuters는 Boehringer의 Cyltezo가 5월 기준 약 2,500건 처방에 그친 반면 Humira는 60만 건 이상이었다고 보도했다. 즉 가격할인과 interchangeability는 Stage 2 근거지만, Stage 3는 실제 prescription volume과 margin 방어가 필요하다. ([Reuters][6])
...
Novo Nordisk는 GLP-1 시장의 대표 성장기업이었지만, 2026년 sales와 operating profit이 5~13% 감소할 수 있다고 경고했다. 원인은 미국 가격 압박, 경쟁 심화, semaglutide 특허 만료, copycat drug 압박이었다. Reuters는 이 경고 이후 Novo의 미국 상장주가 12% 하락했다고 보도했다. ([Reuters][8])

다음 날 Reuters는 Novo Nordisk 주가가 16% 급락했고 약 500억 달러 시가총액이 사라졌다고 보도했다. 이건 거대한 TAM과 기존 고성장도 가격·경쟁·보험·copycat 압박 앞에서는 Stage 4C로 내려갈 수 있다는 기준이다. ([Reuters][9])
...
Hims & Hers는 compounded GLP-1에서 branded Wegovy 등으로 전환하면서 2026년 1분기 예상 밖 손실을 냈고, 주가는 11% 하락했다. Reuters는 semaglutide ingredient write-down, legal fee, merger-related cost, revenue recognition timing, compounded drug에서 branded drug으로의 pivot 비용이 손실에 영향을 줬다고 보도했다. ([Reuters][10])

또 Hims는 FDA가 compounded GLP-1 drug의 품질·안전·법적 문제를 지적하고 단속을 예고한 뒤, compounded semaglutide pill 판매를 중단하기로 했다. HHS가 DOJ referral 가능성을 언급한 것도 함께 보도됐다. 이건 GLP-1 수요가 아무리 커도 유통채널이 회색이면 Stage 3-Green을 막아야 한다는 기준이다. ([Reuters][11])
...
Stage 4C-watch = FDA crackdown, DOJ referral, loss, legal cost, revenue recognition issue
가격경로 = -11% 이상
...
Bluebird bio는 승인된 gene therapy를 갖고 있었지만 severe cash crunch로 Carlyle과 SK Capital에 주당 3달러에 비상장화되기로 했다. 이 가격은 직전 종가 대비 57.4% 할인된 수준이었고, 발표 후 주가는 36% 하락했다. Reuters는 Bluebird가 세 개의 commercial gene therapy를 보유했지만 uptake가 느렸고, 2024년 11월 기준 세 제품 전체에서 치료를 시작한 환자가 57명이라고 보도했다. ([Reuters][12])
...
Charles River Laboratories는 biotech 고객들의 funding crunch가 이어지면서 2024년 연간 전망을 낮췄고, 주가는 premarket에서 15% 하락했다. 회사는 drug discovery·development service 수요가 하반기에 개선될 것으로 보지 않는다고 밝혔고, 연간 adjusted profit 전망과 revenue 전망도 낮췄다. ([Reuters][13])
...
Teladoc은 BetterHelp 관련 7.9억 달러 impairment를 기록하고 연간·장기 전망을 철회했으며, 주가는 13% 하락해 record low를 기록했다. Reuters는 BetterHelp revenue decline과 customer acquisition expense 증가가 핵심 문제라고 보도했다. ([Reuters][14])
...
Stage 2 = 사용자 기반·매출
Stage 4C = impairment, CAC increase, forecast withdrawal
가격경로 = -13%, record low
...
Amgen은 Samsung Bioepis의 Prolia/Xgeva biosimilar에 대해 34개 특허 침해를 주장하며 소송을 제기했다. Amgen은 biosimilar 생산·판매 금지와 손해배상을 요구했고, Prolia와 Xgeva의 미국 매출은 전년 기준 42억 달러 이상이었다. 이건 biosimilar가 FDA 신청·허가 단계에 있어도 patent litigation이 launch timing과 economics를 흔들 수 있음을 보여준다. ([Reuters][15])
...
FDA는 Botox와 유사한 counterfeit 또는 unapproved injectable wrinkle-smoothing products를 판매한 18개 웹사이트에 warning letters를 보냈다. AP는 FDA가 injury report와 toxic side effects 이후 조치했고, Botox류 제품은 호흡·삼킴에 영향을 줄 수 있는 boxed warning을 가진다고 보도했다. ([AP News][16])
...
이번 R7 Loop 7부터 기본 점수표는 아래처럼 재정규화한다.
...
6. cash runway·capital discipline         10점
7. 안전·규제·disclosure confidence       12점
...
예:
Intuitive Surgical은 Stage 2→3 포착이 가격상승과 잘 맞음.
...
| Intuitive Surgical             |     Stage 2→3 |                      주가 +7.2% | 매우 잘 맞음                                   | procedure/consumables 가중치 상향        |
| Lilly Foundayo approval        |       Stage 2 |                     Lilly +6% | approval stage 포착 맞음                      | scripts·보험 전 Stage 3 제한             |
| Lilly maintenance data         |    Stage 2 강화 |             price backfill 필요 | thesis 강화, 아직 commercial gate             | refill/adherence field 추가           |
...
| Hims & Hers                    |      4C-watch |                     -11%~-12% | telehealth GLP-1 RedTeam 잘 맞음             | CAC/regulatory hard gate            |
...
| Teladoc                        |       hard 4C |              -13%, record low | CAC/impairment gate 잘 맞음                  | DTC telehealth 감점 강화                |
...
| 반복소모품                 |        중요 |                       상향. Intuitive가 가격경로로 확인 |
...
### 6-4. R7 Loop 7 archetype별 최종 stage 규칙
...
Stage 4C = FDA crackdown, DOJ referral, legal cost, revenue recognition shock
```
...
```text
Stage 포착이 잘 맞은 사례:
Intuitive Surgical = procedure growth + recurring instruments/accessories → 주가 +7.2%
Lilly Foundayo = FDA approval + launch price → Lilly +6%, 단 Stage 2
Cigna/GoodRx Humira biosimilar = PBM/formulary/access Stage 2
Lunit DBT = external validation Stage 1~2

RedTeam이 가격경로와 잘 맞은 사례:
Novo Nordisk = price war / competition warning → -12%~-16%, 약 $50B 시총 감소
Hims & Hers = compounded GLP-1 / branded pivot cost → -11%~-12%
Bluebird bio = 승인 후 상업화 실패·cash crunch → -36%
Charles River = CRO funding crunch → premarket -15%
Teladoc = BetterHelp impairment·CAC → -13%, record low
Amgen–Samsung Bioepis = biosimilar patent litigation
Botox counterfeit = device/aesthetic safety gate
```

**R7 Loop 7 점수정규화의 핵심 문장:**
...
> 이번 Loop 7에서는 `Intuitive Surgical`이 Stage 2→3와 가격상승이 가장 잘 맞은 사례이고, `Lilly Foundayo`는 approval Stage 2는 맞지만 scripts·보험 전까지 Stage 3 제한이며, `Novo`, `Hims`, `Bluebird`, `Charles River`, `Teladoc`은 R7 RedTeam이 실제 주가하락과 잘 맞은 반례다.

다음 순서는 **R8 — 플랫폼·콘텐츠·SW·보안 Loop 7**다.
...
[3]: https://www.reuters.com/business/healthcare-pharmaceuticals/lillys-weight-loss-pill-wins-us-approval-2026-04-01/?utm_source=chatgpt.com "Lilly's weight-loss pill wins US approval, sets up next battle with rival Novo Nordisk"
...
[5]: https://www.reuters.com/business/healthcare-pharmaceuticals/cigna-offer-humira-rivals-with-0-copay-specialty-pharmacy-2024-04-25/?utm_source=chatgpt.com "Cigna to offer Humira rivals with $0 copay at specialty pharmacy"
[6]: https://www.reuters.com/business/healthcare-pharmaceuticals/boehringer-goodrx-partner-offer-humira-rival-92-discount-2024-07-18/?utm_source=chatgpt.com "Boehringer-GoodRx partner to offer Humira rival at 92% discount"
