좋아. **R6 Loop 10까지 끝났으니, 이번은 R7 Loop 10 — 바이오·헬스케어·의료기기**다.

R7은 CDMO, CMO, 원료의약품, CRO, 바이오시밀러, 의료AI, 원격의료, 유전체검사, AI 신약개발, 이중항체, 세포치료제, 줄기세포, 치매·비만·탈모 치료제, 보톡스, 임플란트, 미용기기, 수술로봇, 전염병 진단을 흡수한다. 이 대섹터는 크게 세 갈래로 나눠야 한다. **pre-revenue biotech은 Green 거의 금지**, **royalty/commercialization biotech은 실제 매출화·로열티 필요**, **CDMO/medical device는 장기계약·반복매출이면 Green 가능**이다.
...
Intuitive Surgical은 R7에서 가장 서생원식에 가까운 의료기기 구조다. 2026년 1분기 da Vinci·Ion procedure는 전년 대비 17% 증가했고, 매출은 23% 증가한 27.7억 달러, 조정 EPS는 2.50달러로 예상치를 웃돌았다. 회사는 2026년 procedure growth guidance도 13.5~15.5%로 올렸고, 정규장 주가는 7.2% 상승했다. 이건 단순 장비 판매가 아니라 **installed base → procedure growth → instruments/accessories 반복매출 → EPS/FCF visibility**로 이어지는 구조다. ([Investors][2])
...
Eli Lilly의 oral GLP-1 비만치료제 Foundayo, 즉 orforglipron은 2026년 4월 미국 FDA 승인을 받았고, Reuters 기준 Lilly 주가는 승인 소식에 6% 상승했다. Foundayo는 once-daily oral GLP-1로, 식사·물 섭취 제한 없이 복용 가능하다는 점이 Wegovy pill 대비 차별점으로 제시됐고, LillyDirect를 통해 월 149달러부터 launch한다고 보도됐다. 이건 `ORAL_GLP1_APPROVAL_COMMERCIALIZATION`의 Stage 2 포착이 가격경로와 맞은 사례다. ([Reuters][4])

maintenance therapy 데이터도 Stage 2 근거를 강화한다. Reuters는 injectable Wegovy에서 Foundayo로 전환한 환자는 1년 뒤 평균 2파운드만 회복했고, Zepbound에서 전환한 환자는 평균 11파운드 회복했다고 보도했다. 52주차 기준 기존 semaglutide 사용자는 감량분의 79.3%, tirzepatide 사용자는 74.7%를 유지했다. 하지만 실제 Stage 3는 weekly scripts, 보험, gross-to-net, refill rate, OP/EPS가 확인돼야 한다. ([Reuters][5])
...
Stage 2 = FDA approval, launch price, Lilly 주가 반응, maintenance data
...
하지만 approval과 초기 clinical/commercial evidence만으로 Stage 3로 올리면 안 된다.
```
...
Humira biosimilar는 R7에서 “허가만으로 부족하고 PBM·보험·처방전환이 핵심”이라는 기준을 만든다. Cigna의 Evernorth는 Accredo specialty pharmacy를 통해 eligible patients에게 Humira biosimilar를 out-of-pocket $0로 제공하겠다고 했고, 이 biosimilar 가격은 Humira list price 대비 약 85% 낮은 수준이었다. ([월스트리트저널][6])
...
The Guardian도 Novo가 2026년 매출 감소를 전망했고, 주가가 하루 17% 하락했으며 1년 기준으로도 큰 폭의 조정을 받았다고 보도했다. 즉 거대한 TAM과 기존 고성장도 가격·경쟁·보험·copycat 압박 앞에서는 Stage 4C로 내려갈 수 있다. ([가디언][10])
...
Hims & Hers는 compounded GLP-1에서 branded Wegovy 등으로 전환하면서 2026년 1분기 예상 밖 손실을 냈고, Reuters 기준 주가는 11% 하락했다. semaglutide ingredient write-down, legal fee, merger-related cost, revenue recognition timing, compounded drug에서 branded drug으로의 pivot 비용이 손실에 영향을 줬다. ([Reuters][11])

Barron’s 기준으로는 Hims 주가가 14.6% 하락했고, 회사가 매출 전망은 올렸지만 GLP-1 전략 전환으로 단기 수익성 가시성이 흔들렸다고 설명했다. 즉 GLP-1 수요가 아무리 커도 유통채널이 회색이면 Stage 3-Green을 막아야 한다. ([Barron's][12])
...
Teladoc은 BetterHelp 관련 7.9억 달러 goodwill impairment를 기록했고, BetterHelp revenue는 9% 감소했다. 회사는 2024년 guidance를 철회했고, MarketWatch 기준 주가는 extended session에서 15% 이상 하락했다. ([마켓워치][15])

Reuters도 Teladoc이 연간·장기 전망을 철회한 뒤 주가가 record low를 기록했고, BetterHelp의 광고비·고객획득비 증가와 매출 감소가 핵심 압박이었다고 보도했다. 즉 DTC telehealth가 사용자 수 narrative만으로 Green이 될 수 없고, CAC·retention·impairment·FCF를 통과해야 한다. ([Reuters][16])
...
R7 Loop 10부터 기본 점수표는 이렇게 재정규화한다.
...
3. 안전·규제·disclosure confidence       16점
...
| Lilly Foundayo approval        |       Stage 2 |                 FDA approval 후 Lilly 주가 +6% | approval stage 포착 맞음                      | scripts·보험 전 Stage 3 제한             |
...
| Teladoc                        |       hard 4C |               extended -15% 이상 / record low | CAC/impairment gate 잘 맞음                  | DTC telehealth 감점 강화                |
...
### 6-4. R7 Loop 10 archetype별 최종 stage 규칙
...
Lilly Foundayo = FDA approval + maintenance data, Stage 2
...
> 이번 Loop 10에서는 `Intuitive Surgical`, `Lilly Foundayo`, `Samsung Biologics`, `Humira biosimilar access`, `Lunit DBT validation`이 Stage 1~2 이상을 포착할 수 있는 사례이고, `Novo`, `Hims`, `Bluebird`, `Charles River`, `Teladoc`, `biosimilar patent litigation`, `Botox counterfeit`이 R7 RedTeam이 실제 가격·사업경로와 맞는 반례다.

다음 순서는 **R8 — 플랫폼·콘텐츠·SW·보안 Loop 10**다.
...
[3]: https://www.barrons.com/articles/intuitive-surgical-earnings-stock-price-dd043033?utm_source=chatgpt.com "Intuitive Surgical Earnings Show Big Beats Don't Always Spark Stock Rallies"
...
[6]: https://www.wsj.com/articles/cigna-s-evernorth-to-offer-humira-biosimilar-without-out-of-pocket-fee-dbb7cb30?utm_source=chatgpt.com "Cigna's Evernorth to Offer Humira Biosimilar Without Out-of-Pocket Fee"
...
[10]: https://www.theguardian.com/business/2026/feb/04/wegovy-ozempic-forecast-revenue-share-price-drop?utm_source=chatgpt.com "Wegovy and Ozempic maker forecasts sharp drop in revenue for 2026"
...
[16]: https://www.reuters.com/business/healthcare-pharmaceuticals/teladoc-shares-hit-record-low-after-telehealth-firm-withdraws-2024-forecast-2024-08-01/?utm_source=chatgpt.com "Teladoc shares hit record low after telehealth firm withdraws 2024 forecast"
[17]: https://www.reuters.com/legal/litigation/amgen-sues-samsung-biotech-unit-over-bone-drug-copies-2024-08-13/?utm_source=chatgpt.com "Amgen sues Samsung biotech unit over bone drug copies"
[18]: https://apnews.com/article/67afcdc72e100204181c20aacec39d89?utm_source=chatgpt.com "FDA warns websites selling unapproved Botox for cosmetic purposes"
