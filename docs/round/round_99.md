좋아. **R6 Loop 5까지 끝났으니, 이번은 R7 Loop 5 — 바이오·헬스케어·의료기기**로 넘어간다.
...
R7 = 바이오·헬스케어·의료기기
Loop 5 목표 =
CDMO 미국 생산거점 / CRO funding cycle / biosimilar commercialization /
oral GLP-1 / GLP-1 telehealth channel / gene therapy uptake /
AI medical external validation / surgical robot installed base /
medical device safety / Botox counterfeit risk를 완전히 분리
```
...
| `ORAL_GLP1_MAINTENANCE_THERAPY`      | Watch-to-Green. approval은 Stage 2, scripts와 보험이 Stage 3    |
...
| `DISCLOSURE_CONFIDENCE_CAP`          | RedTeam cap. 계약금액·기간·상대방·수가·처방량 미공개 시 Stage 3 제한           |
...
Samsung Biologics는 GSK로부터 미국 Maryland Rockville 소재 Human Genome Sciences 생산시설을 2.8억 달러에 인수하기로 했다. 이 시설은 60,000L drug substance capacity를 갖고 있고, Samsung Biologics의 첫 미국 생산거점이다. Reuters는 이 거래가 장기 미국 수요 대응과 잠재적 관세 리스크에 대응하는 전략이라고 설명했고, 발표 당시 주가는 0.4% 하락해 코스피 2% 상승을 밑돌았다. 즉 전략적으론 좋지만, 가격경로는 즉시 aligned라고 보기 어렵다. ([Reuters][1])
...
```text
CDMO_US_TARIFF_HEDGE_CAPACITY를 CDMO_HEALTHCARE_CONTRACT에서 별도 분리한다.
...
Intuitive Surgical은 R7에서 가장 서생원식 구조에 가까운 의료기기 성공 후보 중 하나다. 2026년 1분기 da Vinci와 Ion procedure가 전년 대비 17% 증가했고, 매출은 23% 증가한 27.7억 달러, 조정 EPS는 2.50달러로 시장 예상을 넘었다. 회사는 2026년 procedure growth guidance도 13.5~15.5%로 올렸고, da Vinci 5 시스템과 Ion 사용 증가가 growth driver로 언급됐다. 이 구조는 **installed base → procedure growth → instruments/accessories 반복매출 → EPS/FCF visibility**가 확인되는 좋은 reference다. ([Investors][2])
...
```text
SURGICAL_ROBOT_INSTALLED_BASE는 R7 최상위 Green 후보군으로 유지.
...
Straumann은 치과 임플란트·디지털 치과 쪽에서 좋은 의료기기 reference다. 2025년 매출은 26.1억 스위스프랑으로 예상치를 웃돌았고, 2026년 high single-digit sales growth를 제시했다. 주가는 장중 최대 6% 상승했다. 다만 중국 VBP, 즉 volume-based procurement가 가격을 낮추고 현지 생산품을 우대할 가능성이 있어, 임플란트는 Green 가능이지만 가격통제 overlay를 반드시 붙여야 한다. ([Reuters][3])
...
## 4-4. Lilly Foundayo — `ORAL_GLP1_MAINTENANCE_THERAPY`

Eli Lilly의 oral GLP-1 비만치료제 Foundayo, 즉 orforglipron은 2026년 4월 FDA 승인을 받았다. Reuters는 Foundayo가 임상에서 12~15% 체중감량을 보였고, LillyDirect에서 월 149달러부터 시작하며, Novo의 Wegovy pill과 경쟁하게 된다고 보도했다. 승인 뉴스에서 Lilly 주가는 6% 올랐다. 이는 `OBESITY_GLP1_COMMERCIALIZATION`의 강한 Stage 2 후보지만, Stage 3는 처방량·보험·가격·OP/EPS가 따라와야 한다. ([Reuters][4])
...
```text
ORAL_GLP1_MAINTENANCE_THERAPY를 GLP-1 본체에서 별도 분리한다.
...
## 4-5. Foundayo 유지요법 데이터 — approval 이후 script gate 필요
...
Lunit INSIGHT DBT 모델을 163,449건 screening mammography exams로 외부검증한 연구는 전체 AUC 0.91, recall 0.73을 보고했다. 하지만 non-invasive cancer, calcifications, dense breast tissue subgroup에서는 성능이 낮아져, 의료AI 도입에는 평균 AUC뿐 아니라 subgroup performance와 임상 deployment 리스크를 같이 봐야 한다. ([arXiv][6])
...
Novo Nordisk는 GLP-1 시장의 대표 성장기업이지만, 2026년 sales와 operating profit이 5~13% 감소할 수 있다고 경고하자 미국 상장주가 12% 하락했다. Reuters는 미국 가격 압박, 경쟁 심화, semaglutide 특허 만료, copycat drug pressure를 핵심 원인으로 설명했다. 이 사례는 GLP-1 같은 거대 TAM도 가격·보험·경쟁 압박을 이기지 못하면 4B에서 4C로 내려간다는 기준이다. ([Reuters][8])
...
Hims & Hers는 compounded GLP-1에서 branded Wegovy 등으로 전환하면서 Q1 실적에서 예상 밖 손실을 냈고, 주가가 11% 하락했다. Reuters는 compounded drug에서 branded drug으로 전환하는 과정에서 restructuring cost, semaglutide ingredient write-down, legal cost, revenue recognition timing 문제가 발생했다고 보도했다. ([Reuters][9])
...
Hims & Hers는 Novo Nordisk의 Wegovy pill 복제형으로 보이는 compounded semaglutide pill을 출시했다가, FDA가 GLP-1 성분을 사용한 compounded drug에 대해 품질·안전·연방법 위반 우려를 들어 단속 방침을 밝히자 판매를 중단했다. Reuters는 HHS가 DOJ referral도 언급했다고 보도했다. ([Reuters][10])
...
Bluebird bio는 승인된 유전자치료제를 갖고 있었지만 severe cash crunch로 Carlyle·SK Capital에 주당 3달러에 비상장화되기로 했다. 이 가격은 직전 종가 대비 57.4% 할인된 수준이었고, 발표 후 주가는 36% 하락했다. Reuters는 gene therapy uptake가 느렸고, 2024년 11월 기준 세 치료제 중 하나를 시작한 환자가 57명에 그쳤다고 보도했다. ([Reuters][11])
...
## 5-5. Charles River — `CRO_CLINICAL_SERVICE`

Charles River Laboratories는 biotech 고객들의 funding crunch가 이어지면서 2024년 전망을 낮췄고, 주가는 premarket에서 15% 하락했다. 회사는 drug discovery·development service demand가 하반기에 개선될 것으로 보지 않는다고 밝혔고, 연간 매출 전망도 기존 증가에서 2.5~4.5% 감소로 낮췄다. ([Reuters][12])
...
Teladoc은 BetterHelp 관련 7.9억 달러 impairment를 기록하고 연간·장기 전망을 철회했으며, 주가는 13% 하락해 record low를 기록했다. Reuters는 BetterHelp의 revenue decline, customer acquisition expense 증가, DTC mental health model의 성장 둔화가 핵심 문제라고 보도했다. ([Reuters][13])
...
Recursion은 Exscientia를 6.88억 달러 all-stock deal로 인수해 AI-driven drug discovery 역량과 pipeline을 강화하려 했다. Reuters는 합병 법인이 약 8.5억 달러 cash를 보유해 3년 운영을 지원할 수 있다고 보도했다. 하지만 이것은 AI 신약개발의 잠재력을 보여주는 동시에, **cash runway는 필요조건이지 승인약·상업화·EPS의 충분조건이 아니다**라는 기준이 된다. ([Reuters][14])
...
Amgen은 Samsung Bioepis의 Prolia/Xgeva biosimilar에 대해 34개 특허 침해를 주장하며 소송을 제기했다. Amgen은 biosimilar 생산·판매 금지와 손해배상을 요구했고, Prolia와 Xgeva의 미국 매출은 전년 기준 각각 27억 달러, 15억 달러 이상이었다. 이 사례는 biosimilar가 허가·신청 단계에 있어도 patent litigation이 launch timing과 economics를 흔들 수 있음을 보여준다. ([Reuters][15])
...
FDA는 Botox와 유사한 counterfeit 또는 unapproved injectable wrinkle-smoothing products를 판매한 18개 웹사이트에 warning letters를 보냈다. AP는 FDA가 부상과 toxic side effects 보고 이후 조치했고, Botox류 제품은 boxed warning을 갖고 있으며 호흡·삼킴에 영향을 줄 수 있는 위험도 있다고 보도했다. ([AP News][16])
...
Novo의 2026년 sales·profit 감소 경고는 GLP-1도 TAM만으로 Green 유지가 안 된다는 기준이다. ([Reuters][8])
...
Bluebird는 유전자치료제 승인 후에도 상업화와 현금흐름이 따라오지 않으면 어떻게 무너지는지 보여주는 기준 사례다. ([Reuters][11])
...
Novo의 2026년 sales·operating profit 감소 경고와 주가 급락은 GLP-1의 4B→4C 전환 기준이다. ([Reuters][8])
...
Hims의 compounded GLP-1 중단과 branded drug 전환 비용은 pharma channel이 규제에 얼마나 민감한지 보여준다. ([Reuters][10])
...
Charles River의 forecast cut과 premarket -15%는 CRO도 funding cycle에 묶인다는 기준이다. ([Reuters][12])
...
Teladoc은 원격의료·온라인 정신건강이 사용자 수보다 CAC·privacy·반복계약·FCF가 중요하다는 hard counterexample이다. ([Reuters][13])
...
보톡스·미용시술은 반복수요가 있어도 안전성과 허가 채널이 깨지면 Stage 3-Green을 유지하면 안 된다. ([AP News][16])
...
Amgen의 Samsung Bioepis 상대 Prolia/Xgeva biosimilar 특허소송은 biosimilar launch timing과 economics를 흔드는 대표 RedTeam이다. ([Reuters][15])

---

# 8. 점수비중 보정표 — R7 Loop 5 / v5.0
...
| `ORAL_GLP1_MAINTENANCE_THERAPY`      |      21 |         19 |         11 |         13 |         9 |       0 |    6 | 초기 처방량, 보험, 경쟁 pill, boxed warning              |
...
Loop 5에서 가장 크게 바뀐 건 여덟 가지다.

```text
1. CDMO_US_TARIFF_HEDGE_CAPACITY를 유지하되 Stage 3 조건 강화.
   미국 생산거점은 전략적으로 좋지만, 고객계약·가동률·OPM 전까지 Stage 3 금지.

2. CDMO_ADC_CELL_GENE_CAPABILITY를 추가.
   ADC·세포/유전자 생산능력은 고부가지만, 고객계약·tech transfer·가동률 없으면 capex narrative다.

3. ORAL_GLP1_MAINTENANCE_THERAPY를 유지/강화.
   Foundayo approval과 maintenance data는 좋지만, scripts·보험·가격이 핵심 gate다.

4. GLP1_PRICE_WAR_OVERLAY를 추가.
   Novo 사례처럼 GLP-1도 가격·보험·경쟁으로 4B에서 4C로 갈 수 있다.

5. COMPOUNDED_GLP1_REGULATORY_RISK를 gate로 격상.
   Hims 사례처럼 channel이 회색이면 GLP-1 수요가 커도 4C가 된다.

6. MEDICAL_AI_EXTERNAL_VALIDATION을 별도 유지.
   AUC와 논문은 Stage 1~2이고, 병원도입·수가·반복매출이 Stage 3다.

7. SURGICAL_ROBOT_INSTALLED_BASE는 Green 후보 유지.
   installed base + procedure growth + 소모품 매출이 반복수익 구조를 만든다.

8. BIOSIMILAR_ACCESS_CASH_PAY를 추가.
   92% discount 같은 접근성 개선은 Stage 2 보조근거지만, 처방전환·PBM·마진이 Stage 3 조건이다.
```
...
```text
Stage 1:
oral GLP-1 임상·승인·출시 뉴스

Stage 2:
FDA approval, self-pay price, distribution channel, maintenance trial data 확인

Stage 3:
weekly scripts + insurance coverage + repeat refill + OP/EPS revision 확인

Stage 4B:
oral GLP-1 convenience narrative 과열

Stage 4C:
처방 ramp 실패, 보험 미등재, 가격경쟁, boxed-warning/safety issue
```
...
| `novo_glp1_price_pressure_case`                    | 2026-02-03 | sales/profit -5~13% guide, 4C-watch              |
...
**R7 Loop 5 점수정규화의 핵심 문장:**

> 바이오·헬스케어·의료기기는 “허가”, “임상”, “AI”, “논문”, “시장규모”가 아니라 **계약, 가동률, 처방량, PBM/보험, 수가, 반복시술, 소모품, 환급, cash runway, FCF 전환, 실제 가격경로 리레이팅**으로 봐야 한다.
> Loop 5부터는 특히 `CDMO_US_TARIFF_HEDGE_CAPACITY`, `ORAL_GLP1_MAINTENANCE_THERAPY`, `GLP1_PRICE_WAR_OVERLAY`, `COMPOUNDED_GLP1_REGULATORY_RISK`, `MEDICAL_AI_EXTERNAL_VALIDATION`, `BIOSIMILAR_ACCESS_CASH_PAY`, `DEVICE_SAFETY_COUNTERFEIT_OVERLAY`, `DISCLOSURE_CONFIDENCE_CAP`을 강한 보정축으로 넣어야 한다.

다음 순서는 **R8 — 플랫폼·콘텐츠·SW·보안 Loop 5**다.
...
[8]: https://www.reuters.com/business/novo-nordisk-warns-2026-sales-decline-2026-02-03/?utm_source=chatgpt.com "Novo Nordisk warns on profits and sales amid Trump drug price crackdown"
[9]: https://www.reuters.com/legal/litigation/hims-hers-plunges-after-weight-loss-pivot-hits-quarterly-results-2026-05-12/?utm_source=chatgpt.com "Hims & Hers plunges as branded weight-loss drug pivot hits results"
[10]: https://www.reuters.com/legal/litigation/hims-hers-stop-offering-compounded-semaglutide-pill-after-fda-crackdown-2026-02-07/?utm_source=chatgpt.com "Hims to stop offering GLP-1 pill after FDA warned of crackdown"
[11]: https://www.reuters.com/markets/deals/bluebird-bio-be-taken-private-by-carlyle-sk-capital-amid-cash-crunch-2025-02-21/?utm_source=chatgpt.com "Gene therapy maker bluebird to go private in discounted deal amid cash crunch"
[12]: https://www.reuters.com/business/healthcare-pharmaceuticals/charles-river-cuts-2024-forecast-funding-crunch-among-biotech-clients-persists-2024-08-07/?utm_source=chatgpt.com "Charles River cuts 2024 forecast as funding crunch among biotech clients persists"
[13]: https://www.reuters.com/business/healthcare-pharmaceuticals/teladoc-shares-hit-record-low-after-telehealth-firm-withdraws-2024-forecast-2024-08-01/?utm_source=chatgpt.com "Teladoc shares hit record low after telehealth firm withdraws 2024 forecast"
[14]: https://www.reuters.com/markets/deals/biotech-firm-recursion-buy-smaller-peer-exscientia-688-million-2024-08-08/?utm_source=chatgpt.com "Biotech firm Recursion to buy smaller peer Exscientia for $688 million"
[15]: https://www.reuters.com/legal/litigation/amgen-sues-samsung-biotech-unit-over-bone-drug-copies-2024-08-13/?utm_source=chatgpt.com "Amgen sues Samsung biotech unit over bone drug copies"
[16]: https://apnews.com/article/67afcdc72e100204181c20aacec39d89?utm_source=chatgpt.com "FDA warns websites selling unapproved Botox for cosmetic purposes"
