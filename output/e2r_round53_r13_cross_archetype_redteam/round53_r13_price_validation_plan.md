...
| --- | --- | --- | --- |
| `sk_hynix_hbm_memory_aligned_4b_watch_case` | `STRUCTURAL_SUCCESS_ALIGNED` | 2026-05-14 | needs_price_backfill |
| `hyundai_motor_valueup_strategy_aligned_case` | `STRUCTURAL_SUCCESS_ALIGNED` | 2024-08-28 | needs_price_backfill |
| `event_to_contract_escalation_case` | `EVENT_PREMIUM` | undated | needs_price_backfill |
...
| `terrausd_luna_algorithmic_stablecoin_break_case` | `THESIS_BREAK_4C` | 2022-05-12 | needs_price_backfill |
| `bluebird_bio_approval_commercialization_failure_case` | `LEVERAGE_FCF_BREAKDOWN` | 2025-02-21 | needs_price_backfill |
| `novo_nordisk_glp1_4b_to_4c_case` | `CROWDED_RERATING_4B_WATCH` | 2026-02-04 | needs_price_backfill |
...
| `financial_reporting_integrity_delay_case` | `FINANCIAL_REPORTING_INTEGRITY_RISK` | undated | needs_price_backfill |
