# Round-171 R13 Loop-10 Cross-Archetype RedTeam / 4B / Price Validation

- source_round: `docs/round/round_171.md`
- large_sector: `CROSS_ARCHETYPE_REDTEAM_4B_PRICE_VALIDATION`
- target_count: 22
- source_canonical_target_count: 16
- overlay_axis_count: 7
- stage_cap_count: 4
- case_candidate_count: 46
...
- Round 171 is a common validation overlay, not a sector score-owner.
- The source note names 16 canonical buckets; this pack keeps them and also preserves earlier diagnostic hard-gate buckets for regression coverage.
...
## R13 v10 Cross-Archetype Overlay Axes
