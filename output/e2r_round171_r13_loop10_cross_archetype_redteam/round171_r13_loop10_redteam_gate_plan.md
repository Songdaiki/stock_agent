# Round-171 R13 Loop-10 RedTeam Gate Plan
...
| `STAGE2_EVIDENCE_NOT_GREEN` | WATCH_YELLOW_FIRST | false | false | eps_fcf_missing, repeatability_missing, stage3_green_evidence_missing, detail_missing |
...
- Do not apply Round171 overlay symbols to production scoring yet.
- Do not lower Stage 3-Green to improve recall.
- Do not use R13 Loop-10 case records as candidate-generation input.
