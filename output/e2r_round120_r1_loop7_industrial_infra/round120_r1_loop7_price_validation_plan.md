...
| `siemens_energy_fcf_buyback_case` | `POWER_EQUIPMENT_CAPITAL_RETURN` | 2026-05-12 | needs_price_backfill |
| `siemens_energy_record_backlog_case` | `POWER_EQUIPMENT_CAPITAL_RETURN` | 2026-02-01 | needs_price_backfill |
