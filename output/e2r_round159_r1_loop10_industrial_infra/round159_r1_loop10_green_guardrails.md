...
| `POWER_EQUIPMENT_BACKLOG_TO_FCF` | WATCH_YELLOW_FIRST | fcf_growth, buyback_or_dividend, margin_visible, order_backlog_quality | order_peak, fcf_slowdown, buyback_cut, legacy_loss |
