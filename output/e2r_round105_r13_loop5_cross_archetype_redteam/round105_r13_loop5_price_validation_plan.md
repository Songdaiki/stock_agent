...
| `blackstone_digital_infra_trust_stage1_capped_case` | `DISCLOSURE_CONFIDENCE_CAP` | 2026-05-14 | needs_price_backfill |
...
| `opendart_disclosure_confidence_cap_reference_case` | `DISCLOSURE_CONFIDENCE_CAP` | undated | needs_price_backfill |
