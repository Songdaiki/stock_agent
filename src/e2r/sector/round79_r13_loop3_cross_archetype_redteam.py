"""Round-79 R13 Loop-3 cross-archetype RedTeam / 4B / price validation pack.

Round 79 is a common validation layer over the R1-R12 sector/archetype work.
...
ROUND79_SOURCE_ROUND_PATH = "docs/round/round_79.md"
ROUND79_LARGE_SECTOR = "CROSS_ARCHETYPE_REDTEAM_4B_PRICE_VALIDATION"
ROUND79_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round79_r13_loop3_cross_archetype_redteam"
ROUND79_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r13_loop3_round79.jsonl"
ROUND79_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round79_r13_loop3_v3.csv"


@dataclass(frozen=True)
class Round79OverlayWeightDraft:
    eps_fcf: str
...
@dataclass(frozen=True)
class Round79OverlayTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round79OverlayWeightDraft
...
ROUND79_OVERLAY_TARGETS: tuple[Round79OverlayTarget, ...] = (
    Round79OverlayTarget(
        "STRUCTURAL_SUCCESS_ALIGNED",
        E2RArchetype.STRUCTURAL_SUCCESS_ALIGNED,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round79OverlayWeightDraft("+", "+", "+", "+", "+", "optional", "+", "pass_if_no_redteam"),
    ...
    Round79OverlayTarget(
        ...
        Round79OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "stage4b_watch"),
    ...
    Round79OverlayTarget(
        ...
        Round79OverlayWeightDraft("0", "0", "0", "-", "-", "0", "-", "green_block"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round79OverlayWeightDraft("0~+", "0", "0", "+", "0", "0", "medium", "event_split"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round79OverlayWeightDraft("+", "+", "optional", "+", "optional", "0", "+", "stage2_candidate"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round79OverlayWeightDraft("+", "low", "+", "0", "low", "0", "medium", "cycle_cap"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("-", "-", "-", "-", "-", "0", "-", "score_recalibration"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round79OverlayWeightDraft("+", "+", "optional", "0", "-", "optional", "+", "alignment_review"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_block"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_review"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_soft_gate"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("-", "-", "0", "-", "-", "-", "medium", "green_block"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("hard-", "hard-", "0", "hard-", "hard-", "hard-", "+", "hard_4c"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_hard_review"),
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "policy_price_path_shock"),
        (
            "tax_policy_comment",
            "ai_windfall_tax",
            "citizen_dividend",
    ...
    Round79OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round79OverlayWeightDraft("0", "0", "0", "0", "0", "0", "low", "green_block"),
...
ROUND79_CASE_CANDIDATES: tuple[Round79CaseCandidate, ...] = (
    Round79CaseCandidate(
        ...
        ("round_79.md Reuters SK Hynix AI boom / market value",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters Hyundai sales target / hybrid / buyback",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters Korea Commercial Act revision",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters Circle reserve income / USDC circulation",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md event-to-contract escalation rule",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Barron's Korea AI tax / KOSPI shock",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md AP SMCI auditor resignation",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters CrowdStrike outage and lawsuit",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters TerraUSD/Luna collapse",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters bluebird bio cash crunch",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters Novo GLP-1 guide down",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md Reuters Hindenburg Equinix short report",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md price-only rally definition",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md event premium bucket",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md cyclical success rule",),
    ...
    Round79CaseCandidate(
        ...
        "false_positive_score",
        "needs_price_backfill",
        ("round_79.md false-positive score rule",),
    ...
    Round79CaseCandidate(
        ...
        "evidence_good_but_price_failed",
        "needs_price_backfill",
        ("round_79.md evidence-good price-failed rule",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md legal/regulatory RedTeam rule",),
    ...
    Round79CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_79.md leverage/FCF breakdown rule",),
    ...
    Round79CaseCandidate(
        ...
        "unknown_insufficient_evidence",
        "needs_price_backfill",
        ("round_79.md insufficient evidence rule",),
        "Unknown evidence must remain unknown; missing fields are not filled.",
    ),
)


ROUND79_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "market",
...
def round79_target_for(target_id: str) -> Round79OverlayTarget | None:
    for target in ROUND79_OVERLAY_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round79_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND79_CASE_CANDIDATES:
        target = round79_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round79 R13 Loop-3 cross-archetype validation case for {candidate.target_id}; "
            ...
            score_price_alignment=_round79_score_price_alignment(candidate),
            rerating_result=_round79_rerating_result(candidate),
            price_pattern=candidate.alignment_hint,
            score_weight_hint=_round79_score_weight_hint(target),
            green_guardrails=(
...
def round79_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round79_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND79_CASE_CANDIDATES:
        target = round79_target_for(candidate.target_id)
...
def round79_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round79_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round79_backfill": "true"} for field in ROUND79_PRICE_FIELDS)


def round79_summary() -> dict[str, int | bool]:
    records = round79_case_records()
    return {
        "target_count": len(ROUND79_OVERLAY_TARGETS),
        ...
        "hard_gate_target_count": sum(1 for target in ROUND79_OVERLAY_TARGETS if target.hard_gate),
        "green_possible_count": sum(1 for target in ROUND79_OVERLAY_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND79_OVERLAY_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND79_OVERLAY_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round79_r13_loop3_reports(
    *,
    output_directory: str | Path = ROUND79_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND79_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND79_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round79_r13_loop3_cross_archetype_redteam_summary.md",
        "case_matrix": output / "round79_r13_loop3_case_matrix.csv",
        "target_matrix": output / "round79_r13_loop3_overlay_target_matrix.csv",
        "stage_date_plan": output / "round79_r13_loop3_stage_date_plan.csv",
        "redteam_gate_plan": output / "round79_r13_loop3_redteam_gate_plan.md",
        "price_validation_plan": output / "round79_r13_loop3_price_validation_plan.md",
        "price_fields": output / "round79_r13_loop3_price_fields.csv",
    }
    _write_case_jsonl(round79_case_records(), cases)
    _write_rows(round79_score_profile_rows(), score_profiles)
    _write_rows(round79_score_profile_rows(), paths["target_matrix"])
    _write_rows(round79_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round79_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round79_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round79_summary_markdown(), encoding="utf-8")
    paths["redteam_gate_plan"].write_text(render_round79_redteam_gate_plan_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round79_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round79_summary_markdown() -> str:
    summary = round79_summary()
    lines = [
        "# Round-79 R13 Loop-3 Cross-Archetype RedTeam / 4B / Price Validation",
        "",
        f"- source_round: `{ROUND79_SOURCE_ROUND_PATH}`",
        f"- large_sector: `{ROUND79_LARGE_SECTOR}`",
        ...
        "## Interpretation",
        "",
        "- Round 79 is a common validation overlay, not a sector score-owner.",
...
def render_round79_redteam_gate_plan_markdown() -> str:
    lines = [
        "# Round-79 R13 Loop-3 RedTeam Gate Plan",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply Round79 overlay symbols to production scoring yet.",
            "- Do not lower Stage 3-Green to improve recall.",
            "- Do not use R13 Loop-3 case records as candidate-generation input.",
            "- Do not treat price-only movement, event premium, or cycle success as structural Green by itself.",
            "- Do not ignore hard RedTeam evidence such as auditor resignation, filing delay, global outage, regulatory denial, cash runway collapse, AFFO integrity risk, or stablecoin de-peg.",
        ]
    )
    return "\n".join(lines) + "\n"


def render_round79_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round79_case_candidate_rows():
...
def _round79_score_price_alignment(candidate: Round79CaseCandidate) -> str:
...
def _round79_rerating_result(candidate: Round79CaseCandidate) -> str:
...
def _round79_score_weight_hint(target: Round79OverlayTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
        "eps_fcf": _round79_symbolic_weight(weights["eps_fcf"]),
        "visibility": _round79_symbolic_weight(weights["structural_visibility"]),
        "bottleneck": _round79_symbolic_weight(weights["bottleneck_pricing"]),
        "mispricing": _round79_symbolic_weight(weights["market_mispricing"]),
        "valuation": _round79_symbolic_weight(weights["valuation"]),
        "capital_allocation": _round79_symbolic_weight(weights["capital_allocation"]),
        "information_confidence": _round79_symbolic_weight(weights["information_confidence"]),
    }


def _round79_symbolic_weight(value: str) -> float:
    return {
        "+": 1.0,
        "0": 0.0,
        "-": -1.0,
...
__all__ = [
    ...
    "ROUND79_DEFAULT_CASES_PATH",
    "ROUND79_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND79_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND79_LARGE_SECTOR",
    "ROUND79_OVERLAY_TARGETS",
    "ROUND79_PRICE_FIELDS",
    "Round79CaseCandidate",
    "Round79OverlayTarget",
    "Round79OverlayWeightDraft",
