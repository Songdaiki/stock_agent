"""Round-143 R11 Loop-8 policy/geopolitical/disaster/event pack.

Round 143 tightens the R11 event-risk pack from Round 116. The rule stays
...
Loop 8 adds explicit export-control, tourism-policy, and AI policy-shock gates.
...
ROUND143_SOURCE_ROUND_PATH = "docs/round/round_143.md"
ROUND143_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round143_r11_loop8_policy_geopolitical_event"
ROUND143_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r11_loop8_round143.jsonl"
ROUND143_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round143_r11_loop8_v8.csv"


@dataclass(frozen=True)
class Round143ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round143ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round143ScoreWeightDraft
...
ROUND143_BASE_SCORE_AXES: tuple[Round143BaseScoreAxis, ...] = (
    Round143BaseScoreAxis(
...
ROUND143_STAGE_CAPS: tuple[Round143StageCap, ...] = (
    Round143StageCap(
...
ROUND143_SCORE_TARGETS: tuple[Round143ScoreTarget, ...] = (
    Round143ScoreTarget(
        "NORTH_KOREA_POLICY_EVENT",
        E2RArchetype.NORTH_KOREA_POLICY_EVENT,
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(4, 3, 5, 8, 4, 0, 3),
    ...
    Round143ScoreTarget(
        ...
        Round143ScoreWeightDraft(12, 11, 8, 10, 8, 0, 4),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(14, 15, 9, 11, 9, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(15, 16, 10, 12, 9, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(12, 12, 17, 12, 8, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(16, 17, 17, 13, 10, 1, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(10, 6, 7, 8, 6, 0, 4),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(13, 14, 11, 10, 8, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(15, 16, 13, 11, 9, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(13, 9, 8, 8, 6, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(16, 15, 8, 11, 8, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(19, 5, 5, 5, 5, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(5, 4, 5, 5, 5, 0, 3),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(7, 6, 6, 8, 6, 0, 3),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(5, 5, 5, 8, 5, 0, 3),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(8, 7, 4, 10, 6, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(10, 10, 8, 10, 7, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft(8, 5, 5, 6, 5, 0, 4),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round143ScoreWeightDraft(15, 14, 8, 10, 8, 0, 5),
    ...
    Round143ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round143ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND143_CASE_CANDIDATES: tuple[Round143CaseCandidate, ...] = (
    Round143CaseCandidate(
...
ROUND143_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round143ScoreTarget | None:
...
def round143_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND143_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round143 R11 Loop-8 case for {candidate.target_id}; "
...
def round143_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round143_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND143_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round143_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round143_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round143_backfill": "true"} for field in ROUND143_PRICE_FIELDS)


def round143_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_dict() for axis in ROUND143_BASE_SCORE_AXES)


def round143_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND143_STAGE_CAPS)


def round143_summary() -> dict[str, int | bool]:
    records = round143_case_records()
    return {
        "target_count": len(ROUND143_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND143_BASE_SCORE_AXES),
        "stage_cap_count": len(ROUND143_STAGE_CAPS),
        ...
        "green_possible_count": sum(1 for target in ROUND143_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND143_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND143_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND143_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round143_r11_loop8_reports(
    *,
    output_directory: str | Path = ROUND143_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND143_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND143_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round143_r11_loop8_policy_geopolitical_event_summary.md",
        "case_matrix": output / "round143_r11_loop8_case_matrix.csv",
        "stage_date_plan": output / "round143_r11_loop8_stage_date_plan.csv",
        "green_guardrails": output / "round143_r11_loop8_green_guardrails.md",
        "event_false_positive_caps": output / "round143_r11_loop8_event_false_positive_caps.md",
        "price_validation_plan": output / "round143_r11_loop8_price_validation_plan.md",
        "price_fields": output / "round143_r11_loop8_price_fields.csv",
        "base_score_axes": output / "round143_r11_loop8_base_score_axes.csv",
        "stage_caps": output / "round143_r11_loop8_stage_caps.csv",
    }
    _write_case_jsonl(round143_case_records(), cases)
    _write_rows(round143_score_profile_rows(), score_profiles)
    _write_rows(round143_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round143_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round143_price_field_rows(), paths["price_fields"])
    _write_rows(round143_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round143_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round143_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round143_green_guardrail_markdown(), encoding="utf-8")
    paths["event_false_positive_caps"].write_text(render_round143_event_false_positive_caps_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round143_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round143_summary_markdown() -> str:
    summary = round143_summary()
    lines = [
        "# Round-143 R11 Loop-8 Policy / Geopolitical / Disaster / Event Summary",
        "",
        f"- source_round: `{ROUND143_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R11 Loop-8 is mostly a false-positive defense pack.",
        ...
        "",
        "## R11 v8 Base Score Axes",
        "",
        "These axes are calibration material only. They document how Round 143 separates policy/event headlines from actual orders, budgets, financing, guidance, recurrence, and RedTeam detail checks.",
    ]
    for axis in ROUND143_BASE_SCORE_AXES:
    ...
    for cap in ROUND143_STAGE_CAPS:
        lines.append(f"- {cap.cap_id}: {cap.stage_band} / {cap.score_cap}")
    return "\n".join(lines) + "\n"


def render_round143_green_guardrail_markdown() -> str:
    lines = [
        "# Round-143 R11 Loop-8 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R11 Loop-8 v8 weights to production scoring yet.",
...
def render_round143_event_false_positive_caps_markdown() -> str:
    lines = [
...
def render_round143_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-143 R11 Loop-8 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round143_case_candidate_rows():
...
def _score_price_alignment(candidate: Round143CaseCandidate) -> str:
...
def _rerating_result(candidate: Round143CaseCandidate) -> str:
...
__all__ = [
    ...
    "ROUND143_DEFAULT_CASES_PATH",
    "ROUND143_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND143_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND143_PRICE_FIELDS",
    "ROUND143_SCORE_TARGETS",
    "ROUND143_SOURCE_ROUND_PATH",
    "ROUND143_STAGE_CAPS",
    "Round143BaseScoreAxis",
    "Round143CaseCandidate",
    "Round143ScoreTarget",
    "Round143ScoreWeightDraft",
    "Round143StageCap",
