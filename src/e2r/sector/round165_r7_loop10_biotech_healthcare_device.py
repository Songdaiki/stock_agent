"""Round-165 R7 Loop-10 biotech, healthcare, and medical-device pack.

Round 165 tightens the R7 healthcare pack. It separates approvals, clinical
...
ROUND165_SOURCE_ROUND_PATH = "docs/round/round_165.md"
ROUND165_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round165_r7_loop10_biotech_healthcare_device"
ROUND165_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r7_loop10_round165.jsonl"
ROUND165_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round165_r7_loop10_v10.csv"

ROUND165_SOURCE_CANONICAL_TARGET_IDS: tuple[str, ...] = (
...
ROUND165_HELPER_OVERLAY_TARGET_IDS: tuple[str, ...] = (
    "MEDICAL_DEVICE_DENTAL_IMPLANT",
    "DIAGNOSTICS_INFECTIOUS_DISEASE",
)
ROUND165_SOURCE_CANONICAL_TARGET_COUNT = len(ROUND165_SOURCE_CANONICAL_TARGET_IDS)
ROUND165_HELPER_OVERLAY_TARGET_COUNT = len(ROUND165_HELPER_OVERLAY_TARGET_IDS)


@dataclass(frozen=True)
class Round165ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round165ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round165ScoreWeightDraft
...
@dataclass(frozen=True)
class Round165ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
GATE_WEIGHT = Round165ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
CAP_WEIGHT = Round165ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND165_BASE_SCORE_WEIGHTS: tuple[Round165BaseScoreWeight, ...] = (
    Round165BaseScoreWeight(
    ...
    Round165BaseScoreWeight(
        ...
        16,
        "Safety, reimbursement, FDA/DOJ, patent litigation, subgroup validation, device counterfeit, and disclosure detail are stronger Loop-10 hard gates.",
    ),
    Round165BaseScoreWeight(
...
ROUND165_STAGE_CAPS: tuple[Round165StageCap, ...] = (
    Round165StageCap(
...
ROUND165_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round165ScoreStagePriceAlignment, ...] = (
    Round165ScoreStagePriceAlignment(
...
ROUND165_SCORE_TARGETS: tuple[Round165ScoreTarget, ...] = (
    Round165ScoreTarget(
        "CDMO_HEALTHCARE_CONTRACT",
        E2RArchetype.CDMO_HEALTHCARE_CONTRACT,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round165ScoreWeightDraft(20, 24, 12, 12, 12, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round165ScoreWeightDraft(19, 21, 12, 12, 11, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(19, 20, 11, 12, 10, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(16, 17, 7, 11, 9, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(18, 18, 6, 12, 9, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(16, 15, 5, 11, 8, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(18, 19, 6, 12, 9, 0, 7),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round165ScoreWeightDraft(22, 20, 12, 13, 8, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(21, 20, 11, 13, 9, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(21, 19, 11, 13, 9, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(18, 15, 5, 13, 7, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round165ScoreWeightDraft(7, 10, 8, 9, 5, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round165ScoreWeightDraft(6, 10, 7, 12, 6, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(18, 17, 8, 13, 12, 0, 7),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(16, 16, 8, 13, 11, 0, 7),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(16, 16, 7, 12, 9, 1, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round165ScoreWeightDraft(15, 13, 5, 10, 8, 0, 6),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round165ScoreWeightDraft(20, 22, 13, 14, 12, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round165ScoreWeightDraft(21, 23, 13, 14, 12, 1, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round165ScoreWeightDraft(19, 20, 12, 13, 11, 0, 5),
    ...
    Round165ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round165ScoreWeightDraft(20, 5, 5, 5, 5, 0, 5),
...
ROUND165_CASE_CANDIDATES: tuple[Round165CaseCandidate, ...] = (
    Round165CaseCandidate(
        "samsung_biologics_gsk_us_facility_case",
        "CDMO_US_TARIFF_HEDGE_CAPACITY",
        "207940",
        ...
        ("round_165.md Reuters Samsung Biologics GSK US facility",),
    ...
    Round165CaseCandidate(
        ...
        ("round_165.md Samsung Biologics CDMO structure reference",),
    ...
    Round165CaseCandidate(
        ...
        ("round_165.md Investors Intuitive Surgical Q1 2026",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Straumann dental implant growth",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Lilly oral GLP-1 approval",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Foundayo switch maintenance",),
    ...
    Round165CaseCandidate(
        ...
        ("round_165.md Reuters Humira biosimilar GoodRx access",),
    ...
    Round165CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_165.md Reuters Cigna Humira biosimilar $0 copay",),
    ...
    Round165CaseCandidate(
        ...
        "glp1_4b_to_4c",
        "needs_price_backfill",
        ("round_165.md Reuters Novo 2026 outlook warning",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Hims GLP-1 revenue miss",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Hims compounded GLP-1 crackdown",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters bluebird bio take-private cash crunch",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Charles River forecast cut",),
        "CRO is service revenue, but funding-cycle cuts can break backlog and forecast visibility.",
        (E2RArchetype.CRO_CLINICAL_SERVICE,),
    ),
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Teladoc record low",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md Reuters Recursion Exscientia merger",),
    ...
    Round165CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_165.md arXiv Lunit DBT subgroup performance",),
    ...
    Round165CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_165.md Reuters Amgen Samsung Bioepis patent litigation",),
    ...
    Round165CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_165.md AP FDA unapproved Botox warning",),
...
ROUND165_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round165_target_for(target_id: str) -> Round165ScoreTarget | None:
...
def round165_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND165_CASE_CANDIDATES:
        target = round165_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round165 R7 Loop-10 case for {candidate.target_id}; "
...
def round165_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round165_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND165_CASE_CANDIDATES:
        target = round165_target_for(candidate.target_id)
...
def round165_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round165_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round165_backfill": "true"} for field in ROUND165_PRICE_FIELDS)


def round165_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for item in ROUND165_BASE_SCORE_WEIGHTS
    )


def round165_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": item.cap_id,
        ...
        for item in ROUND165_STAGE_CAPS
    )


def round165_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for item in ROUND165_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round165_summary() -> dict[str, int | bool]:
    records = round165_case_records()
    return {
        "target_count": len(ROUND165_SCORE_TARGETS),
        "source_canonical_target_count": ROUND165_SOURCE_CANONICAL_TARGET_COUNT,
        "helper_overlay_target_count": ROUND165_HELPER_OVERLAY_TARGET_COUNT,
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND165_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND165_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND165_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND165_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND165_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND165_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND165_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round165_r7_loop10_reports(
    *,
    output_directory: str | Path = ROUND165_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND165_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND165_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round165_r7_loop10_biotech_healthcare_device_summary.md",
        "case_matrix": output / "round165_r7_loop10_case_matrix.csv",
        "stage_date_plan": output / "round165_r7_loop10_stage_date_plan.csv",
        "green_guardrails": output / "round165_r7_loop10_green_guardrails.md",
        "risk_overlays": output / "round165_r7_loop10_risk_overlays.md",
        "price_validation_plan": output / "round165_r7_loop10_price_validation_plan.md",
        "price_fields": output / "round165_r7_loop10_price_fields.csv",
        "base_score_weights": output / "round165_r7_loop10_base_score_weights.csv",
        "stage_caps": output / "round165_r7_loop10_stage_caps.csv",
        "score_stage_price_alignment": output / "round165_r7_loop10_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round165_r7_loop10_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round165_case_records(), cases)
    _write_rows(round165_score_profile_rows(), score_profiles)
    _write_rows(round165_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round165_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round165_price_field_rows(), paths["price_fields"])
    _write_rows(round165_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round165_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round165_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round165_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round165_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round165_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round165_price_validation_plan_markdown(), encoding="utf-8")
...
def render_round165_summary_markdown() -> str:
    summary = round165_summary()
    lines = [
        "# Round-165 R7 Loop-10 Biotech / Healthcare / Medical Device Summary",
        "",
        f"- source_round: `{ROUND165_SOURCE_ROUND_PATH}`",
        "- large_sector: `BIOTECH_HEALTHCARE_DEVICE`",
        "- loop: `R7 Loop 10 / v10.0`",
        ...
        "## Interpretation",
        "",
        "- R7 Loop 10 says approval, clinical success, AI papers, and TAM are not commercialization by themselves.",
        "- The source round defines 30 canonical targets; dental implant and infectious-diagnostics are kept as 2 helper overlays for price-path and RedTeam calibration.",
...
def render_round165_green_guardrail_markdown() -> str:
    lines = [
        "# Round-165 R7 Loop-10 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R7 Loop-10 v10.0 weights to production scoring yet.",
...
def render_round165_risk_overlay_markdown() -> str:
    lines = [
        "# Round-165 R7 Loop-10 Risk Overlays",
        "",
...
def render_round165_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round165_case_candidate_rows():
...
def render_round165_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-165 R7 Loop-10 Score / Stage / Price Alignment",
        "",
        "Round 165 checks whether R7 healthcare evidence is actually moving from science, approval, and TAM into commercialization, recurring revenue, and price-path confirmation.",
...
def _score_price_alignment(candidate: Round165CaseCandidate) -> str:
...
def _rerating_result(candidate: Round165CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round165ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    ...
    "ROUND165_SCORE_STAGE_PRICE_ALIGNMENT",
