"""Round-140 R8 Loop-8 platform/content/software/security pack.

Round 140 tightens the R8 platform/content/software/security pack. It separates
...
ROUND140_SOURCE_ROUND_PATH = "docs/round/round_140.md"
ROUND140_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round140_r8_loop8_platform_content_sw_security"
ROUND140_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r8_loop8_round140.jsonl"
ROUND140_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round140_r8_loop8_v8.csv"


@dataclass(frozen=True)
class Round140ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round140ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round140ScoreWeightDraft
...
GATE_WEIGHT = Round140ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
GATE_INFO5_WEIGHT = Round140ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 5)
CAP_WEIGHT = Round140ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND140_BASE_SCORE_AXES: tuple[Round140BaseScoreAxis, ...] = (
    Round140BaseScoreAxis(
    ...
    Round140BaseScoreAxis(
        ...
        "Rerating room exists only when the market still uses the old frame while repeat economics are improving; Loop 8 shifts weight from narrative rerating to evidence quality.",
    ),
    Round140BaseScoreAxis(
    ...
    Round140BaseScoreAxis(
        ...
        "Operational trust and legal/data quality are hard Loop 8 gates; CrowdStrike, Roblox, Meta, and Netflix-style events can cap or break Stage 3.",
    ),
)


ROUND140_SCORE_TARGETS: tuple[Round140ScoreTarget, ...] = (
    Round140ScoreTarget(
        "PLATFORM_SOFTWARE_INTERNET",
        E2RArchetype.PLATFORM_SOFTWARE_INTERNET,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(18, 18, 7, 15, 13, 1, 5),
    ...
    Round140ScoreTarget(
        ...
        Round140ScoreWeightDraft(20, 23, 7, 15, 13, 1, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round140ScoreWeightDraft(23, 23, 10, 16, 9, 0, 6),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(23, 24, 11, 15, 10, 0, 6),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round140ScoreWeightDraft(22, 23, 9, 16, 10, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(20, 21, 12, 14, 9, 2, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(20, 19, 9, 15, 12, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(20, 21, 8, 14, 11, 0, 6),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(21, 22, 8, 15, 10, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(19, 20, 8, 14, 13, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(18, 16, 6, 13, 10, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(10, 8, 4, 10, 6, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(17, 14, 5, 12, 8, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(16, 14, 6, 12, 9, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(18, 18, 7, 14, 8, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(20, 21, 8, 14, 11, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(21, 21, 10, 14, 11, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(21, 21, 13, 13, 9, 2, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round140ScoreWeightDraft(20, 20, 10, 14, 11, 0, 5),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round140ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 6),
    ...
    Round140ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round140ScoreWeightDraft(5, 5, 5, 6, 5, 0, 3),
...
ROUND140_CASE_CANDIDATES: tuple[Round140CaseCandidate, ...] = (
    Round140CaseCandidate(
        ...
        ("round_140.md Reuters EQT Douzone Bizon",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md MarketWatch Palantir Q4 2025",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md MarketWatch Palantir Q1 2026",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Barrons Akamai frontier model AI cloud deal",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Barrons Akamai AI cloud revenue contribution",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Barrons Datadog observability",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Barrons Dynatrace ARR guidance risk",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Barrons Fortinet billings",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters Cisco AI infrastructure orders",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md The Verge Netflix ad ambitions",),
    ...
    Round140CaseCandidate(
        ...
        "adtech_premium_miss",
        "needs_price_backfill",
        ("round_140.md Barron's Trade Desk revenue miss",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters CrowdStrike shareholder lawsuit",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters Kakao founder legal case",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters Roblox safety forecast cut",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md GTA VI preorder rumor",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters WPP ad forecast cut",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters Netflix Texas privacy lawsuit",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters Meta scam ads lawsuit",),
    ...
    Round140CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_140.md Reuters Meta youth safety trial",),
    ...
    Round140CaseCandidate(
        ...
        ("round_140.md Reuters Breakingviews SaaSpocalypse",),
...
ROUND140_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
ROUND140_RISK_OVERLAYS: tuple[str, ...] = (
...
def round140_target_for(target_id: str) -> Round140ScoreTarget | None:
...
def round140_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND140_CASE_CANDIDATES:
        target = round140_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round140 R8 Loop-8 case for {candidate.target_id}; "
...
def round140_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round140_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for axis in ROUND140_BASE_SCORE_AXES
    )


def round140_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND140_CASE_CANDIDATES:
        target = round140_target_for(candidate.target_id)
...
def round140_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round140_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round140_backfill": "true"} for field in ROUND140_PRICE_FIELDS)


def round140_summary() -> dict[str, int | bool]:
    records = round140_case_records()
    return {
        "target_count": len(ROUND140_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND140_BASE_SCORE_AXES),
        ...
        "green_possible_count": sum(1 for target in ROUND140_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND140_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND140_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND140_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round140_r8_loop8_reports(
    *,
    output_directory: str | Path = ROUND140_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND140_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND140_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round140_r8_loop8_platform_content_sw_security_summary.md",
        "case_matrix": output / "round140_r8_loop8_case_matrix.csv",
        "stage_date_plan": output / "round140_r8_loop8_stage_date_plan.csv",
        "base_score_axes": output / "round140_r8_loop8_base_score_axes.csv",
        "green_guardrails": output / "round140_r8_loop8_green_guardrails.md",
        "risk_overlays": output / "round140_r8_loop8_risk_overlays.md",
        "price_validation_plan": output / "round140_r8_loop8_price_validation_plan.md",
        "price_fields": output / "round140_r8_loop8_price_fields.csv",
    }
    _write_case_jsonl(round140_case_records(), cases)
    _write_rows(round140_score_profile_rows(), score_profiles)
    _write_rows(round140_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round140_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round140_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round140_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round140_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round140_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round140_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round140_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round140_summary_markdown() -> str:
    summary = round140_summary()
    lines = [
        "# Round 140 R8 Loop-8 Platform/Content/SW/Security Summary",
        "",
        "Round 140 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round140_green_guardrail_markdown() -> str:
    lines = [
        "# Round 140 R8 Loop-8 Green Guardrails",
        "",
        "- Do not apply R8 Loop-8 v8.0 weights to production scoring yet.",
...
def render_round140_risk_overlay_markdown() -> str:
    lines = ["# Round 140 R8 Loop-8 Risk Overlays", ""]
    for overlay in ROUND140_RISK_OVERLAYS:
...
def render_round140_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 140 R8 Loop-8 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round140_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND140_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round140CaseCandidate) -> str:
...
def _rerating_result(candidate: Round140CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round140ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
