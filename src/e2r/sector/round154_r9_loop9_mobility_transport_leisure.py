"""Round-154 R9 Loop-9 mobility, transport, and leisure pack.

Round 154 tightens the R9 mobility, transport, and leisure pack. It keeps the
...
ROUND154_SOURCE_ROUND_PATH = "docs/round/round_154.md"
ROUND154_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round154_r9_loop9_mobility_transport_leisure"
ROUND154_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r9_loop9_round154.jsonl"
ROUND154_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round154_r9_loop9_v9.csv"


@dataclass(frozen=True)
class Round154ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round154ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round154ScoreWeightDraft
...
GATE_WEIGHT = Round154ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND154_BASE_SCORE_AXES: tuple[Round154BaseScoreAxis, ...] = (
    Round154BaseScoreAxis(
...
ROUND154_SCORE_TARGETS: tuple[Round154ScoreTarget, ...] = (
    Round154ScoreTarget(
        "AUTO_MOBILITY_COMPLETED_VEHICLE",
        E2RArchetype.AUTO_MOBILITY_COMPLETED_VEHICLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(20, 18, 10, 15, 17, 10, 5),
    ...
    Round154ScoreTarget(
        ...
        Round154ScoreWeightDraft(21, 20, 11, 15, 17, 10, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(18, 18, 9, 12, 13, 5, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(20, 18, 11, 14, 14, 3, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(21, 19, 14, 14, 13, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(18, 16, 9, 13, 11, 0, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(17, 17, 10, 15, 10, 0, 6),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(16, 16, 10, 14, 9, 0, 6),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(17, 17, 10, 14, 9, 0, 6),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(17, 12, 12, 10, 9, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(18, 14, 5, 12, 10, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(17, 13, 5, 12, 10, 1, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(18, 13, 5, 12, 10, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(8, 7, 4, 10, 6, 0, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round154ScoreWeightDraft(20, 7, 18, 8, 7, 0, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(18, 15, 6, 12, 10, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(15, 12, 6, 10, 8, 1, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round154ScoreWeightDraft(16, 13, 6, 11, 8, 1, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round154ScoreWeightDraft(8, 8, 6, 12, 6, 0, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round154ScoreWeightDraft(14, 13, 8, 12, 9, 0, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round154ScoreWeightDraft(19, 21, 10, 13, 11, 2, 5),
    ...
    Round154ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round154ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND154_CASE_CANDIDATES: tuple[Round154CaseCandidate, ...] = (
    Round154CaseCandidate(
        ...
        ("round_154.md Reuters Hyundai hybrid expansion and shareholder return",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Hyundai US output and margin goal cut",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Toyota hybrid bottleneck",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Avride Hyundai robotaxi",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Axios Uber Avride Dallas autonomous rides",),
    ...
    Round154CaseCandidate(
        ...
        "robotaxi_operational_reality_check",
        "needs_price_backfill",
        ("round_154.md Reuters Tesla Texas robotaxi wait times",),
    ...
    Round154CaseCandidate(
        ...
        "robotaxi_safety_4c",
        "needs_price_backfill",
        ("round_154.md Reuters Waymo flooded-road recall",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md MySA Avride Texas crashes and federal probe",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md The Verge Aurora first driverless delivery Texas",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Axios Bot Auto paid driverless freight",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters GM hires Aurora cofounder as chief product officer",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Korean Air record revenue and integration",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters China group visa-free entry",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters SES airline connectivity",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Maersk unsustainable container rates", "round_154.md Reuters falling ocean rates",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Axios Hertz sells 20,000 EVs",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Michelin annual outlook cut",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Joby discounted offering",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Lilium cash crunch",),
    ...
    Round154CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_154.md Reuters Archer Part 135",),
...
ROUND154_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
ROUND154_RISK_OVERLAYS: tuple[str, ...] = (
...
def target_for(target_id: str) -> Round154ScoreTarget | None:
    for target in ROUND154_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round154_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND154_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round154 R9 Loop-9 case for {candidate.target_id}; "
...
def round154_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round154_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for axis in ROUND154_BASE_SCORE_AXES
    )


def round154_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND154_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round154_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round154_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round154_backfill": "true"} for field in ROUND154_PRICE_FIELDS)


def round154_summary() -> dict[str, int | bool]:
    records = round154_case_records()
    return {
        "target_count": len(ROUND154_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND154_BASE_SCORE_AXES),
        ...
        "green_possible_count": sum(1 for target in ROUND154_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND154_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND154_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND154_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round154_r9_loop9_reports(
    *,
    output_directory: str | Path = ROUND154_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND154_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND154_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round154_r9_loop9_mobility_transport_leisure_summary.md",
        "case_matrix": output / "round154_r9_loop9_case_matrix.csv",
        "stage_date_plan": output / "round154_r9_loop9_stage_date_plan.csv",
        "base_score_axes": output / "round154_r9_loop9_base_score_axes.csv",
        "green_guardrails": output / "round154_r9_loop9_green_guardrails.md",
        "risk_overlays": output / "round154_r9_loop9_risk_overlays.md",
        "price_validation_plan": output / "round154_r9_loop9_price_validation_plan.md",
        "price_fields": output / "round154_r9_loop9_price_fields.csv",
    }
    _write_case_jsonl(round154_case_records(), cases)
    _write_rows(round154_score_profile_rows(), score_profiles)
    _write_rows(round154_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round154_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round154_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round154_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round154_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round154_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round154_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round154_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round154_summary_markdown() -> str:
    summary = round154_summary()
    lines = [
        "# Round 154 R9 Loop-9 Mobility/Transport/Leisure Summary",
        "",
        "Round 154 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round154_green_guardrail_markdown() -> str:
    lines = [
        "# Round 154 R9 Loop-9 Green Guardrails",
        "",
        "- Do not apply R9 Loop-9 v9.0 weights to production scoring yet.",
...
def render_round154_risk_overlay_markdown() -> str:
    lines = ["# Round 154 R9 Loop-9 Risk Overlays", ""]
    for overlay in ROUND154_RISK_OVERLAYS:
...
def render_round154_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 154 R9 Loop-9 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round154_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND154_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round154CaseCandidate) -> str:
...
def _rerating_result(candidate: Round154CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round154ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
