...
DEFAULT_ARCHETYPE_KEYWORDS: dict[E2RArchetype, tuple[str, ...]] = {
    ...
    E2RArchetype.AUTO_MOBILITY_COMPLETED_VEHICLE: ("완성차", "전기차", "하이브리드", "수출차"),
    E2RArchetype.AI_DATA_CENTER_INFRASTRUCTURE: ("데이터센터", "AI전력", "전력망", "서버전력", "냉각"),
    E2RArchetype.NUCLEAR_SMR_GRID_POLICY: ("원전", "SMR", "체코", "전력망 정책"),
    E2RArchetype.TRAVEL_LEISURE_REOPENING: ("여행", "레저", "리오프닝", "항공수요"),
    E2RArchetype.EDUCATION_SPECIALTY_SERVICES: ("교육", "입시", "평생교육", "전문서비스"),
    E2RArchetype.RARE_METALS_STRATEGIC_MATERIALS: ("희소금속", "희토류", "전략소재", "텅스텐"),
    E2RArchetype.VALUE_UP_SHAREHOLDER_RETURN: ("밸류업", "주주환원", "자사주", "배당"),
    ...
    E2RArchetype.BIOTECH_PRE_REVENUE_REGULATORY: ("전임상", "임상", "허가", "FDA"),
    E2RArchetype.BIOTECH_ROYALTY_COMMERCIALIZATION: ("로열티", "마일스톤", "기술수출", "상업화"),
    E2RArchetype.CDMO_HEALTHCARE_CONTRACT: ("CDMO", "위탁생산", "바이오의약품 생산", "수주"),
