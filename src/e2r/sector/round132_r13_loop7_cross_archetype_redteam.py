"""Round-132 R13 Loop-7 cross-archetype RedTeam / 4B / price validation pack.

Round 132 is a common validation layer over the R1-R12 sector/archetype work.
...
ROUND132_SOURCE_ROUND_PATH = "docs/round/round_132.md"
ROUND132_LARGE_SECTOR = "CROSS_ARCHETYPE_REDTEAM_4B_PRICE_VALIDATION"
ROUND132_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round132_r13_loop7_cross_archetype_redteam"
ROUND132_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r13_loop7_round132.jsonl"
ROUND132_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round132_r13_loop7_v7.csv"


@dataclass(frozen=True)
class Round132OverlayWeightDraft:
    eps_fcf: str
...
@dataclass(frozen=True)
class Round132OverlayTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round132OverlayWeightDraft
...
ROUND132_OVERLAY_AXES: tuple[Round132OverlayAxis, ...] = (
    Round132OverlayAxis(
    ...
    Round132OverlayAxis(
        ...
        10,
        ("list_only_disclosure", "single_source_claim", "undated_document"),
        ("detail_fetched", "amount_customer_duration_verified", "audit_status_checked", "legal_scope_checked"),
        ("disclosure_confidence_high", "no_hard_redteam", "redteam_review_passed"),
        ("redteam_ignored_during_crowded_rally",),
...
ROUND132_OVERLAY_TARGETS: tuple[Round132OverlayTarget, ...] = (
    Round132OverlayTarget(
        "STRUCTURAL_SUCCESS_ALIGNED",
        E2RArchetype.STRUCTURAL_SUCCESS_ALIGNED,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round132OverlayWeightDraft("+", "+", "+", "+", "+", "optional", "+", "pass_if_no_redteam"),
    ...
    Round132OverlayTarget(
        ...
        Round132OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "stage4b_watch"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round132OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "policy_4b_overlay"),
    ...
    Round132OverlayTarget(
        ...
        Round132OverlayWeightDraft("0", "0", "0", "-", "-", "0", "-", "green_block"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round132OverlayWeightDraft("0~+", "0", "0", "+", "0", "0", "medium", "event_split"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round132OverlayWeightDraft("+", "+", "optional", "+", "optional", "0", "+", "stage2_candidate"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round132OverlayWeightDraft("+", "low", "+", "0", "low", "0", "medium", "cycle_cap"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("-", "-", "-", "-", "-", "0", "-", "score_recalibration"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round132OverlayWeightDraft("+", "+", "optional", "0", "-", "optional", "+", "alignment_review"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_block"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_review"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_soft_gate"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("-", "-", "0", "-", "-", "-", "medium", "green_block"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("hard-", "hard-", "0", "hard-", "hard-", "hard-", "+", "hard_4c"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_hard_review"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_infra_hard_review"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "ai_infra_hard_review"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "policy_price_path_shock"),
        (
            "tax_policy_comment",
            "ai_windfall_tax",
            "citizen_dividend",
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+", "stage3_confidence_cap"),
    ...
    Round132OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round132OverlayWeightDraft("0", "0", "0", "0", "0", "0", "low", "green_block"),
...
ROUND132_CASE_CANDIDATES: tuple[Round132CaseCandidate, ...] = (
    Round132CaseCandidate(
        ...
        ("round_132.md Reuters SK Hynix AI boom / market value",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Hyundai sales target / hybrid / buyback",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Korea Commercial Act revision",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Circle reserve income / USDC circulation",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Blackstone data-center vehicle IPO",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Fermi AI data-center IPO",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md event-to-contract escalation rule",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Barron's Korea AI tax / KOSPI shock",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Nvidia / CoreWeave financing and capacity relationship",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md AP SMCI auditor resignation",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters CrowdStrike outage and lawsuit",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters TerraUSD/Luna collapse",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters bluebird bio cash crunch",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Novo GLP-1 guide down",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Hindenburg Equinix short report",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md Reuters Equinix capex / AFFO per share disappointment",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md disclosure confidence cap rule",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md price-only rally definition",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md event premium bucket",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md cyclical success rule",),
    ...
    Round132CaseCandidate(
        ...
        "false_positive_score",
        "needs_price_backfill",
        ("round_132.md false-positive score rule",),
    ...
    Round132CaseCandidate(
        ...
        "evidence_good_but_price_failed",
        "needs_price_backfill",
        ("round_132.md evidence-good price-failed rule",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md legal/regulatory RedTeam rule",),
    ...
    Round132CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_132.md leverage/FCF breakdown rule",),
    ...
    Round132CaseCandidate(
        ...
        "unknown_insufficient_evidence",
        "needs_price_backfill",
        ("round_132.md insufficient evidence rule",),
        "Unknown evidence must remain unknown; missing fields are not filled.",
    ),
)


ROUND132_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "market",
...
def round132_target_for(target_id: str) -> Round132OverlayTarget | None:
    for target in ROUND132_OVERLAY_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round132_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND132_CASE_CANDIDATES:
        target = round132_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round132 R13 Loop-7 cross-archetype validation case for {candidate.target_id}; "
            ...
            score_price_alignment=_round132_score_price_alignment(candidate),
            rerating_result=_round132_rerating_result(candidate),
            price_pattern=candidate.alignment_hint,
            score_weight_hint=_round132_score_weight_hint(target),
            green_guardrails=(
...
def round132_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round132_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND132_CASE_CANDIDATES:
        target = round132_target_for(candidate.target_id)
...
def round132_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round132_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round132_backfill": "true"} for field in ROUND132_PRICE_FIELDS)


def round132_overlay_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_csv_dict() for axis in ROUND132_OVERLAY_AXES)


def round132_summary() -> dict[str, int | bool]:
    records = round132_case_records()
    return {
        "target_count": len(ROUND132_OVERLAY_TARGETS),
        "overlay_axis_count": len(ROUND132_OVERLAY_AXES),
        ...
        "hard_gate_target_count": sum(1 for target in ROUND132_OVERLAY_TARGETS if target.hard_gate),
        "green_possible_count": sum(1 for target in ROUND132_OVERLAY_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND132_OVERLAY_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND132_OVERLAY_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round132_r13_loop7_reports(
    *,
    output_directory: str | Path = ROUND132_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND132_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND132_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round132_r13_loop7_cross_archetype_redteam_summary.md",
        "case_matrix": output / "round132_r13_loop7_case_matrix.csv",
        "target_matrix": output / "round132_r13_loop7_overlay_target_matrix.csv",
        "stage_date_plan": output / "round132_r13_loop7_stage_date_plan.csv",
        "redteam_gate_plan": output / "round132_r13_loop7_redteam_gate_plan.md",
        "price_validation_plan": output / "round132_r13_loop7_price_validation_plan.md",
        "price_fields": output / "round132_r13_loop7_price_fields.csv",
        "overlay_axes": output / "round132_r13_loop7_overlay_axes.csv",
    }
    _write_case_jsonl(round132_case_records(), cases)
    _write_rows(round132_score_profile_rows(), score_profiles)
    _write_rows(round132_score_profile_rows(), paths["target_matrix"])
    _write_rows(round132_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round132_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round132_price_field_rows(), paths["price_fields"])
    _write_rows(round132_overlay_axis_rows(), paths["overlay_axes"])
    paths["summary"].write_text(render_round132_summary_markdown(), encoding="utf-8")
    paths["redteam_gate_plan"].write_text(render_round132_redteam_gate_plan_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round132_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round132_summary_markdown() -> str:
    summary = round132_summary()
    lines = [
        "# Round-132 R13 Loop-7 Cross-Archetype RedTeam / 4B / Price Validation",
        "",
        f"- source_round: `{ROUND132_SOURCE_ROUND_PATH}`",
        f"- large_sector: `{ROUND132_LARGE_SECTOR}`",
        ...
        "## Interpretation",
        "",
        "- Round 132 is a common validation overlay, not a sector score-owner.",
        ...
        "",
        "## R13 v7 Cross-Archetype Overlay Axes",
        "",
    ]
    for axis in ROUND132_OVERLAY_AXES:
...
def render_round132_redteam_gate_plan_markdown() -> str:
    lines = [
...
def render_round132_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-132 R13 Loop-7 Price / Stage Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round132_case_candidate_rows():
...
def _round132_score_price_alignment(candidate: Round132CaseCandidate) -> str:
...
def _round132_rerating_result(candidate: Round132CaseCandidate) -> str:
...
def _round132_score_weight_hint(target: Round132OverlayTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
        "eps_fcf": _round132_symbolic_weight(weights["eps_fcf"]),
        "visibility": _round132_symbolic_weight(weights["structural_visibility"]),
        "bottleneck": _round132_symbolic_weight(weights["bottleneck_pricing"]),
        "mispricing": _round132_symbolic_weight(weights["market_mispricing"]),
        "valuation": _round132_symbolic_weight(weights["valuation"]),
        "capital_allocation": _round132_symbolic_weight(weights["capital_allocation"]),
        "information_confidence": _round132_symbolic_weight(weights["information_confidence"]),
    }


def _round132_symbolic_weight(value: str) -> float:
    return {
        "+": 1.0,
        "0": 0.0,
        "-": -1.0,
...
__all__ = [
    "ROUND132_CASE_CANDIDATES",
    "ROUND132_DEFAULT_CASES_PATH",
    "ROUND132_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND132_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND132_LARGE_SECTOR",
    "ROUND132_OVERLAY_AXES",
    "ROUND132_OVERLAY_TARGETS",
    "ROUND132_PRICE_FIELDS",
    "Round132CaseCandidate",
    "Round132OverlayAxis",
    "Round132OverlayTarget",
    "Round132OverlayWeightDraft",
    "render_round132_price_validation_plan_markdown",
    "render_round132_redteam_gate_plan_markdown",
    "render_round132_summary_markdown",
    "round132_case_candidate_rows",
    "round132_case_records",
    "round132_overlay_axis_rows",
    "round132_price_field_rows",
    "round132_score_profile_rows",
    "round132_stage_date_rows",
    "round132_summary",
    "round132_target_for",
    "write_round132_r13_loop7_reports",
]
