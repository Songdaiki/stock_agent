"""Round-163 R5 Loop-10 consumer, retail, and brand calibration pack.

Round 163 tightens R5 by separating consumer buzz from EPS/FCF bodyweight
...
ROUND163_SOURCE_ROUND_PATH = "docs/round/round_163.md"
ROUND163_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round163_r5_loop10_consumer_retail_brand"
ROUND163_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r5_loop10_round163.jsonl"
ROUND163_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round163_r5_loop10_v10.csv"
ROUND163_SOURCE_CANONICAL_TARGET_COUNT = 26


@dataclass(frozen=True)
class Round163ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round163ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round163ScoreWeightDraft
...
@dataclass(frozen=True)
class Round163ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round163ScoreWeightDraft:
    return Round163ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round163ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND163_BASE_SCORE_WEIGHTS: tuple[Round163BaseScoreWeight, ...] = (
    Round163BaseScoreWeight(
    ...
    Round163BaseScoreWeight(
        ...
        12,
        "Recall, tariff, import review, data breach, IP, product safety, trust failure, and disclosure gaps are stronger Loop-10 gates.",
    ),
    Round163BaseScoreWeight(
...
ROUND163_STAGE_CAPS: tuple[Round163StageCap, ...] = (
    Round163StageCap(
...
ROUND163_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round163ScoreStagePriceAlignment, ...] = (
    Round163ScoreStagePriceAlignment(
    ...
    Round163ScoreStagePriceAlignment(
        "ulta_kbeauty_retail_platform_case",
        "Stage 2",
        "Ulta net sales +12.9%, same-store sales +6.3%, and after-hours share price around +6%",
        "retailer channel thesis is useful, but brand-level sell-through, reorder, and margin quality are still unverified",
        "raise K-beauty retail-platform Stage 2 credit; keep brand-level sell-through, reorder, inventory, receivables, and OPM gates",
    ),
    Round163ScoreStagePriceAlignment(
...
ROUND163_SCORE_TARGETS: tuple[Round163ScoreTarget, ...] = (
    _target(
...
ROUND163_CASE_CANDIDATES: tuple[Round163CaseCandidate, ...] = (
    Round163CaseCandidate(
        "samyang_buldak_export_rerating_case",
        "EXPORT_RECURRING_CONSUMER",
        "003230",
        "삼양식품 Buldak 수출 리레이팅",
        ...
        ("round_163.md MarketWatch Samyang Buldak target revision",),
    ...
    Round163CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_163.md AP Samyang Denmark recall",),
    ...
    Round163CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_163.md AP Samyang Denmark partial reversal",),
    ...
    Round163CaseCandidate(
        ...
        ("round_163.md K-food hero to portfolio expansion framework",),
    ...
    Round163CaseCandidate(
        ...
        ("round_163.md Reuters K-beauty US export",),
    ...
    Round163CaseCandidate(
        ...
        "K_BEAUTY_RETAIL_PLATFORM",
        "ULTA",
        "Ulta Beauty K-beauty retail platform",
        "US",
        "success_candidate",
        None,
        None,
        ...
        None,
        (
            "ulta_exclusive_kbeauty_selection",
            "medicube_tirtir_fwee_unleashia",
            "net_sales_growth_12_9pct",
            "same_store_sales_growth_6_3pct",
            "after_hours_share_price_plus_6pct",
            "curated_channel_expansion",
        ),
        ("brand_level_sell_through_unverified", "reorder_unverified", "inventory_growth", "brand_churn", "channel_conflict"),
        "ulta_kbeauty_retail_platform_stage2",
        "needs_exact_stage_date_backfill",
        ("round_163.md Business Insider Ulta K-beauty earnings",),
        "Retailer-level sales, same-store sales growth, and after-hours price reaction support Stage 2 channel evidence, but brand-level sell-through, reorder, and margin are still needed.",
        (
            E2RArchetype.K_BEAUTY_EXPORT_DISTRIBUTION,
            E2RArchetype.K_BEAUTY_OFFLINE_SELL_THROUGH,
            E2RArchetype.CHANNEL_STUFFING_INVENTORY_OVERLAY,
    ...
    Round163CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_163.md AP K-beauty US tariff risk",),
    ...
    Round163CaseCandidate(
        ...
        ("round_163.md K-beauty offline sell-through framework",),
    ...
    Round163CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_163.md FT APR beauty device",),
    ...
    Round163CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_163.md Vogue Medicube omnichannel",),
    ...
    Round163CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_163.md Reuters K-beauty fast beauty OEM/ODM",),
    ...
    Round163CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_163.md Barron's Coupang data breach",),
    ...
    Round163CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_163.md Reuters Coupang supplier regulation",),
    ...
    Round163CaseCandidate(
        ...
        "needs_source_date_and_price_backfill",
        ("round_163.md Coway rental model reference",),
    ...
    Round163CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_163.md Barron's Whirlpool dividend suspension",),
    ...
    Round163CaseCandidate(
        ...
        ("round_163.md Reuters Shein Temu litigation",),
    ...
    Round163CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_163.md FT France EU Shein Temu crackdown",),
...
ROUND163_PRICE_FIELDS: tuple[str, ...] = (
    ...
    "ulta_net_sales_growth", "ulta_same_store_sales_growth", "after_hours_share_price_change", "retailer_exclusive_selection_flag",
...
def round163_target_for(target_id: str) -> Round163ScoreTarget | None:
    for target in ROUND163_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round163_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND163_CASE_CANDIDATES:
        target = round163_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round163 R5 Loop-10 case for {candidate.target_id}; "
...
def round163_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round163_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND163_CASE_CANDIDATES:
        target = round163_target_for(candidate.target_id)
...
def round163_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round163_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round163_backfill": "true"} for field in ROUND163_PRICE_FIELDS)


def round163_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND163_BASE_SCORE_WEIGHTS
    )


def round163_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND163_STAGE_CAPS
    )


def round163_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND163_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round163_summary() -> dict[str, int | bool]:
    records = round163_case_records()
    return {
        "target_count": len(ROUND163_SCORE_TARGETS),
        "source_canonical_target_count": ROUND163_SOURCE_CANONICAL_TARGET_COUNT,
        "helper_overlay_target_count": len(ROUND163_SCORE_TARGETS) - ROUND163_SOURCE_CANONICAL_TARGET_COUNT,
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND163_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND163_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND163_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND163_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND163_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND163_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND163_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round163_r5_loop10_reports(
    *,
    output_directory: str | Path = ROUND163_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND163_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND163_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round163_r5_loop10_consumer_retail_brand_summary.md",
        "case_matrix": output / "round163_r5_loop10_case_matrix.csv",
        "stage_date_plan": output / "round163_r5_loop10_stage_date_plan.csv",
        "green_guardrails": output / "round163_r5_loop10_green_guardrails.md",
        "risk_overlays": output / "round163_r5_loop10_risk_overlays.md",
        "price_validation_plan": output / "round163_r5_loop10_price_validation_plan.md",
        "price_fields": output / "round163_r5_loop10_price_fields.csv",
        "base_score_weights": output / "round163_r5_loop10_base_score_weights.csv",
        "stage_caps": output / "round163_r5_loop10_stage_caps.csv",
        "score_stage_price_alignment": output / "round163_r5_loop10_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round163_r5_loop10_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round163_case_records(), cases)
    _write_rows(round163_score_profile_rows(), score_profiles)
    _write_rows(round163_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round163_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round163_price_field_rows(), paths["price_fields"])
    _write_rows(round163_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round163_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round163_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round163_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round163_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round163_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round163_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round163_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round163_summary_markdown() -> str:
    summary = round163_summary()
    lines = [
        "# Round-163 R5 Loop-10 Consumer / Retail / Brand Summary",
        "",
        f"- source_round: `{ROUND163_SOURCE_ROUND_PATH}`",
        "- large_sector: `CONSUMER_RETAIL_BRAND`",
        "- loop: `R5 Loop 10 / v10.0`",
        ...
        "## Interpretation",
        "",
        "- R5 Loop 10 says brand buzz and recurring FCF are different things.",
        ...
        "- Example: Ulta K-beauty selection and same-store sales confirm channel momentum, but brand-level sell-through, reorder, inventory, and OPM decide whether it can move higher.",
...
def render_round163_green_guardrail_markdown() -> str:
    lines = [
        "# Round-163 R5 Loop-10 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R5 Loop-10 v10.0 weights to production scoring yet.",
...
def render_round163_risk_overlay_markdown() -> str:
    lines = [
        "# Round-163 R5 Loop-10 Risk Overlays",
        "",
        ...
        "- `ULTA_RETAIL_CHANNEL_STAGE2`: Ulta sales and same-store sales support channel Stage 2, but brand-level sell-through and reorder remain required.",
...
def render_round163_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-163 R5 Loop-10 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round163_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "- `ULTA_KBEAUTY_RETAIL_PLATFORM_STAGE2`: retailer sales and same-store sales are Stage 2 channel evidence, not brand-level Green proof.",
...
def render_round163_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-163 R5 Loop-10 Score / Stage / Price Alignment",
        "",
        "Round 163 checks whether consumer, retail, and brand score interpretation matches the observed price and operating path.",
...
def _score_price_alignment(candidate: Round163CaseCandidate) -> str:
...
def _rerating_result(candidate: Round163CaseCandidate) -> str:
...
def _score_weight_hint(target: Round163ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND163_CASE_CANDIDATES",
    "ROUND163_DEFAULT_CASES_PATH",
    "ROUND163_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND163_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND163_SOURCE_CANONICAL_TARGET_COUNT",
    "ROUND163_PRICE_FIELDS",
    "ROUND163_BASE_SCORE_WEIGHTS",
    "ROUND163_SCORE_TARGETS",
    "ROUND163_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND163_STAGE_CAPS",
    "Round163BaseScoreWeight",
    "Round163CaseCandidate",
    "Round163ScoreStagePriceAlignment",
    ...
    "Round163ScoreWeightDraft",
    "Round163StageCap",
    "render_round163_green_guardrail_markdown",
    "render_round163_price_validation_plan_markdown",
    "render_round163_risk_overlay_markdown",
    "render_round163_score_stage_price_alignment_markdown",
    "render_round163_summary_markdown",
    "round163_base_score_weight_rows",
    "round163_case_candidate_rows",
    "round163_case_records",
    "round163_price_field_rows",
    "round163_score_profile_rows",
    "round163_score_stage_price_alignment_rows",
    "round163_stage_cap_rows",
    "round163_stage_date_rows",
    "round163_summary",
    "round163_target_for",
    "write_round163_r5_loop10_reports",
]
