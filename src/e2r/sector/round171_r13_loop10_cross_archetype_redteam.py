"""Round-171 R13 Loop-10 cross-archetype RedTeam / 4B / price validation pack.

Round 171 is a common validation layer over the R1-R12 sector/archetype work.
...
ROUND171_SOURCE_ROUND_PATH = "docs/round/round_171.md"
ROUND171_LARGE_SECTOR = "CROSS_ARCHETYPE_REDTEAM_4B_PRICE_VALIDATION"
ROUND171_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round171_r13_loop10_cross_archetype_redteam"
ROUND171_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r13_loop10_round171.jsonl"
ROUND171_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round171_r13_loop10_v10.csv"
ROUND171_SOURCE_CANONICAL_TARGET_IDS: tuple[str, ...] = (
...
ROUND171_SOURCE_CANONICAL_TARGET_COUNT = len(ROUND171_SOURCE_CANONICAL_TARGET_IDS)


@dataclass(frozen=True)
class Round171OverlayWeightDraft:
    eps_fcf: str
...
@dataclass(frozen=True)
class Round171OverlayTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round171OverlayWeightDraft
...
ROUND171_OVERLAY_AXES: tuple[Round171OverlayAxis, ...] = (
    Round171OverlayAxis(
...
ROUND171_STAGE_CAPS: tuple[Round171StageCap, ...] = (
    Round171StageCap(
...
ROUND171_OVERLAY_TARGETS: tuple[Round171OverlayTarget, ...] = (
    Round171OverlayTarget(
        "STRUCTURAL_SUCCESS_ALIGNED",
        E2RArchetype.STRUCTURAL_SUCCESS_ALIGNED,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round171OverlayWeightDraft("+", "+", "+", "+", "+", "optional", "+", "pass_if_no_redteam"),
    ...
    Round171OverlayTarget(
        ...
        Round171OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "stage4b_watch"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round171OverlayWeightDraft("+", "+", "optional", "0~+", "0", "optional", "+", "stage2_cap"),
        ("customer_or_contract_visible", "approval_or_budget_visible", "order_or_arr_visible"),
        ("binding_contract", "customer", "prescription_volume", "arr_billings", "government_order", "tenant_lease"),
        ("eps_fcf_conversion", "repeatability_confirmed", "price_path_aligned", "redteam_clean"),
        ("stage2_story_crowded_before_earnings", "valuation_premium_without_conversion"),
        ("no_eps_fcf_conversion", "price_path_failed", "detail_missing", "stage3_green_evidence_missing", "hard_redteam"),
        ("eps_fcf_conversion", "repeatability_confirmed", "price_path_aligned", "redteam_clean"),
        ("eps_fcf_missing", "repeatability_missing", "stage3_green_evidence_missing", "detail_missing"),
        "Holds real Stage 2 evidence below Green until cash-flow conversion, repeatability, price path, and RedTeam checks pass.",
        "Example: a tenant lease or government order can be useful evidence, but it is still Watch if EPS/FCF conversion is not visible.",
    ),
    Round171OverlayTarget(
        "SECTOR_SUCCESS_BUT_POLICY_SHOCK_WATCH",
        E2RArchetype.SECTOR_SUCCESS_BUT_POLICY_SHOCK_WATCH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round171OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "policy_4b_overlay"),
    ...
    Round171OverlayTarget(
        ...
        Round171OverlayWeightDraft("0", "0", "0", "-", "-", "0", "-", "green_block"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round171OverlayWeightDraft("0~+", "0", "0", "+", "0", "0", "medium", "event_split"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round171OverlayWeightDraft("+", "+", "optional", "+", "optional", "0", "+", "stage2_candidate"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round171OverlayWeightDraft("+", "low", "+", "0", "low", "0", "medium", "cycle_cap"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("-", "-", "-", "-", "-", "0", "-", "score_recalibration"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round171OverlayWeightDraft("+", "+", "optional", "0", "-", "optional", "+", "alignment_review"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_block"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_review"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_soft_gate"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("-", "-", "0", "-", "-", "-", "medium", "green_block"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("hard-", "hard-", "0", "hard-", "hard-", "hard-", "+", "hard_4c"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_hard_review"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_infra_hard_review"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "ai_infra_hard_review"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "policy_price_path_shock"),
        (
            "tax_policy_comment",
            "ai_windfall_tax",
            "citizen_dividend",
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+", "stage3_confidence_cap"),
    ...
    Round171OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round171OverlayWeightDraft("0", "0", "0", "0", "0", "0", "low", "green_block"),
...
ROUND171_CASE_CANDIDATES: tuple[Round171CaseCandidate, ...] = (
    Round171CaseCandidate(
        ...
        ("round_171.md Reuters SK Hynix AI boom / market value",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Hyundai sales target / hybrid / buyback",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Korea Commercial Act revision",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Circle reserve income / USDC circulation",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Blackstone data-center vehicle IPO",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Fermi AI data-center IPO",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md event-to-contract escalation rule",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Barron's Korea AI tax / KOSPI shock",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Nvidia / CoreWeave financing and capacity relationship",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md AP SMCI auditor resignation",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters CrowdStrike outage and lawsuit",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters TerraUSD/Luna collapse",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters bluebird bio cash crunch",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Novo GLP-1 guide down",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Hindenburg Equinix short report",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Equinix capex / AFFO per share disappointment",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md disclosure confidence cap rule",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md price-only rally definition",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md event premium bucket",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md cyclical success rule",),
    ...
    Round171CaseCandidate(
        ...
        "false_positive_score",
        "needs_price_backfill",
        ("round_171.md false-positive score rule",),
    ...
    Round171CaseCandidate(
        ...
        "evidence_good_but_price_failed",
        "needs_price_backfill",
        ("round_171.md evidence-good price-failed rule",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md legal/regulatory RedTeam rule",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md leverage/FCF breakdown rule",),
    ...
    Round171CaseCandidate(
        ...
        "unknown_insufficient_evidence",
        "needs_price_backfill",
        ("round_171.md insufficient evidence rule",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters GE Vernova outlook and backlog",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md R13 structural success list",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md MarketWatch Fortinet AI threat and billings",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Investors Cisco AI networking orders",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Bavarian Nordic stockpile contract and guidance",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Stage 2 but not Green list",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md Reuters Bayer Crop Science soy seed licensing EBITDA",),
    ...
    Round171CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_171.md success but 4B list",),
...
ROUND171_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "market",
    ...
    "ev_ebitda_after",
    "market_cap_usd",
    "one_two_year_runup_pct",
    "sk_hynix_return_2025_pct",
    "sk_hynix_return_2026_pct",
    "contract_value",
    ...
    "datadog_revenue_growth_pct",
    "fortinet_billings_growth_pct",
    "bayer_crop_science_ebitda_growth_pct",
    "crop_science_ebitda_growth_pct",
    "auditor_resignation_flag",
    "supermicro_auditor_resignation_drop_pct",
    "filing_delay_flag",
    "internal_control_issue_flag",
    "regulatory_probe_flag",
    "related_party_risk_flag",
    "security_outage_flag",
    "crowdstrike_affected_devices_count",
    "crowdstrike_market_cap_loss_usd",
    "privacy_breach_flag",
    ...
    "stablecoin_circulation",
    "circle_usdc_circulation",
    "usdc_circulation_growth_pct",
    "reserve_income",
    "circle_reserve_income",
    "ai_payment_option_flag",
    "redemption_at_par_flag",
    "circular_financing_flag",
    "supplier_investor_customer_loop_flag",
    "capacity_guarantee_flag",
    "coreweave_unused_capacity_agreement",
    "nvidia_foundation_compute_purchase",
    "gpu_collateral_debt_flag",
    "customer_contract_concentration",
    "fermi_project_tenant_absent_flag",
    "fermi_funding_agreement_terminated_flag",
    "novo_revenue_decline_guidance_pct",
    "event_only_flag",
    "cycle_only_flag",
...
def round171_target_for(target_id: str) -> Round171OverlayTarget | None:
    for target in ROUND171_OVERLAY_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round171_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND171_CASE_CANDIDATES:
        target = round171_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round171 R13 Loop-10 cross-archetype validation case for {candidate.target_id}; "
            ...
            score_price_alignment=_round171_score_price_alignment(candidate),
            rerating_result=_round171_rerating_result(candidate),
            price_pattern=candidate.alignment_hint,
            score_weight_hint=_round171_score_weight_hint(target),
            green_guardrails=(
...
def round171_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round171_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND171_CASE_CANDIDATES:
        target = round171_target_for(candidate.target_id)
...
def round171_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round171_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round171_backfill": "true"} for field in ROUND171_PRICE_FIELDS)


def round171_overlay_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_csv_dict() for axis in ROUND171_OVERLAY_AXES)


def round171_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND171_STAGE_CAPS)


def round171_summary() -> dict[str, int | bool]:
    records = round171_case_records()
    return {
        "target_count": len(ROUND171_OVERLAY_TARGETS),
        "source_canonical_target_count": ROUND171_SOURCE_CANONICAL_TARGET_COUNT,
        "overlay_axis_count": len(ROUND171_OVERLAY_AXES),
        "stage_cap_count": len(ROUND171_STAGE_CAPS),
        ...
        "hard_gate_target_count": sum(1 for target in ROUND171_OVERLAY_TARGETS if target.hard_gate),
        "green_possible_count": sum(1 for target in ROUND171_OVERLAY_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND171_OVERLAY_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND171_OVERLAY_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round171_r13_loop10_reports(
    *,
    output_directory: str | Path = ROUND171_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND171_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND171_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round171_r13_loop10_cross_archetype_redteam_summary.md",
        "case_matrix": output / "round171_r13_loop10_case_matrix.csv",
        "target_matrix": output / "round171_r13_loop10_overlay_target_matrix.csv",
        "stage_date_plan": output / "round171_r13_loop10_stage_date_plan.csv",
        "redteam_gate_plan": output / "round171_r13_loop10_redteam_gate_plan.md",
        "price_validation_plan": output / "round171_r13_loop10_price_validation_plan.md",
        "price_fields": output / "round171_r13_loop10_price_fields.csv",
        "overlay_axes": output / "round171_r13_loop10_overlay_axes.csv",
        "stage_caps": output / "round171_r13_loop10_stage_caps.csv",
    }
    _write_case_jsonl(round171_case_records(), cases)
    _write_rows(round171_score_profile_rows(), score_profiles)
    _write_rows(round171_score_profile_rows(), paths["target_matrix"])
    _write_rows(round171_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round171_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round171_price_field_rows(), paths["price_fields"])
    _write_rows(round171_overlay_axis_rows(), paths["overlay_axes"])
    _write_rows(round171_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round171_summary_markdown(), encoding="utf-8")
    paths["redteam_gate_plan"].write_text(render_round171_redteam_gate_plan_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round171_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round171_summary_markdown() -> str:
    summary = round171_summary()
    lines = [
        "# Round-171 R13 Loop-10 Cross-Archetype RedTeam / 4B / Price Validation",
        "",
        f"- source_round: `{ROUND171_SOURCE_ROUND_PATH}`",
        f"- large_sector: `{ROUND171_LARGE_SECTOR}`",
    ...
    for axis in ROUND171_OVERLAY_AXES:
    ...
    for cap in ROUND171_STAGE_CAPS:
...
def render_round171_redteam_gate_plan_markdown() -> str:
    lines = [
...
def render_round171_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round171_case_candidate_rows():
...
def _round171_score_price_alignment(candidate: Round171CaseCandidate) -> str:
...
def _round171_rerating_result(candidate: Round171CaseCandidate) -> str:
...
def _round171_score_weight_hint(target: Round171OverlayTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
        "eps_fcf": _round171_symbolic_weight(weights["eps_fcf"]),
        "visibility": _round171_symbolic_weight(weights["structural_visibility"]),
        "bottleneck": _round171_symbolic_weight(weights["bottleneck_pricing"]),
        "mispricing": _round171_symbolic_weight(weights["market_mispricing"]),
        "valuation": _round171_symbolic_weight(weights["valuation"]),
        "capital_allocation": _round171_symbolic_weight(weights["capital_allocation"]),
        "information_confidence": _round171_symbolic_weight(weights["information_confidence"]),
    }


def _round171_symbolic_weight(value: str) -> float:
    return {
        "+": 1.0,
        "0": 0.0,
        "-": -1.0,
...
__all__ = [
    ...
    "ROUND171_DEFAULT_CASES_PATH",
    "ROUND171_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND171_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND171_LARGE_SECTOR",
    "ROUND171_OVERLAY_AXES",
    "ROUND171_OVERLAY_TARGETS",
    "ROUND171_PRICE_FIELDS",
