"""Round-169 R12 Loop-10 agriculture, life services, and miscellaneous pack.

Round 169 tightens the R12 unit-economics pack from Round 104. Agriculture,
...
Loop 10 reinforces the cycle and regulation splitters from the prior R12 pass:
seed/IP licensing, fertilizer input cycles, animal-health conditional approval,
right-to-repair expansion outside agriculture, vertical-farming unit economics,
AI education monetization/disruption, self-checkout local regulation, nicotine
youth-safety, and partial cannabis rescheduling limits.
...
ROUND169_SOURCE_ROUND_PATH = "docs/round/round_169.md"
ROUND169_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round169_r12_loop10_agri_life_misc"
ROUND169_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r12_loop10_round169.jsonl"
ROUND169_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round169_r12_loop10_v10.csv"

ROUND169_SOURCE_CANONICAL_TARGET_IDS: tuple[str, ...] = (
    ...
    "FERTILIZER_INPUT_COST_SULFURIC_ACID",
...
ROUND169_SOURCE_CANONICAL_TARGET_COUNT = len(ROUND169_SOURCE_CANONICAL_TARGET_IDS)


@dataclass(frozen=True)
class Round169ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round169ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round169ScoreWeightDraft
...
ROUND169_BASE_SCORE_AXES: tuple[Round169BaseScoreAxis, ...] = (
    Round169BaseScoreAxis(
...
ROUND169_STAGE_CAPS: tuple[Round169StageCap, ...] = (
    Round169StageCap(
        "stage1_theme_event_cap",
        "Stage 1",
        "45",
        (
            "avian_flu_or_asf_price_news",
            "smart_farm_or_vertical_farming_narrative",
            "autonomous_agri_machinery_announcement",
            "ai_education_feature_launch",
            "self_checkout_or_kiosk_installation",
            "nicotine_alternative_theme",
            "cannabis_rescheduling_headline",
        ),
        (
            "actual_order",
            "recurring_service_revenue",
            "regulatory_authorization_scope",
            "bookings_or_paid_conversion",
            "unit_economics_positive",
            "date_verified_price_path",
        ),
        (
            "disease_one_off",
            "hardware_cycle_only",
            "pre_revenue_vertical_farm",
            "partial_rescheduling_misclassified",
            "youth_safety_warning",
        ),
        "R12 headlines route research, but disease, AI, smart-farm, kiosk, nicotine, or cannabis labels stay Stage 1 until revenue-quality evidence appears.",
    ),
    Round169StageCap(
        "stage2_repeat_revenue_unit_economics_cap",
        "Stage 2",
        "70",
        (
            "licensing_revenue",
            "government_conditional_approval",
            "fda_or_dea_authorization",
            "bookings_growth",
            "recurring_service_account_growth",
            "operating_contract",
            "stage2_price_response",
        ),
        (
            "repeat_contract",
            "repeat_revenue",
            ...
            "opm_expansion",
            "churn_cac_stable",
            "farm_income_or_farmer_margin_stable",
            "public_health_gate_passed",
        ),
        (
            "bookings_miss",
            "demand_cycle_collapse",
            "right_to_repair_lawsuit",
            "vertical_farming_shutdown",
            "regulatory_scope_limited",
            "livestock_price_investigation",
        ),
        "Licensing, approval, bookings, or service-account evidence can reach Stage 2, but Stage 3 needs repeat economics and clean RedTeam checks.",
    ),
    Round169StageCap(
        "stage3_recurring_fcf_gate",
        "Stage 3",
        "requires_score_above_70_and_recurring_fcf",
        (
            "candidate_above_70_without_repeat_revenue",
            "green_requested_from_regulatory_approval_only",
            "theme_rerating_before_unit_economics",
        ),
        (
            "recurring_revenue",
            "unit_economics_positive",
            "price_pass_through_or_pricing_power",
            "fcf_after_capex",
            "regulatory_scope_verified",
            "public_health_gate_passed",
            "redteam_clean",
        ),
        (
            "chapter11",
            "dividend_suspension",
            "ai_core_service_substitution",
            "self_checkout_local_regulation",
            "fda_or_dea_scope_reversal",
            "youth_safety_backlash",
        ),
        "R12 Stage 3 is intentionally rare: the case must become recurring FCF, not just essential-demand or regulatory headline evidence.",
    ),
    Round169StageCap(
        "stage4b_4c_misc_theme_unwind_gate",
        "4B/4C",
        "watch_or_break",
        (
            "smart_farm_hype",
            "ai_education_hype",
            "disease_beneficiary_hype",
            "nicotine_or_cannabis_hype",
            "agriculture_input_cycle_crowding",
            "hardware_replacement_rally",
        ),
        (
            "follow_on_order",
            "retention_and_bookings_intact",
            "regulatory_clarity",
            "price_path_stabilized",
            "fcf_conversion_confirmed",
        ),
        (
            "hardware_guide_cut",
            "bookings_miss",
            "diagnostic_or_disease_normalization",
            "vertical_farming_shutdown",
            "antitrust_or_price_probe",
            "partial_rescheduling_misclassified",
        ),
        "R12 themes often become 4B or 4C before Green; price moves without repeat economics stay visible as watch or thesis-break evidence.",
    ),
)


ROUND169_SCORE_TARGETS: tuple[Round169ScoreTarget, ...] = (
    Round169ScoreTarget(
        "SMART_FARM_AGRI_TECH",
        E2RArchetype.SMART_FARM_AGRI_TECH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(17, 13, 12, 9, 8, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round169ScoreWeightDraft(8, 6, 5, 7, 5, 0, 4),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(16, 13, 10, 10, 9, 1, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(14, 11, 8, 9, 7, 1, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(16, 14, 9, 11, 9, 1, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round169ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(18, 16, 11, 12, 10, 1, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(18, 11, 14, 9, 8, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(16, 12, 13, 10, 8, 0, 5),
    ...
    Round169ScoreTarget(
        "FERTILIZER_INPUT_COST_SULFURIC_ACID",
        E2RArchetype.FERTILIZER_INPUT_COST_SULFURIC_ACID,
        Round10ThemePosture.REDTEAM_FIRST,
        Round169ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
        ("phosphate_price_strength", "fertilizer_supply_tightness", "sulfuric_acid_cost", "sulfur_cost"),
        ("input_cost_risk_detected", "production_guidance_at_risk"),
        ("normally_blocked_if_input_cost_overwhelms_phosphate_price",),
        ("fertilizer_price_rally_before_input_cost_audit",),
        (
            "sulfuric_acid_spike",
            "sulfur_cost_spike",
            "ammonia_cost_spike",
        ...
        ("input_cost_risk_resolved", "farmer_margin_stable", "fcf_conversion"),
        ("sulfuric_acid", "sulfur", "ammonia", "urea", "production_curtailment", "guidance_withdrawal"),
        "Fertilizer price strength can fail when sulfuric acid, sulfur, ammonia, or urea costs overwhelm phosphate pricing.",
        gate_only=True,
    ),
    Round169ScoreTarget(
        "AGRI_LIVESTOCK_FOOD_COMMODITY",
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round169ScoreWeightDraft(18, 8, 14, 8, 7, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(18, 16, 8, 11, 9, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(14, 12, 8, 10, 8, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(17, 16, 5, 12, 10, 2, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(16, 15, 5, 12, 9, 1, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round169ScoreWeightDraft(10, 8, 4, 8, 5, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(14, 10, 5, 8, 6, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(15, 13, 7, 10, 8, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(18, 15, 8, 12, 10, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(16, 13, 8, 10, 8, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round169ScoreWeightDraft(16, 14, 8, 11, 8, 0, 5),
    ...
    Round169ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round169ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND169_CASE_CANDIDATES: tuple[Round169CaseCandidate, ...] = (
    Round169CaseCandidate(
    ...
    Round169CaseCandidate(
        "mosaic_phosphate_sulfuric_acid_squeeze_case",
        "FERTILIZER_INPUT_COST_SULFURIC_ACID",
        "MOS",
        "Mosaic phosphate sulfuric-acid input-cost squeeze",
        "US",
        "4c_thesis_break",
        date(2026, 5, 6),
        None,
        ...
        None,
        date(2026, 5, 6),
        ("phosphate_price_strength", "sulfuric_acid_spike", "sulfur_cost_spike", "production_guidance_at_risk"),
        ("sulfuric_acid_spike", "sulfur_cost_spike", "ammonia_cost_spike", "urea_cost_spike", "guidance_withdrawal", "loss_reported"),
        "fertilizer_price_good_but_input_cost_squeezed",
        "needs_price_backfill",
        ("WSJ Mosaic sulfuric acid input-cost squeeze",),
        "Phosphate pricing can look supportive, but sulfuric-acid and sulfur input costs can overwhelm margins and turn the fertilizer cycle into a 4C-watch case.",
        (E2RArchetype.FERTILIZER_INPUT_COST_CYCLE,),
    ),
    Round169CaseCandidate(
    ...
    Round169CaseCandidate(
        ...
        "needs_price_backfill",
        ("Round 169 Chegg AI search disintermediation synthesis",),
...
ROUND169_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
    ...
    "sulfuric_acid_price_change",
    "sulfur_cost_change",
    "ammonia_cost_change",
    "urea_cost_change",
    "production_guidance_withdrawal_flag",
    "fertilizer_loss_reported_flag",
...
def target_for(target_id: str) -> Round169ScoreTarget | None:
    for target in ROUND169_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round169_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND169_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round169 R12 Loop-10 case for {candidate.target_id}; "
...
def round169_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round169_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND169_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round169_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round169_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round169_backfill": "true"} for field in ROUND169_PRICE_FIELDS)


def round169_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_csv_dict() for axis in ROUND169_BASE_SCORE_AXES)


def round169_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND169_STAGE_CAPS)


def round169_summary() -> dict[str, int | bool]:
    records = round169_case_records()
    return {
        "target_count": len(ROUND169_SCORE_TARGETS),
        "source_canonical_target_count": ROUND169_SOURCE_CANONICAL_TARGET_COUNT,
        "base_score_axis_count": len(ROUND169_BASE_SCORE_AXES),
        "stage_cap_count": len(ROUND169_STAGE_CAPS),
        ...
        "green_possible_count": sum(1 for target in ROUND169_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND169_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND169_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND169_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round169_r12_loop10_reports(
    *,
    output_directory: str | Path = ROUND169_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND169_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND169_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round169_r12_loop10_agri_life_misc_summary.md",
        "case_matrix": output / "round169_r12_loop10_case_matrix.csv",
        "stage_date_plan": output / "round169_r12_loop10_stage_date_plan.csv",
        "green_guardrails": output / "round169_r12_loop10_green_guardrails.md",
        "unit_economics_caps": output / "round169_r12_loop10_unit_economics_caps.md",
        "price_validation_plan": output / "round169_r12_loop10_price_validation_plan.md",
        "price_fields": output / "round169_r12_loop10_price_fields.csv",
        "base_score_axes": output / "round169_r12_loop10_base_score_axes.csv",
        "stage_caps": output / "round169_r12_loop10_stage_caps.csv",
    }
    _write_case_jsonl(round169_case_records(), cases)
    _write_rows(round169_score_profile_rows(), score_profiles)
    _write_rows(round169_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round169_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round169_price_field_rows(), paths["price_fields"])
    _write_rows(round169_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round169_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round169_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round169_green_guardrail_markdown(), encoding="utf-8")
    paths["unit_economics_caps"].write_text(render_round169_unit_economics_cap_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round169_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round169_summary_markdown() -> str:
    summary = round169_summary()
    lines = [
        "# Round-169 R12 Loop-10 Agriculture / Life Services / Misc Summary",
        "",
        f"- source_round: `{ROUND169_SOURCE_ROUND_PATH}`",
    ...
    for axis in ROUND169_BASE_SCORE_AXES:
    ...
    for cap in ROUND169_STAGE_CAPS:
...
def render_round169_green_guardrail_markdown() -> str:
    lines = [
...
def render_round169_unit_economics_cap_markdown() -> str:
    lines = [
        "# Round-169 R12 Loop-10 Unit-Economics / Cycle Caps",
        "",
...
def render_round169_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-169 R12 Loop-10 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round169_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "- `fertilizer_input_cost_4c`: phosphate price strength fails if sulfuric-acid, sulfur, ammonia, urea, or production-cost pressure overwhelms margin.",
...
def _score_price_alignment(candidate: Round169CaseCandidate) -> str:
...
def _rerating_result(candidate: Round169CaseCandidate) -> str:
...
__all__ = [
    "ROUND169_BASE_SCORE_AXES",
    "ROUND169_CASE_CANDIDATES",
    "ROUND169_DEFAULT_CASES_PATH",
    "ROUND169_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND169_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND169_PRICE_FIELDS",
    "ROUND169_SCORE_TARGETS",
    "ROUND169_SOURCE_CANONICAL_TARGET_COUNT",
    "ROUND169_SOURCE_CANONICAL_TARGET_IDS",
    "ROUND169_SOURCE_ROUND_PATH",
    "ROUND169_STAGE_CAPS",
    "Round169BaseScoreAxis",
    "Round169CaseCandidate",
    "Round169ScoreTarget",
    "Round169ScoreWeightDraft",
    "Round169StageCap",
    "render_round169_green_guardrail_markdown",
    "render_round169_price_validation_plan_markdown",
    "render_round169_summary_markdown",
    "render_round169_unit_economics_cap_markdown",
    "round169_base_score_axis_rows",
    "round169_case_candidate_rows",
    "round169_case_records",
    "round169_price_field_rows",
    "round169_score_profile_rows",
    "round169_stage_date_rows",
    "round169_stage_cap_rows",
    "round169_summary",
    "target_for",
    "write_round169_r12_loop10_reports",
]
