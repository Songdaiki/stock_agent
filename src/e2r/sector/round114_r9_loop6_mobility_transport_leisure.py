"""Round-114 R9 Loop-6 mobility, transport, and leisure pack.

Round 114 tightens the Round-101 R9 Loop-5 pack. It adds US localization labor
and visa risk, AV crash/probe disclosure, paid driverless freight milestones,
tourism policy-event separation, and the Part-135-versus-type-certification
gate. Demand recovery, hybrid labels, tourism policy, freight spikes, robotaxi
rollouts, autonomous-trucking launches, and partial eVTOL certification are not
Stage 3 evidence unless OPM, FCF, capital return, unit economics, safety,
certification, backlog, or recurring revenue are proven.
...
ROUND114_SOURCE_ROUND_PATH = "docs/round/round_114.md"
ROUND114_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round114_r9_loop6_mobility_transport_leisure"
ROUND114_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r9_loop6_round114.jsonl"
ROUND114_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round114_r9_loop6_v6.csv"


@dataclass(frozen=True)
class Round114ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round114ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round114ScoreWeightDraft
...
GATE_WEIGHT = Round114ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND114_SCORE_TARGETS: tuple[Round114ScoreTarget, ...] = (
    Round114ScoreTarget(
        "AUTO_MOBILITY_COMPLETED_VEHICLE",
        E2RArchetype.AUTO_MOBILITY_COMPLETED_VEHICLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(20, 18, 10, 15, 17, 10, 5),
    ...
    Round114ScoreTarget(
        ...
        Round114ScoreWeightDraft(21, 20, 11, 15, 17, 10, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(18, 18, 9, 12, 13, 5, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(20, 18, 11, 14, 14, 3, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(21, 19, 14, 14, 13, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(18, 16, 9, 13, 11, 0, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(17, 17, 10, 15, 10, 0, 6),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(16, 16, 10, 14, 9, 0, 6),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(17, 17, 10, 14, 9, 0, 6),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(17, 12, 12, 10, 9, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(18, 14, 5, 12, 10, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(17, 13, 5, 12, 10, 1, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(18, 13, 5, 12, 10, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(8, 7, 4, 10, 6, 0, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round114ScoreWeightDraft(20, 7, 18, 8, 7, 0, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(18, 15, 6, 12, 10, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(15, 12, 6, 10, 8, 1, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round114ScoreWeightDraft(16, 13, 6, 11, 8, 1, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round114ScoreWeightDraft(8, 8, 6, 12, 6, 0, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round114ScoreWeightDraft(14, 13, 8, 12, 9, 0, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round114ScoreWeightDraft(19, 21, 10, 13, 11, 2, 5),
    ...
    Round114ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round114ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND114_CASE_CANDIDATES: tuple[Round114CaseCandidate, ...] = (
    Round114CaseCandidate(
        ...
        ("round_114.md Reuters Hyundai hybrid expansion and shareholder return",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Hyundai US output and margin goal cut",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Toyota hybrid bottleneck",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Avride Hyundai robotaxi",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Axios Uber Avride Dallas autonomous rides",),
    ...
    Round114CaseCandidate(
        ...
        "robotaxi_operational_reality_check",
        "needs_price_backfill",
        ("round_114.md Reuters Tesla Texas robotaxi wait times",),
    ...
    Round114CaseCandidate(
        ...
        "robotaxi_safety_4c",
        "needs_price_backfill",
        ("round_114.md Reuters Waymo flooded-road recall",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md MySA Avride Texas crashes and federal probe",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md The Verge Aurora first driverless delivery Texas",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Axios Bot Auto paid driverless freight",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters GM hires Aurora cofounder as chief product officer",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Korean Air record revenue and integration",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters China group visa-free entry",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters SES airline connectivity",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Maersk unsustainable container rates", "round_114.md Reuters falling ocean rates",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Axios Hertz sells 20,000 EVs",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Michelin annual outlook cut",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Joby discounted offering",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Lilium cash crunch",),
    ...
    Round114CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_114.md Reuters Archer Part 135",),
...
ROUND114_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
ROUND114_RISK_OVERLAYS: tuple[str, ...] = (
...
def target_for(target_id: str) -> Round114ScoreTarget | None:
...
def round114_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND114_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round114 R9 Loop-6 case for {candidate.target_id}; "
...
def round114_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round114_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND114_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round114_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round114_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round114_backfill": "true"} for field in ROUND114_PRICE_FIELDS)


def round114_summary() -> dict[str, int | bool]:
    records = round114_case_records()
    return {
        "target_count": len(ROUND114_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND114_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND114_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND114_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND114_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round114_r9_loop6_reports(
    *,
    output_directory: str | Path = ROUND114_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND114_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND114_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round114_r9_loop6_mobility_transport_leisure_summary.md",
        "case_matrix": output / "round114_r9_loop6_case_matrix.csv",
        "stage_date_plan": output / "round114_r9_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round114_r9_loop6_green_guardrails.md",
        "risk_overlays": output / "round114_r9_loop6_risk_overlays.md",
        "price_validation_plan": output / "round114_r9_loop6_price_validation_plan.md",
        "price_fields": output / "round114_r9_loop6_price_fields.csv",
    }
    _write_case_jsonl(round114_case_records(), cases)
    _write_rows(round114_score_profile_rows(), score_profiles)
    _write_rows(round114_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round114_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round114_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round114_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round114_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round114_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round114_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round114_summary_markdown() -> str:
    summary = round114_summary()
    lines = [
        "# Round 114 R9 Loop-6 Mobility/Transport/Leisure Summary",
        "",
        "Round 114 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round114_green_guardrail_markdown() -> str:
    lines = [
        "# Round 114 R9 Loop-6 Green Guardrails",
        "",
        "- Do not apply R9 Loop-6 v6.0 weights to production scoring yet.",
...
def render_round114_risk_overlay_markdown() -> str:
    lines = ["# Round 114 R9 Loop-6 Risk Overlays", ""]
    for overlay in ROUND114_RISK_OVERLAYS:
...
def render_round114_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 114 R9 Loop-6 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round114_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND114_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round114CaseCandidate) -> str:
...
def _rerating_result(candidate: Round114CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round114ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
