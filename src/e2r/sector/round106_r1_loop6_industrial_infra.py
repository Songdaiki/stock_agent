"""Round-106 R1 Loop-6 industrial orders and infrastructure pack.

Round 106 returns to R1 after the R13 Loop-5 RedTeam pass. It narrows the
...
ROUND106_SOURCE_ROUND_PATH = "docs/round/round_106.md"
ROUND106_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round106_r1_loop6_industrial_infra"
ROUND106_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r1_loop6_round106.jsonl"
ROUND106_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round106_r1_loop6_v6.csv"


@dataclass(frozen=True)
class Round106ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round106ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round106ScoreWeightDraft
...
ROUND106_SCORE_TARGETS: tuple[Round106ScoreTarget, ...] = (
    Round106ScoreTarget(
        "GRID_TRANSFORMER_SHORTAGE",
        E2RArchetype.GRID_TRANSFORMER_SHORTAGE,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round106ScoreWeightDraft(24, 25, 24, 12, 10, 1, 5),
        ...
        "Loop 6 strengthens transformer shortage, but Green still requires contract amount, duration, delivery, margin, and EPS conversion.",
    ),
    Round106ScoreTarget(
        "GRID_EHV_TRANSFORMER_EXPORT",
        E2RArchetype.GRID_EHV_TRANSFORMER_EXPORT,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(24, 25, 24, 13, 10, 1, 6),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(22, 24, 22, 12, 10, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(22, 23, 20, 12, 10, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round106ScoreWeightDraft(22, 23, 19, 13, 10, 0, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(21, 22, 18, 12, 10, 0, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(22, 22, 18, 12, 9, 4, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round106ScoreWeightDraft(20, 24, 18, 13, 12, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round106ScoreWeightDraft(21, 24, 17, 14, 14, 3, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(21, 23, 16, 14, 13, 2, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(16, 16, 12, 13, 9, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round106ScoreWeightDraft(21, 22, 18, 13, 13, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(16, 17, 11, 13, 10, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(20, 22, 12, 14, 11, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(19, 23, 13, 14, 12, 2, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round106ScoreWeightDraft(13, 12, 10, 13, 7, 1, 5),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round106ScoreWeightDraft(10, 8, 8, 10, 7, 0, 4),
    ...
    Round106ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round106ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND106_CASE_CANDIDATES: tuple[Round106CaseCandidate, ...] = (
    Round106CaseCandidate(
        ...
        ("round_106.md Reuters US transformer shortage",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md LS Electric 525kV US datacenter transformer case placeholder",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters ABB medium-voltage equipment investment",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Siemens Energy cash flow and buyback",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Siemens Energy record backlog context",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md WSJ GE Vernova orders/backlog",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters GE Vernova power backlog / turbine context",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters EIA US power demand record path",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md arXiv AI data-center flexibility",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Guardian Perth data-center withdrawal",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md data-center moratorium reference",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Seattle data-center moratorium watch",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md arXiv data-center public water systems",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Romania K9 contract",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Hanwha Europe land arms sales",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Hanwha Aerospace trims capital increase plan",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters HD Hyundai Heavy / Huntington Ingalls MoA",),
    ...
    Round106CaseCandidate(
        ...
        ("round_106.md AP Hanwha Ocean China sanctions",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md arXiv shipyard procurement lead-time prediction",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Hyundai Rotem Morocco rail order",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Meta Constellation nuclear PPA",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Three Mile Island restart decision",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Reuters Three Mile Island restart grid rights gate",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md NuScale UAMPS CFPP cancellation",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md reconstruction policy rule",),
    ...
    Round106CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_106.md Neom policy/infrastructure rule",),
...
ROUND106_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round106_target_for(target_id: str) -> Round106ScoreTarget | None:
...
def round106_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND106_CASE_CANDIDATES:
        target = round106_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round106 R1 Loop-6 case for {candidate.target_id}; "
            ...
            score_price_alignment=_round106_score_price_alignment(candidate),
            rerating_result=_round106_rerating_result(candidate),
            ...
            green_guardrails=(
                ...
                "project_delay_capital_allocation_shock_low_margin_mro_smr_false_green_are_loop6_penalties",
                *target.red_flags,
            ),
...
def round106_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round106_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND106_CASE_CANDIDATES:
        target = round106_target_for(candidate.target_id)
...
def round106_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round106_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round106_backfill": "true"} for field in ROUND106_PRICE_FIELDS)


def round106_summary() -> dict[str, int | bool]:
    records = round106_case_records()
    return {
        "target_count": len(ROUND106_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND106_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND106_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND106_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "hard_gate_target_count": sum(1 for target in ROUND106_SCORE_TARGETS if target.hard_gate),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round106_r1_loop6_reports(
    *,
    output_directory: str | Path = ROUND106_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND106_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND106_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round106_r1_loop6_industrial_infra_summary.md",
        "case_matrix": output / "round106_r1_loop6_case_matrix.csv",
        "stage_date_plan": output / "round106_r1_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round106_r1_loop6_green_guardrails.md",
        "loop6_risk_overlays": output / "round106_r1_loop6_risk_overlays.md",
        "price_validation_plan": output / "round106_r1_loop6_price_validation_plan.md",
        "price_fields": output / "round106_r1_loop6_price_fields.csv",
    }
    _write_case_jsonl(round106_case_records(), cases)
    _write_rows(round106_score_profile_rows(), score_profiles)
    _write_rows(round106_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round106_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round106_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round106_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round106_green_guardrail_markdown(), encoding="utf-8")
    paths["loop6_risk_overlays"].write_text(render_round106_loop6_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round106_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round106_summary_markdown() -> str:
    summary = round106_summary()
    lines = [
        "# Round-106 R1 Loop-6 Industrial Orders / Infrastructure Summary",
        "",
        f"- source_round: `{ROUND106_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R1 Loop 6 narrows order/backlog candidates after the R13 Loop-5 RedTeam pass.",
        ...
        "- Loop 6 adds EHV transformer export, power-equipment capital return, grid-flexibility context, and data-center power/water gates.",
...
def render_round106_green_guardrail_markdown() -> str:
    lines = [
        "# Round-106 R1 Loop-6 Green Guardrails",
        "",
    ...
    for target in ROUND106_SCORE_TARGETS:
        lines.append(
            ...
            f"{', '.join(target.green_conditions)} | {', '.join(target.loop6_penalty_axes)} |"
        )
    lines.extend(
        [
            "",
            "## What Not To Change",
            "",
            "- Do not apply R1 Loop-6 v6.0 weights to production scoring yet.",
...
def render_round106_loop6_risk_overlay_markdown() -> str:
    lines = [
        "# Round-106 R1 Loop-6 Risk Overlays",
        "",
...
def render_round106_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-106 R1 Loop-6 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round106_case_candidate_rows():
...
def _round106_score_price_alignment(candidate: Round106CaseCandidate) -> str:
...
def _round106_rerating_result(candidate: Round106CaseCandidate) -> str:
...
__all__ = [
    ...
    "ROUND106_DEFAULT_CASES_PATH",
    "ROUND106_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND106_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND106_PRICE_FIELDS",
    "ROUND106_SCORE_TARGETS",
    "Round106CaseCandidate",
    "Round106ScoreTarget",
    "Round106ScoreWeightDraft",
