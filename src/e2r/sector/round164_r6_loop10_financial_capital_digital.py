"""Round-164 R6 Loop-10 financial, capital-allocation, and digital-finance pack.

Round 164 separates cheapness from discount removal. Low PBR, value-up policy,
...
ROUND164_SOURCE_ROUND_PATH = "docs/round/round_164.md"
ROUND164_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round164_r6_loop10_financial_capital_digital"
ROUND164_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r6_loop10_round164.jsonl"
ROUND164_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round164_r6_loop10_v10.csv"
ROUND164_SOURCE_CANONICAL_TARGET_COUNT = 27


@dataclass(frozen=True)
class Round164ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round164ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round164ScoreWeightDraft
...
@dataclass(frozen=True)
class Round164ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
def _w(
    ...
    capital: int | str,
    confidence: int | str,
) -> Round164ScoreWeightDraft:
    return Round164ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round164ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND164_BASE_SCORE_WEIGHTS: tuple[Round164BaseScoreWeight, ...] = (
    Round164BaseScoreWeight(
    ...
    Round164BaseScoreWeight(
        ...
        12,
        "Governance execution, disclosure detail, exchange security, reserve design, and regulation are stronger Loop-10 hard gates.",
    ),
)


ROUND164_STAGE_CAPS: tuple[Round164StageCap, ...] = (
    Round164StageCap(
...
ROUND164_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round164ScoreStagePriceAlignment, ...] = (
    Round164ScoreStagePriceAlignment(
...
ROUND164_SCORE_TARGETS: tuple[Round164ScoreTarget, ...] = (
    _target(
...
ROUND164_CASE_CANDIDATES: tuple[Round164CaseCandidate, ...] = (
    Round164CaseCandidate(
        "korea_commercial_act_treasury_cancel_case",
        "TREASURY_CANCEL_MANDATE_POLICY",
        ...
        ("round_164.md Reuters commercial act treasury cancellation",),
    ...
    Round164CaseCandidate(
        ...
        ("round_164.md Reuters SK Square buybacks",),
    ...
    Round164CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_164.md Reuters Samsung treasury cancellation",),
    ...
    Round164CaseCandidate(
        ...
        ("round_164.md section 4-4 bank and financial holding candidate",),
        "Round 164 keeps banks and financial holdings Green-capable only after ROE, CET1, credit cost, PF exposure, and return execution are verified.",
        (E2RArchetype.FINANCIAL_SPREAD_BALANCE_SHEET,),
    ),
    Round164CaseCandidate(
        ...
        "needs_named_case_and_price_backfill",
        ("round_164.md section 4-5 insurance underwriting candidate",),
        "Round 164 keeps insurance Green-capable, but separates CSM quality, K-ICS, loss ratio, and investment-loss risks from bank value-up.",
    ),
    Round164CaseCandidate(
        "samsung_ct_activist_rejection_case",
        "GOVERNANCE_EXECUTION_FAILURE_OVERLAY",
        ...
        ("round_164.md Financial Times Samsung C&T activist rejection",),
    ...
    Round164CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_164.md Reuters Korea Zinc tender offer",),
    ...
    Round164CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_164.md Reuters Korea Zinc share issuance probe",),
    ...
    Round164CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_164.md Reuters Korea tax policy shock",),
    ...
    Round164CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_164.md Barron's AI windfall tax policy shock",),
    ...
    Round164CaseCandidate(
        ...
        ("round_164.md Reuters Mynt GCash IPO",),
    ...
    Round164CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_164.md Reuters Clear Street IPO valuation cut",),
    ...
    Round164CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_164.md Reuters Toss global push won stablecoin",),
    ...
    Round164CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_164.md Reuters Circle IPO valuation",),
    ...
    Round164CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_164.md Reuters Bank of England stablecoin regulation",),
    ...
    Round164CaseCandidate(
        ...
        "needs_source_date_and_price_backfill",
        ("round_164.md Reuters TerraUSD Do Kwon",),
    ...
    Round164CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_164.md Reuters Hana Bank Dunamu stake",),
    ...
    Round164CaseCandidate(
        ...
        ("round_164.md WSJ Dunamu Naver Financial merger option",),
    ...
    Round164CaseCandidate(
        ...
        "needs_named_case_and_price_backfill",
        ("round_164.md digital asset exchange security cycle checklist",),
    ...
    Round164CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_164.md Reuters Korean PF restructuring scrutiny",),
    ...
    Round164CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_164.md Reuters FBI Bybit hack attribution",),
...
ROUND164_PRICE_FIELDS: tuple[str, ...] = (
...
def round164_target_for(target_id: str) -> Round164ScoreTarget | None:
...
def round164_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND164_CASE_CANDIDATES:
        target = round164_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round164 R6 Loop-10 case for {candidate.target_id}; "
...
def round164_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round164_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND164_CASE_CANDIDATES:
        target = round164_target_for(candidate.target_id)
...
def round164_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round164_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round164_backfill": "true"} for field in ROUND164_PRICE_FIELDS)


def round164_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND164_BASE_SCORE_WEIGHTS
    )


def round164_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND164_STAGE_CAPS
    )


def round164_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND164_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round164_summary() -> dict[str, int | bool]:
    records = round164_case_records()
    return {
        "target_count": len(ROUND164_SCORE_TARGETS),
        "source_canonical_target_count": ROUND164_SOURCE_CANONICAL_TARGET_COUNT,
        "helper_overlay_target_count": len(ROUND164_SCORE_TARGETS) - ROUND164_SOURCE_CANONICAL_TARGET_COUNT,
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND164_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND164_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND164_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND164_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND164_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND164_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND164_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round164_r6_loop10_reports(
    *,
    output_directory: str | Path = ROUND164_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND164_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND164_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round164_r6_loop10_financial_capital_digital_summary.md",
        "case_matrix": output / "round164_r6_loop10_case_matrix.csv",
        "stage_date_plan": output / "round164_r6_loop10_stage_date_plan.csv",
        "green_guardrails": output / "round164_r6_loop10_green_guardrails.md",
        "risk_overlays": output / "round164_r6_loop10_risk_overlays.md",
        "price_validation_plan": output / "round164_r6_loop10_price_validation_plan.md",
        "price_fields": output / "round164_r6_loop10_price_fields.csv",
        "base_score_weights": output / "round164_r6_loop10_base_score_weights.csv",
        "stage_caps": output / "round164_r6_loop10_stage_caps.csv",
        "score_stage_price_alignment": output / "round164_r6_loop10_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round164_r6_loop10_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round164_case_records(), cases)
    _write_rows(round164_score_profile_rows(), score_profiles)
    _write_rows(round164_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round164_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round164_price_field_rows(), paths["price_fields"])
    _write_rows(round164_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round164_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round164_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round164_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round164_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round164_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round164_price_validation_plan_markdown(), encoding="utf-8")
...
def render_round164_summary_markdown() -> str:
    summary = round164_summary()
    lines = [
        "# Round-164 R6 Loop-10 Financial / Capital / Digital Summary",
        "",
        f"- source_round: `{ROUND164_SOURCE_ROUND_PATH}`",
        "- large_sector: `FINANCIAL_CAPITAL_DIGITAL`",
        "- loop: `R6 Loop 10 / v10.0`",
        ...
        "## Interpretation",
        "",
        "- R6 Loop 10 says low PBR, value-up policy, and digital-asset labels are not enough; execution decides.",
...
def render_round164_green_guardrail_markdown() -> str:
    lines = [
        "# Round-164 R6 Loop-10 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R6 Loop-10 v10.0 weights to production scoring yet.",
...
def render_round164_risk_overlay_markdown() -> str:
    lines = [
        "# Round-164 R6 Loop-10 Risk Overlays",
        "",
...
def render_round164_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round164_case_candidate_rows():
...
def render_round164_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-164 R6 Loop-10 Score / Stage / Price Alignment",
        "",
        "Round 164 checks whether financial, capital-allocation, and digital-finance score interpretation matches the observed price and operating path.",
...
def _score_price_alignment(candidate: Round164CaseCandidate) -> str:
...
def _rerating_result(candidate: Round164CaseCandidate) -> str:
...
def _score_weight_hint(target: Round164ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    ...
    "ROUND164_SOURCE_CANONICAL_TARGET_COUNT",
    "ROUND164_PRICE_FIELDS",
    "ROUND164_BASE_SCORE_WEIGHTS",
    "ROUND164_SCORE_TARGETS",
    "ROUND164_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND164_STAGE_CAPS",
    "Round164BaseScoreWeight",
    "Round164CaseCandidate",
    "Round164ScoreStagePriceAlignment",
