"""Round-144 R12 Loop-8 agriculture, life services, and miscellaneous pack.

Round 144 tightens the R12 unit-economics pack from Round 104. Agriculture,
...
Loop 8 adds stronger cycle and regulation splitters: right-to-repair expansion
...
ROUND144_SOURCE_ROUND_PATH = "docs/round/round_144.md"
ROUND144_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round144_r12_loop8_agri_life_misc"
ROUND144_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r12_loop8_round144.jsonl"
ROUND144_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round144_r12_loop8_v8.csv"


@dataclass(frozen=True)
class Round144ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round144ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round144ScoreWeightDraft
...
ROUND144_BASE_SCORE_AXES: tuple[Round144BaseScoreAxis, ...] = (
    Round144BaseScoreAxis(
...
ROUND144_STAGE_CAPS: tuple[Round144StageCap, ...] = (
    Round144StageCap(
...
ROUND144_SCORE_TARGETS: tuple[Round144ScoreTarget, ...] = (
    Round144ScoreTarget(
        "SMART_FARM_AGRI_TECH",
        E2RArchetype.SMART_FARM_AGRI_TECH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(17, 13, 12, 9, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round144ScoreWeightDraft(8, 6, 5, 7, 5, 0, 4),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(16, 13, 10, 10, 9, 1, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(14, 11, 8, 9, 7, 1, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(16, 14, 9, 11, 9, 1, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round144ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(18, 16, 11, 12, 10, 1, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(18, 11, 14, 9, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(16, 12, 13, 10, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round144ScoreWeightDraft(18, 8, 14, 8, 7, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(18, 16, 8, 11, 9, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(14, 12, 8, 10, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(17, 16, 5, 12, 10, 2, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(16, 15, 5, 12, 9, 1, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round144ScoreWeightDraft(10, 8, 4, 8, 5, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round144ScoreWeightDraft(15, 11, 5, 10, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(14, 10, 5, 8, 6, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(15, 13, 7, 10, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(18, 15, 8, 12, 10, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(16, 13, 8, 10, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(16, 14, 8, 11, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round144ScoreWeightDraft(17, 11, 12, 8, 8, 0, 5),
    ...
    Round144ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round144ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND144_CASE_CANDIDATES: tuple[Round144CaseCandidate, ...] = (
    Round144CaseCandidate(
    ...
    Round144CaseCandidate(
        ...
        "needs_price_backfill",
        ("Round 144 Chegg AI search disintermediation synthesis",),
...
ROUND144_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round144ScoreTarget | None:
...
def round144_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND144_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round144 R12 Loop-8 case for {candidate.target_id}; "
...
def round144_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round144_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND144_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round144_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round144_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round144_backfill": "true"} for field in ROUND144_PRICE_FIELDS)


def round144_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_csv_dict() for axis in ROUND144_BASE_SCORE_AXES)


def round144_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND144_STAGE_CAPS)


def round144_summary() -> dict[str, int | bool]:
    records = round144_case_records()
    return {
        "target_count": len(ROUND144_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND144_BASE_SCORE_AXES),
        "stage_cap_count": len(ROUND144_STAGE_CAPS),
        ...
        "green_possible_count": sum(1 for target in ROUND144_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND144_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND144_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND144_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round144_r12_loop8_reports(
    *,
    output_directory: str | Path = ROUND144_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND144_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND144_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round144_r12_loop8_agri_life_misc_summary.md",
        "case_matrix": output / "round144_r12_loop8_case_matrix.csv",
        "stage_date_plan": output / "round144_r12_loop8_stage_date_plan.csv",
        "green_guardrails": output / "round144_r12_loop8_green_guardrails.md",
        "unit_economics_caps": output / "round144_r12_loop8_unit_economics_caps.md",
        "price_validation_plan": output / "round144_r12_loop8_price_validation_plan.md",
        "price_fields": output / "round144_r12_loop8_price_fields.csv",
        "base_score_axes": output / "round144_r12_loop8_base_score_axes.csv",
        "stage_caps": output / "round144_r12_loop8_stage_caps.csv",
    }
    _write_case_jsonl(round144_case_records(), cases)
    _write_rows(round144_score_profile_rows(), score_profiles)
    _write_rows(round144_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round144_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round144_price_field_rows(), paths["price_fields"])
    _write_rows(round144_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round144_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round144_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round144_green_guardrail_markdown(), encoding="utf-8")
    paths["unit_economics_caps"].write_text(render_round144_unit_economics_cap_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round144_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round144_summary_markdown() -> str:
    summary = round144_summary()
    lines = [
        "# Round-144 R12 Loop-8 Agriculture / Life Services / Misc Summary",
        "",
        f"- source_round: `{ROUND144_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R12 Loop-8 separates recurring FCF from disease, weather, policy, AI, hardware, and regulation headlines.",
    ...
    for cap in ROUND144_STAGE_CAPS:
...
def render_round144_green_guardrail_markdown() -> str:
    lines = [
        "# Round-144 R12 Loop-8 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R12 Loop-8 v8 weights to production scoring yet.",
...
def render_round144_unit_economics_cap_markdown() -> str:
    lines = [
        "# Round-144 R12 Loop-8 Unit-Economics / Cycle Caps",
        "",
...
def render_round144_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round144_case_candidate_rows():
...
def _score_price_alignment(candidate: Round144CaseCandidate) -> str:
...
def _rerating_result(candidate: Round144CaseCandidate) -> str:
...
__all__ = [
    ...
    "ROUND144_DEFAULT_CASES_PATH",
    "ROUND144_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND144_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND144_PRICE_FIELDS",
    "ROUND144_SCORE_TARGETS",
    "ROUND144_SOURCE_ROUND_PATH",
    "ROUND144_STAGE_CAPS",
    "Round144BaseScoreAxis",
    "Round144CaseCandidate",
    "Round144ScoreTarget",
    "Round144ScoreWeightDraft",
    "Round144StageCap",
