"""Round-91 R12 Loop-4 agriculture, life services, and miscellaneous pack.

Round 91 tightens the R12 unit-economics pack from Round 65. Agriculture,
...
ROUND91_SOURCE_ROUND_PATH = "docs/round/round_91.md"
ROUND91_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round91_r12_loop4_agri_life_misc"
ROUND91_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r12_loop4_round91.jsonl"
ROUND91_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round91_r12_loop4_v4.csv"


@dataclass(frozen=True)
class Round91ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round91ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round91ScoreWeightDraft
...
ROUND91_SCORE_TARGETS: tuple[Round91ScoreTarget, ...] = (
    Round91ScoreTarget(
        "SMART_FARM_AGRI_TECH",
        E2RArchetype.SMART_FARM_AGRI_TECH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(17, 13, 12, 9, 8, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round91ScoreWeightDraft(8, 6, 5, 7, 5, 0, 4),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(16, 13, 10, 10, 9, 1, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(16, 14, 9, 11, 9, 1, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(18, 16, 11, 12, 10, 1, 5),
        ("seed_pricing", "crop_protection_product", "soy_seed_licensing", "food_security_theme"),
        ("licensing_revenue", "seed_revenue_growth", "crop_protection_revenue_growth", "price_pass_through", "farmer_roi"),
        ("repeat_seed_or_crop_protection_revenue", "litigation_risk_contained", "regulatory_clearance", "fcf_conversion"),
        ("seed_ip_food_security_theme_crowded", "pricing_power_assumed_before_farmer_roi"),
        ("roundup_litigation", "patent_expiry", "regulatory_restriction", "farmer_margin_pressure", "sales_delay"),
        ("licensing_revenue", "farmer_roi", "price_pass_through", "litigation_risk_contained", "fcf_conversion"),
        ("litigation", "patent_expiry", "regulatory_restriction", "farmer_margin", "debt_burden"),
        "Seed and crop-protection stories can earn credit from licensing and IP, but litigation, regulation, and farmer ROI must be checked.",
    ),
    Round91ScoreTarget(
        "FERTILIZER_INPUT_COST_CYCLE",
        E2RArchetype.FERTILIZER_INPUT_COST_CYCLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(18, 11, 14, 9, 8, 0, 5),
        ("potash_or_phosphate_supply", "nitrogen_price", "crop_nutrient_depletion", "fertilizer_price_spike"),
        ("fertilizer_volume", "potash_sales_volume", "fertilizer_price_change", "farmer_application_rate", "margin_improvement"),
        ("low_cost_supply", "multi_period_demand", "farmer_margin_support", "fcf_conversion"),
        ("fertilizer_price_spike_crowded", "food_security_narrative_overextended"),
        ("crop_price_decline", "farmer_margin_pressure", "demand_deferral", "input_cost_spike", "guidance_withdrawal"),
        ("fertilizer_volume", "farmer_margin_support", "cost_discipline", "fcf_conversion"),
        ("crop_price", "farmer_margin", "input_cost", "supply_disruption", "guidance_withdrawal"),
        "Fertilizer demand can be strong, but potash, phosphate, and nitrogen remain input-cost and farmer-margin cycles.",
    ),
    Round91ScoreTarget(
        "AGRI_LIVESTOCK_FOOD_COMMODITY",
        E2RArchetype.AGRI_LIVESTOCK_FOOD_COMMODITY,
        Round10ThemePosture.REDTEAM_FIRST,
        Round91ScoreWeightDraft(18, 8, 14, 8, 7, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(18, 16, 8, 11, 9, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(17, 16, 5, 12, 10, 2, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round91ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round91ScoreWeightDraft(10, 8, 4, 8, 5, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round91ScoreWeightDraft(15, 11, 5, 10, 8, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(14, 10, 5, 8, 6, 0, 5),
        ("appliance_replacement_cycle", "housing_turnover", "consumer_durable_demand", "hardware_sales"),
        ("replacement_demand_indicator", "housing_turnover_indicator", "hardware_sales_margin", "debt_reduction_progress"),
        ("stable_replacement_demand", "fcf_conversion", "low_debt_pressure"),
        ("appliance_hardware_recovery_crowded", "replacement_cycle_assumed"),
        ("replacement_demand_collapse", "housing_turnover_weakness", "dividend_suspension", "guidance_cut", "debt_reduction_pressure"),
        ("stable_replacement_demand", "hardware_margin", "fcf_conversion", "low_debt_pressure"),
        ("replacement_cycle", "housing_turnover", "dividend_suspension", "guidance_cut", "debt_pressure"),
        "Appliance hardware is separated from rental/care recurring models because replacement demand and housing cycles can break the thesis.",
    ),
    Round91ScoreTarget(
        "SERVICE_KIOSK_SELF_CHECKOUT",
        E2RArchetype.SERVICE_KIOSK_SELF_CHECKOUT,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(15, 13, 7, 10, 8, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(18, 15, 8, 12, 10, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(17, 14, 8, 11, 9, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(16, 14, 8, 11, 8, 0, 5),
    ...
    Round91ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round91ScoreWeightDraft(17, 11, 12, 8, 8, 0, 5),
...
ROUND91_CASE_CANDIDATES: tuple[Round91CaseCandidate, ...] = (
    Round91CaseCandidate(
    ...
    Round91CaseCandidate(
        ...
        "AGRI_INPUT_SEED_CROP_PROTECTION",
        "BAYN.DE",
        "Bayer soy seed licensing and Crop Science EBITDA",
        "EU",
        "success_candidate",
        date(2026, 5, 12),
        date(2026, 5, 12),
        ...
        None,
        None,
        ("soy_seed_license_flag", "licensing_revenue", "crop_science_ebitda_growth", "seed_revenue_growth"),
        ("roundup_litigation", "debt_burden", "farmer_margin_pressure", "regulatory_restriction"),
        "agri_input_licensed_ip_success",
        "needs_price_backfill",
        ("Reuters Bayer Q1 Crop Science soy licensing",),
        "Seed and crop-protection IP can support Stage 2 when licensing lifts EBITDA, but Roundup litigation and farmer ROI remain RedTeam checks.",
    ),
    Round91CaseCandidate(
        "nutrien_potash_demand_cycle_case",
        "FERTILIZER_INPUT_COST_CYCLE",
        "NTR",
        "Nutrien potash demand and fertilizer cycle",
        "GLOBAL",
        "cyclical_success",
        date(2025, 8, 7),
        date(2025, 8, 7),
        ...
        None,
        None,
        ("potash_sales_volume", "fertilizer_volume", "farmer_application_rate", "forecast_raise"),
        ("crop_price_decline", "farmer_margin_pressure", "input_cost_spike", "supply_disruption_flag"),
        "fertilizer_cycle_with_input_risk",
        "needs_price_backfill",
        ("Reuters Nutrien fertilizer use despite low crop prices",),
        "Strong potash demand can be real, but fertilizer remains a crop-price, input-cost, farmer-margin, and supply-disruption cycle.",
    ),
    Round91CaseCandidate(
...
ROUND91_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round91ScoreTarget | None:
...
def round91_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND91_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round91 R12 Loop-4 case for {candidate.target_id}; "
...
def round91_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round91_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND91_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round91_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round91_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round91_backfill": "true"} for field in ROUND91_PRICE_FIELDS)


def round91_summary() -> dict[str, int | bool]:
    records = round91_case_records()
    return {
        "target_count": len(ROUND91_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND91_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND91_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND91_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND91_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round91_r12_loop4_reports(
    *,
    output_directory: str | Path = ROUND91_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND91_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND91_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round91_r12_loop4_agri_life_misc_summary.md",
        "case_matrix": output / "round91_r12_loop4_case_matrix.csv",
        "stage_date_plan": output / "round91_r12_loop4_stage_date_plan.csv",
        "green_guardrails": output / "round91_r12_loop4_green_guardrails.md",
        "unit_economics_caps": output / "round91_r12_loop4_unit_economics_caps.md",
        "price_validation_plan": output / "round91_r12_loop4_price_validation_plan.md",
        "price_fields": output / "round91_r12_loop4_price_fields.csv",
    }
    _write_case_jsonl(round91_case_records(), cases)
    _write_rows(round91_score_profile_rows(), score_profiles)
    _write_rows(round91_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round91_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round91_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round91_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round91_green_guardrail_markdown(), encoding="utf-8")
    paths["unit_economics_caps"].write_text(render_round91_unit_economics_cap_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round91_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round91_summary_markdown() -> str:
    summary = round91_summary()
    lines = [
        "# Round-91 R12 Loop-4 Agriculture / Life Services / Misc Summary",
        "",
        f"- source_round: `{ROUND91_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R12 Loop-4 separates recurring FCF from disease, weather, policy, AI, hardware, and regulation headlines.",
...
def render_round91_green_guardrail_markdown() -> str:
    lines = [
...
def render_round91_unit_economics_cap_markdown() -> str:
    lines = [
        "# Round-91 R12 Loop-4 Unit-Economics / Cycle Caps",
        "",
        ...
        "- `AGRI_INPUT_SEED_CROP_PROTECTION`: seed/IP licensing can support Stage 2, but litigation, patent expiry, regulation, and farmer ROI cap Green.",
        "- `FERTILIZER_INPUT_COST_CYCLE`: potash or fertilizer demand must be checked against crop prices, farmer margin, input costs, and supply disruption.",
        ...
        "- `HOME_APPLIANCE_HARDWARE_CYCLE`: one-time durable goods demand is a replacement and housing cycle, not a rental-quality recurring model.",
...
def render_round91_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round91_case_candidate_rows():
...
def _score_price_alignment(candidate: Round91CaseCandidate) -> str:
...
def _rerating_result(candidate: Round91CaseCandidate) -> str:
...
__all__ = [
    ...
    "ROUND91_DEFAULT_CASES_PATH",
    "ROUND91_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND91_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND91_PRICE_FIELDS",
    "ROUND91_SCORE_TARGETS",
    "ROUND91_SOURCE_ROUND_PATH",
    "Round91CaseCandidate",
    "Round91ScoreTarget",
    "Round91ScoreWeightDraft",
