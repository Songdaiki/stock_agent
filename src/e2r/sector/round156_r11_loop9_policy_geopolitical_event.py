"""Round-156 R11 Loop-9 policy/geopolitical/disaster/event pack.

Round 156 tightens the R11 event-risk pack from Round 116. The rule stays
...
Loop 9 reinforces export-control, tourism-policy, procurement-reversal,
...
ROUND156_SOURCE_ROUND_PATH = "docs/round/round_156.md"
ROUND156_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round156_r11_loop9_policy_geopolitical_event"
ROUND156_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r11_loop9_round156.jsonl"
ROUND156_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round156_r11_loop9_v9.csv"


@dataclass(frozen=True)
class Round156ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round156ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round156ScoreWeightDraft
...
ROUND156_BASE_SCORE_AXES: tuple[Round156BaseScoreAxis, ...] = (
    Round156BaseScoreAxis(
...
ROUND156_STAGE_CAPS: tuple[Round156StageCap, ...] = (
    Round156StageCap(
...
ROUND156_SCORE_TARGETS: tuple[Round156ScoreTarget, ...] = (
    Round156ScoreTarget(
        "NORTH_KOREA_POLICY_EVENT",
        E2RArchetype.NORTH_KOREA_POLICY_EVENT,
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(4, 3, 5, 8, 4, 0, 3),
    ...
    Round156ScoreTarget(
        ...
        Round156ScoreWeightDraft(12, 11, 8, 10, 8, 0, 4),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(14, 15, 9, 11, 9, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(15, 16, 10, 12, 9, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(12, 12, 17, 12, 8, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(16, 17, 17, 13, 10, 1, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(10, 6, 7, 8, 6, 0, 4),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(13, 14, 11, 10, 8, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(15, 16, 13, 11, 9, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(13, 9, 8, 8, 6, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(16, 15, 8, 11, 8, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(19, 5, 5, 5, 5, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(5, 4, 5, 5, 5, 0, 3),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(7, 6, 6, 8, 6, 0, 3),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(5, 5, 5, 8, 5, 0, 3),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(8, 7, 4, 10, 6, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(10, 10, 8, 10, 7, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft(8, 5, 5, 6, 5, 0, 4),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round156ScoreWeightDraft(15, 14, 8, 10, 8, 0, 5),
    ...
    Round156ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round156ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND156_CASE_CANDIDATES: tuple[Round156CaseCandidate, ...] = (
    Round156CaseCandidate(
...
ROUND156_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round156ScoreTarget | None:
    for target in ROUND156_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round156_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND156_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round156 R11 Loop-9 case for {candidate.target_id}; "
...
def round156_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round156_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND156_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round156_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round156_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round156_backfill": "true"} for field in ROUND156_PRICE_FIELDS)


def round156_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_dict() for axis in ROUND156_BASE_SCORE_AXES)


def round156_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND156_STAGE_CAPS)


def round156_summary() -> dict[str, int | bool]:
    records = round156_case_records()
    return {
        "target_count": len(ROUND156_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND156_BASE_SCORE_AXES),
        "stage_cap_count": len(ROUND156_STAGE_CAPS),
        ...
        "green_possible_count": sum(1 for target in ROUND156_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND156_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND156_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND156_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round156_r11_loop9_reports(
    *,
    output_directory: str | Path = ROUND156_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND156_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND156_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round156_r11_loop9_policy_geopolitical_event_summary.md",
        "case_matrix": output / "round156_r11_loop9_case_matrix.csv",
        "stage_date_plan": output / "round156_r11_loop9_stage_date_plan.csv",
        "green_guardrails": output / "round156_r11_loop9_green_guardrails.md",
        "event_false_positive_caps": output / "round156_r11_loop9_event_false_positive_caps.md",
        "price_validation_plan": output / "round156_r11_loop9_price_validation_plan.md",
        "price_fields": output / "round156_r11_loop9_price_fields.csv",
        "base_score_axes": output / "round156_r11_loop9_base_score_axes.csv",
        "stage_caps": output / "round156_r11_loop9_stage_caps.csv",
    }
    _write_case_jsonl(round156_case_records(), cases)
    _write_rows(round156_score_profile_rows(), score_profiles)
    _write_rows(round156_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round156_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round156_price_field_rows(), paths["price_fields"])
    _write_rows(round156_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round156_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round156_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round156_green_guardrail_markdown(), encoding="utf-8")
    paths["event_false_positive_caps"].write_text(render_round156_event_false_positive_caps_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round156_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round156_summary_markdown() -> str:
    summary = round156_summary()
    lines = [
        "# Round-156 R11 Loop-9 Policy / Geopolitical / Disaster / Event Summary",
        "",
        f"- source_round: `{ROUND156_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R11 Loop-9 is mostly a false-positive defense pack.",
        ...
        "",
        "## R11 v9 Base Score Axes",
        "",
        "These axes are calibration material only. They document how Round 156 separates policy/event headlines from actual orders, budgets, financing, guidance, recurrence, and RedTeam detail checks.",
    ]
    for axis in ROUND156_BASE_SCORE_AXES:
    ...
    for cap in ROUND156_STAGE_CAPS:
        lines.append(f"- {cap.cap_id}: {cap.stage_band} / {cap.score_cap}")
    return "\n".join(lines) + "\n"


def render_round156_green_guardrail_markdown() -> str:
    lines = [
        "# Round-156 R11 Loop-9 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R11 Loop-9 v9 weights to production scoring yet.",
...
def render_round156_event_false_positive_caps_markdown() -> str:
    lines = [
        "# Round-156 R11 Loop-9 Event False-Positive Caps",
        "",
...
def render_round156_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round156_case_candidate_rows():
...
def _score_price_alignment(candidate: Round156CaseCandidate) -> str:
...
def _rerating_result(candidate: Round156CaseCandidate) -> str:
...
__all__ = [
    "ROUND156_BASE_SCORE_AXES",
    "ROUND156_CASE_CANDIDATES",
    "ROUND156_DEFAULT_CASES_PATH",
    "ROUND156_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND156_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND156_PRICE_FIELDS",
    "ROUND156_SCORE_TARGETS",
    "ROUND156_SOURCE_ROUND_PATH",
    "ROUND156_STAGE_CAPS",
    "Round156BaseScoreAxis",
    "Round156CaseCandidate",
    "Round156ScoreTarget",
    "Round156ScoreWeightDraft",
    "Round156StageCap",
    "render_round156_event_false_positive_caps_markdown",
    "render_round156_green_guardrail_markdown",
    "render_round156_price_validation_plan_markdown",
    "render_round156_summary_markdown",
    "round156_base_score_axis_rows",
    "round156_case_candidate_rows",
    "round156_case_records",
    "round156_price_field_rows",
    "round156_score_profile_rows",
    "round156_stage_date_rows",
    "round156_stage_cap_rows",
    "round156_summary",
    "target_for",
    "write_round156_r11_loop9_reports",
]
