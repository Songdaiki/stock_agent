"""Round-137 R5 Loop-8 consumer, retail, and brand calibration pack.

Round 137 tightens R5 by separating consumer buzz from EPS/FCF bodyweight
...
ROUND137_SOURCE_ROUND_PATH = "docs/round/round_137.md"
ROUND137_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round137_r5_loop8_consumer_retail_brand"
ROUND137_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r5_loop8_round137.jsonl"
ROUND137_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round137_r5_loop8_v8.csv"


@dataclass(frozen=True)
class Round137ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round137ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round137ScoreWeightDraft
...
@dataclass(frozen=True)
class Round137ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round137ScoreWeightDraft:
    return Round137ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round137ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND137_BASE_SCORE_WEIGHTS: tuple[Round137BaseScoreWeight, ...] = (
    Round137BaseScoreWeight(
    ...
    Round137BaseScoreWeight(
        ...
        12,
        "Recall, tariff, import review, data breach, IP, product safety, trust failure, and disclosure gaps are stronger Loop-8 gates.",
    ),
)


ROUND137_STAGE_CAPS: tuple[Round137StageCap, ...] = (
    Round137StageCap(
...
ROUND137_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round137ScoreStagePriceAlignment, ...] = (
    Round137ScoreStagePriceAlignment(
...
ROUND137_SCORE_TARGETS: tuple[Round137ScoreTarget, ...] = (
    _target(
...
ROUND137_CASE_CANDIDATES: tuple[Round137CaseCandidate, ...] = (
    Round137CaseCandidate(
        "samyang_buldak_export_rerating_case",
        "EXPORT_RECURRING_CONSUMER",
        "003230",
        "삼양식품 Buldak 수출 리레이팅",
        ...
        ("round_137.md MarketWatch Samyang Buldak target revision",),
    ...
    Round137CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_137.md AP Samyang Denmark recall",),
    ...
    Round137CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_137.md AP Samyang Denmark partial reversal",),
    ...
    Round137CaseCandidate(
        ...
        ("round_137.md K-food hero to portfolio expansion framework",),
    ...
    Round137CaseCandidate(
        ...
        ("round_137.md Reuters K-beauty US export",),
    ...
    Round137CaseCandidate(
        ...
        ("round_137.md Reuters Olive Young US retail platform",),
    ...
    Round137CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_137.md AP K-beauty US tariff risk",),
    ...
    Round137CaseCandidate(
        ...
        ("round_137.md K-beauty offline sell-through framework",),
    ...
    Round137CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_137.md FT APR beauty device",),
    ...
    Round137CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_137.md Vogue Medicube omnichannel",),
    ...
    Round137CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_137.md Reuters K-beauty fast beauty OEM/ODM",),
    ...
    Round137CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_137.md Barron's Coupang data breach",),
    ...
    Round137CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_137.md Reuters Coupang supplier regulation",),
    ...
    Round137CaseCandidate(
        ...
        "needs_source_date_and_price_backfill",
        ("round_137.md Coway rental model reference",),
    ...
    Round137CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_137.md Barron's Whirlpool dividend suspension",),
    ...
    Round137CaseCandidate(
        ...
        ("round_137.md Reuters Shein Temu litigation",),
    ...
    Round137CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_137.md FT France EU Shein Temu crackdown",),
...
ROUND137_PRICE_FIELDS: tuple[str, ...] = (
...
def round137_target_for(target_id: str) -> Round137ScoreTarget | None:
    for target in ROUND137_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round137_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND137_CASE_CANDIDATES:
        target = round137_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round137 R5 Loop-8 case for {candidate.target_id}; "
...
def round137_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round137_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND137_CASE_CANDIDATES:
        target = round137_target_for(candidate.target_id)
...
def round137_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round137_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round137_backfill": "true"} for field in ROUND137_PRICE_FIELDS)


def round137_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND137_BASE_SCORE_WEIGHTS
    )


def round137_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND137_STAGE_CAPS
    )


def round137_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND137_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round137_summary() -> dict[str, int | bool]:
    records = round137_case_records()
    return {
        "target_count": len(ROUND137_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND137_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND137_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND137_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND137_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND137_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND137_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND137_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round137_r5_loop8_reports(
    *,
    output_directory: str | Path = ROUND137_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND137_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND137_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round137_r5_loop8_consumer_retail_brand_summary.md",
        "case_matrix": output / "round137_r5_loop8_case_matrix.csv",
        "stage_date_plan": output / "round137_r5_loop8_stage_date_plan.csv",
        "green_guardrails": output / "round137_r5_loop8_green_guardrails.md",
        "risk_overlays": output / "round137_r5_loop8_risk_overlays.md",
        "price_validation_plan": output / "round137_r5_loop8_price_validation_plan.md",
        "price_fields": output / "round137_r5_loop8_price_fields.csv",
        "base_score_weights": output / "round137_r5_loop8_base_score_weights.csv",
        "stage_caps": output / "round137_r5_loop8_stage_caps.csv",
        "score_stage_price_alignment": output / "round137_r5_loop8_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round137_r5_loop8_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round137_case_records(), cases)
    _write_rows(round137_score_profile_rows(), score_profiles)
    _write_rows(round137_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round137_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round137_price_field_rows(), paths["price_fields"])
    _write_rows(round137_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round137_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round137_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round137_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round137_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round137_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round137_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round137_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round137_summary_markdown() -> str:
    summary = round137_summary()
    lines = [
        "# Round-137 R5 Loop-8 Consumer / Retail / Brand Summary",
        "",
        f"- source_round: `{ROUND137_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R5 Loop 8 says brand buzz and recurring FCF are different things.",
...
def render_round137_green_guardrail_markdown() -> str:
    lines = [
        "# Round-137 R5 Loop-8 Green Guardrails",
        "",
    ...
    for target in ROUND137_SCORE_TARGETS:
        lines.append(
            ...
            f"{', '.join(target.green_conditions) or 'not_applicable'} | {', '.join(target.loop8_penalty_axes)} |"
        )
    lines.extend(
        [
            "",
            "## What Not To Change",
            "",
            "- Do not apply R5 Loop-8 v8.0 weights to production scoring yet.",
...
def render_round137_risk_overlay_markdown() -> str:
    lines = [
        "# Round-137 R5 Loop-8 Risk Overlays",
        "",
...
def render_round137_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-137 R5 Loop-8 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round137_case_candidate_rows():
...
def render_round137_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-137 R5 Loop-8 Score / Stage / Price Alignment",
        "",
        "Round 137 checks whether consumer, retail, and brand score interpretation matches the observed price and operating path.",
...
def _score_price_alignment(candidate: Round137CaseCandidate) -> str:
...
def _rerating_result(candidate: Round137CaseCandidate) -> str:
...
def _score_weight_hint(target: Round137ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND137_CASE_CANDIDATES",
    "ROUND137_DEFAULT_CASES_PATH",
    "ROUND137_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND137_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND137_PRICE_FIELDS",
    "ROUND137_BASE_SCORE_WEIGHTS",
    "ROUND137_SCORE_TARGETS",
    "ROUND137_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND137_STAGE_CAPS",
    "Round137BaseScoreWeight",
    "Round137CaseCandidate",
    "Round137ScoreStagePriceAlignment",
    ...
    "Round137ScoreWeightDraft",
    "Round137StageCap",
    "render_round137_green_guardrail_markdown",
    "render_round137_price_validation_plan_markdown",
    "render_round137_risk_overlay_markdown",
    "render_round137_score_stage_price_alignment_markdown",
    "render_round137_summary_markdown",
    "round137_base_score_weight_rows",
    "round137_case_candidate_rows",
    "round137_case_records",
    "round137_price_field_rows",
    "round137_score_profile_rows",
    "round137_score_stage_price_alignment_rows",
    "round137_stage_cap_rows",
    "round137_stage_date_rows",
    "round137_summary",
    "round137_target_for",
    "write_round137_r5_loop8_reports",
]
