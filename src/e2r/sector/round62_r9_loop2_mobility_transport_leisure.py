"""Round-62 R9 Loop-2 mobility, transport, and leisure pack.

Round 62 tightens the Round-49 R9 pack. It separates auto value-up and
...
ROUND62_SOURCE_ROUND_PATH = "docs/round/round_62.md"
ROUND62_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round62_r9_loop2_mobility_transport_leisure"
ROUND62_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r9_loop2_round62.jsonl"
ROUND62_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round62_r9_loop2_v2.csv"


@dataclass(frozen=True)
class Round62ScoreWeightDraft:
    eps_fcf: int
...
@dataclass(frozen=True)
class Round62ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round62ScoreWeightDraft
...
ROUND62_SCORE_TARGETS: tuple[Round62ScoreTarget, ...] = (
    Round62ScoreTarget(
        "AUTO_MOBILITY_COMPLETED_VEHICLE",
        E2RArchetype.AUTO_MOBILITY_COMPLETED_VEHICLE,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round62ScoreWeightDraft(20, 18, 10, 15, 17, 10, 5),
        ...
        "Completed vehicles can be Green only when hybrid/mix, OPM, FCF, and capital return are source-backed.",
    ),
    Round62ScoreTarget(
        "AUTO_MOBILITY_COMPONENTS",
        E2RArchetype.AUTO_MOBILITY_COMPONENTS,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(20, 18, 11, 14, 14, 3, 5),
        ("hybrid_component_demand", "electronics_component", "lighting_or_adas_demand"),
        ("customer_delivery", "component_bottleneck", "customer_diversification", "opm_improvement", "cost_pass_through"),
        ("high_value_mix", "repeat_program_visibility", "fcf_improvement", "quality_cost_low"),
        ("hybrid_component_bottleneck_crowded", "component_group_multiple_expansion"),
        ("customer_concentration", "raw_material_cost_spike", "bottleneck_normalization", "quality_cost"),
        ("customer_delivery", "component_bottleneck", "cost_pass_through", "op_eps_revision"),
        ...
        "Hybrid components can improve, but customer delivery, margin, and cost pass-through decide Stage 2+.",
    ),
    Round62ScoreTarget(
        "AUTO_COMPONENTS_EV_ADAS",
        E2RArchetype.AUTO_COMPONENTS_EV_ADAS,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(18, 16, 9, 13, 11, 0, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(17, 12, 12, 10, 9, 2, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(18, 14, 5, 12, 10, 2, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(17, 13, 5, 12, 10, 1, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(18, 13, 5, 12, 10, 2, 5),
    ...
    Round62ScoreTarget(
        ...
        Round62ScoreWeightDraft(20, 7, 18, 8, 7, 0, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(18, 15, 6, 12, 10, 2, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(16, 13, 6, 11, 9, 1, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round62ScoreWeightDraft(16, 13, 6, 11, 8, 1, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round62ScoreWeightDraft(9, 9, 6, 12, 6, 0, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round62ScoreWeightDraft(14, 13, 8, 12, 9, 0, 5),
    ...
    Round62ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round62ScoreWeightDraft(18, 20, 10, 13, 11, 2, 5),
...
ROUND62_CASE_CANDIDATES: tuple[Round62CaseCandidate, ...] = (
    Round62CaseCandidate(
        ...
        ("round_62.md Reuters Hyundai hybrid expansion and shareholder return",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Hyundai US output and margin goal cut",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Toyota hybrid bottleneck",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Korean Air record revenue and integration",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters China group visa-free entry",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters SES airline connectivity",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Maersk unsustainable container rates", "round_62.md Reuters falling ocean rates",),
        "Shipping freight spikes are cyclical unless contract rates and supply discipline persist.",
    ),
    Round62CaseCandidate(
        "maersk_suez_route_normalization_case",
        "SHIPPING_FREIGHT_CYCLE",
        "MAERSK-B.CO",
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Maersk Suez Canal sailings",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Axios Hertz sells 20,000 EVs",),
        "EV fleet transition breaks if residual value, repair cost, insurance, and utilization do not work.",
    ),
    Round62CaseCandidate(
        "hertz_additional_ev_charge_case",
        "RENTAL_USED_CAR_MOBILITY",
        "HTZ",
        "Hertz additional EV charge and stock drop",
        "US",
        "4c_thesis_break",
        date(2024, 4, 25),
        None,
        ...
        date(2024, 4, 25),
        ("ev_fleet_ratio",),
        ("vehicle_depreciation_charge", "repair_cost_per_vehicle", "residual_value_drop", "fleet_write_down"),
        "rental_ev_additional_unit_economics_4c",
        "needs_price_backfill",
        ("round_62.md Investopedia Hertz EV plan loss",),
        "Repeated EV fleet charges confirm that the issue is unit economics, not just headline EV demand.",
    ),
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Michelin annual outlook cut",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md MarketWatch Lime IPO filing",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Joby discounted offering",),
    ...
    Round62CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_62.md Reuters Lilium cash crunch",),
...
ROUND62_RISK_OVERLAYS: tuple[str, ...] = (
...
def target_for(target_id: str) -> Round62ScoreTarget | None:
...
def round62_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND62_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round62 R9 Loop-2 case for {candidate.target_id}; "
...
def round62_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round62_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND62_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round62_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round62_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round62_backfill": "true"} for field in ROUND62_PRICE_FIELDS)


def round62_summary() -> dict[str, int | bool]:
    records = round62_case_records()
    return {
        "target_count": len(ROUND62_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND62_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND62_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND62_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round62_r9_loop2_reports(
    *,
    output_directory: str | Path = ROUND62_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND62_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND62_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round62_r9_loop2_mobility_transport_leisure_summary.md",
        "case_matrix": output / "round62_r9_loop2_case_matrix.csv",
        "stage_date_plan": output / "round62_r9_loop2_stage_date_plan.csv",
        "green_guardrails": output / "round62_r9_loop2_green_guardrails.md",
        "risk_overlays": output / "round62_r9_loop2_risk_overlays.md",
        "price_validation_plan": output / "round62_r9_loop2_price_validation_plan.md",
        "price_fields": output / "round62_r9_loop2_price_fields.csv",
    }
    _write_case_jsonl(round62_case_records(), cases)
    _write_rows(round62_score_profile_rows(), score_profiles)
    _write_rows(round62_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round62_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round62_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round62_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round62_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round62_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round62_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round62_summary_markdown() -> str:
    summary = round62_summary()
    lines = [
        "# Round 62 R9 Loop-2 Mobility/Transport/Leisure Summary",
        "",
        "Round 62 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round62_green_guardrail_markdown() -> str:
    lines = [
        "# Round 62 R9 Loop-2 Green Guardrails",
        "",
        "- Do not apply R9 Loop-2 v2.0 weights to production scoring yet.",
...
def render_round62_risk_overlay_markdown() -> str:
    lines = ["# Round 62 R9 Loop-2 Risk Overlays", ""]
    for overlay in ROUND62_RISK_OVERLAYS:
...
def render_round62_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round62_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND62_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round62CaseCandidate) -> str:
...
def _rerating_result(candidate: Round62CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round62ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
