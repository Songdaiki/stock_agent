"""Round-158 R13 Loop-9 cross-archetype RedTeam / 4B / price validation pack.

Round 158 is a common validation layer over the R1-R12 sector/archetype work.
...
ROUND158_SOURCE_ROUND_PATH = "docs/round/round_158.md"
ROUND158_LARGE_SECTOR = "CROSS_ARCHETYPE_REDTEAM_4B_PRICE_VALIDATION"
ROUND158_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round158_r13_loop9_cross_archetype_redteam"
ROUND158_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r13_loop9_round158.jsonl"
ROUND158_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round158_r13_loop9_v9.csv"


@dataclass(frozen=True)
class Round158OverlayWeightDraft:
    eps_fcf: str
...
@dataclass(frozen=True)
class Round158OverlayTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round158OverlayWeightDraft
...
ROUND158_OVERLAY_AXES: tuple[Round158OverlayAxis, ...] = (
    Round158OverlayAxis(
...
ROUND158_STAGE_CAPS: tuple[Round158StageCap, ...] = (
    Round158StageCap(
...
ROUND158_OVERLAY_TARGETS: tuple[Round158OverlayTarget, ...] = (
    Round158OverlayTarget(
        "STRUCTURAL_SUCCESS_ALIGNED",
        E2RArchetype.STRUCTURAL_SUCCESS_ALIGNED,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round158OverlayWeightDraft("+", "+", "+", "+", "+", "optional", "+", "pass_if_no_redteam"),
    ...
    Round158OverlayTarget(
        ...
        Round158OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "stage4b_watch"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round158OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "policy_4b_overlay"),
    ...
    Round158OverlayTarget(
        ...
        Round158OverlayWeightDraft("0", "0", "0", "-", "-", "0", "-", "green_block"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round158OverlayWeightDraft("0~+", "0", "0", "+", "0", "0", "medium", "event_split"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round158OverlayWeightDraft("+", "+", "optional", "+", "optional", "0", "+", "stage2_candidate"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round158OverlayWeightDraft("+", "low", "+", "0", "low", "0", "medium", "cycle_cap"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("-", "-", "-", "-", "-", "0", "-", "score_recalibration"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round158OverlayWeightDraft("+", "+", "optional", "0", "-", "optional", "+", "alignment_review"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_block"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_review"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_soft_gate"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("-", "-", "0", "-", "-", "-", "medium", "green_block"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("hard-", "hard-", "0", "hard-", "hard-", "hard-", "+", "hard_4c"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_hard_review"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_infra_hard_review"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "ai_infra_hard_review"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "policy_price_path_shock"),
        (
            "tax_policy_comment",
            "ai_windfall_tax",
            "citizen_dividend",
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+", "stage3_confidence_cap"),
    ...
    Round158OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round158OverlayWeightDraft("0", "0", "0", "0", "0", "0", "low", "green_block"),
...
ROUND158_CASE_CANDIDATES: tuple[Round158CaseCandidate, ...] = (
    Round158CaseCandidate(
        ...
        ("round_158.md Reuters SK Hynix AI boom / market value",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Hyundai sales target / hybrid / buyback",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Korea Commercial Act revision",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Circle reserve income / USDC circulation",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Blackstone data-center vehicle IPO",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Fermi AI data-center IPO",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md event-to-contract escalation rule",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Barron's Korea AI tax / KOSPI shock",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Nvidia / CoreWeave financing and capacity relationship",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md AP SMCI auditor resignation",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters CrowdStrike outage and lawsuit",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters TerraUSD/Luna collapse",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters bluebird bio cash crunch",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Novo GLP-1 guide down",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Hindenburg Equinix short report",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Equinix capex / AFFO per share disappointment",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md disclosure confidence cap rule",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md price-only rally definition",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md event premium bucket",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md cyclical success rule",),
    ...
    Round158CaseCandidate(
        ...
        "false_positive_score",
        "needs_price_backfill",
        ("round_158.md false-positive score rule",),
    ...
    Round158CaseCandidate(
        ...
        "evidence_good_but_price_failed",
        "needs_price_backfill",
        ("round_158.md evidence-good price-failed rule",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md legal/regulatory RedTeam rule",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md leverage/FCF breakdown rule",),
    ...
    Round158CaseCandidate(
        ...
        "unknown_insufficient_evidence",
        "needs_price_backfill",
        ("round_158.md insufficient evidence rule",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters GE Vernova outlook and backlog",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md R13 structural success list",),
    ...
    Round158CaseCandidate(
        "fortinet_ai_security_billings_structural_case",
        "STRUCTURAL_SUCCESS_ALIGNED",
        "FTNT",
        "Fortinet",
        "US",
        ...
        None,
        None,
        ("ai_driven_cyber_threat", "billings_growth", "revenue_growth", "eps_or_margin_validation_candidate"),
        ("security_budget_slowdown", "platform_competition", "multiple_expansion_ahead_of_eps"),
        "ai_security_demand_needs_billings_fcf_and_price_validation",
        "needs_price_backfill",
        ("round_158.md MarketWatch Fortinet AI threat and billings",),
        "AI security can pass R13 only when cyber demand turns into billings, revenue, EPS/FCF, and price-path validation.",
        (E2RArchetype.CYBERSECURITY_AI_THREAT_DEMAND, E2RArchetype.PLATFORM_SOFTWARE_INTERNET),
    ),
    Round158CaseCandidate(
        "cisco_ai_networking_orders_structural_case",
        "STRUCTURAL_SUCCESS_ALIGNED",
        "CSCO",
        "Cisco AI networking orders",
        "US",
        "success_candidate",
        None,
        None,
        ...
        None,
        None,
        ("hyperscaler_ai_orders", "networking_backlog", "guidance_raise", "price_path_candidate"),
        ("order_timing_risk", "customer_capex_slowdown", "margin_mix_risk"),
        "ai_networking_orders_need_revenue_margin_and_price_validation",
        "needs_price_backfill",
        ("round_158.md Investors Cisco AI networking orders",),
        "AI networking is not a theme-only case when hyperscaler orders and guidance are visible, but Stage 3 still needs revenue, margin, FCF, and price validation.",
        (E2RArchetype.AI_NETWORKING_SWITCHING_INFRA, E2RArchetype.AI_DATA_CENTER_INFRASTRUCTURE),
    ),
    Round158CaseCandidate(
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Reuters Bavarian Nordic stockpile contract and guidance",),
    ...
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md Stage 2 but not Green list",),
    ...
    Round158CaseCandidate(
        "bayer_crop_science_seed_ip_ebitda_stage2_case",
        "EVENT_TO_CONTRACT_ESCALATION",
        "BAYN",
        "Bayer Crop Science",
        "DE",
        ...
        None,
        None,
        ("seed_ip_licensing", "licensing_dispute_resolution", "crop_science_ebitda_growth", "litigation_cost_control"),
        ("roundup_litigation", "patent_or_regulatory_risk", "repeat_licensing_unproven"),
        "agri_input_ip_licensing_stage2_until_repeat_fcf_validation",
        "needs_price_backfill",
        ("round_158.md Reuters Bayer Crop Science soy seed licensing EBITDA",),
        "Agriculture input stories can reach Stage 2 when seed/IP licensing converts into EBITDA, but Stage 3 waits for repeat licensing revenue, litigation cost control, FCF, and price-path validation.",
        (E2RArchetype.AGRI_INPUT_SEED_CROP_PROTECTION, E2RArchetype.SMART_FARM_AGRI_TECH),
    ),
    Round158CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_158.md success but 4B list",),
...
ROUND158_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "market",
...
def round158_target_for(target_id: str) -> Round158OverlayTarget | None:
    for target in ROUND158_OVERLAY_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round158_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND158_CASE_CANDIDATES:
        target = round158_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round158 R13 Loop-9 cross-archetype validation case for {candidate.target_id}; "
            ...
            score_price_alignment=_round158_score_price_alignment(candidate),
            rerating_result=_round158_rerating_result(candidate),
            price_pattern=candidate.alignment_hint,
            score_weight_hint=_round158_score_weight_hint(target),
            green_guardrails=(
...
def round158_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round158_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND158_CASE_CANDIDATES:
        target = round158_target_for(candidate.target_id)
...
def round158_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round158_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round158_backfill": "true"} for field in ROUND158_PRICE_FIELDS)


def round158_overlay_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_csv_dict() for axis in ROUND158_OVERLAY_AXES)


def round158_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND158_STAGE_CAPS)


def round158_summary() -> dict[str, int | bool]:
    records = round158_case_records()
    return {
        "target_count": len(ROUND158_OVERLAY_TARGETS),
        "overlay_axis_count": len(ROUND158_OVERLAY_AXES),
        "stage_cap_count": len(ROUND158_STAGE_CAPS),
        ...
        "hard_gate_target_count": sum(1 for target in ROUND158_OVERLAY_TARGETS if target.hard_gate),
        "green_possible_count": sum(1 for target in ROUND158_OVERLAY_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND158_OVERLAY_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND158_OVERLAY_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round158_r13_loop9_reports(
    *,
    output_directory: str | Path = ROUND158_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND158_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND158_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round158_r13_loop9_cross_archetype_redteam_summary.md",
        "case_matrix": output / "round158_r13_loop9_case_matrix.csv",
        "target_matrix": output / "round158_r13_loop9_overlay_target_matrix.csv",
        "stage_date_plan": output / "round158_r13_loop9_stage_date_plan.csv",
        "redteam_gate_plan": output / "round158_r13_loop9_redteam_gate_plan.md",
        "price_validation_plan": output / "round158_r13_loop9_price_validation_plan.md",
        "price_fields": output / "round158_r13_loop9_price_fields.csv",
        "overlay_axes": output / "round158_r13_loop9_overlay_axes.csv",
        "stage_caps": output / "round158_r13_loop9_stage_caps.csv",
    }
    _write_case_jsonl(round158_case_records(), cases)
    _write_rows(round158_score_profile_rows(), score_profiles)
    _write_rows(round158_score_profile_rows(), paths["target_matrix"])
    _write_rows(round158_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round158_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round158_price_field_rows(), paths["price_fields"])
    _write_rows(round158_overlay_axis_rows(), paths["overlay_axes"])
    _write_rows(round158_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round158_summary_markdown(), encoding="utf-8")
    paths["redteam_gate_plan"].write_text(render_round158_redteam_gate_plan_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round158_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round158_summary_markdown() -> str:
    summary = round158_summary()
    lines = [
        "# Round-158 R13 Loop-9 Cross-Archetype RedTeam / 4B / Price Validation",
        "",
        f"- source_round: `{ROUND158_SOURCE_ROUND_PATH}`",
        f"- large_sector: `{ROUND158_LARGE_SECTOR}`",
        ...
        "## Interpretation",
        "",
        "- Round 158 is a common validation overlay, not a sector score-owner.",
        ...
        "",
        "## R13 v9 Cross-Archetype Overlay Axes",
        "",
    ]
    for axis in ROUND158_OVERLAY_AXES:
    ...
    for cap in ROUND158_STAGE_CAPS:
...
def render_round158_redteam_gate_plan_markdown() -> str:
    lines = [
        "# Round-158 R13 Loop-9 RedTeam Gate Plan",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply Round158 overlay symbols to production scoring yet.",
            "- Do not lower Stage 3-Green to improve recall.",
            "- Do not use R13 Loop-9 case records as candidate-generation input.",
...
def render_round158_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round158_case_candidate_rows():
...
def _round158_score_price_alignment(candidate: Round158CaseCandidate) -> str:
...
def _round158_rerating_result(candidate: Round158CaseCandidate) -> str:
...
def _round158_score_weight_hint(target: Round158OverlayTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
        "eps_fcf": _round158_symbolic_weight(weights["eps_fcf"]),
        "visibility": _round158_symbolic_weight(weights["structural_visibility"]),
        "bottleneck": _round158_symbolic_weight(weights["bottleneck_pricing"]),
        "mispricing": _round158_symbolic_weight(weights["market_mispricing"]),
        "valuation": _round158_symbolic_weight(weights["valuation"]),
        "capital_allocation": _round158_symbolic_weight(weights["capital_allocation"]),
        "information_confidence": _round158_symbolic_weight(weights["information_confidence"]),
    }


def _round158_symbolic_weight(value: str) -> float:
    return {
        "+": 1.0,
        "0": 0.0,
        "-": -1.0,
...
__all__ = [
    "ROUND158_CASE_CANDIDATES",
    "ROUND158_DEFAULT_CASES_PATH",
    "ROUND158_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND158_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND158_LARGE_SECTOR",
    "ROUND158_OVERLAY_AXES",
    "ROUND158_OVERLAY_TARGETS",
    "ROUND158_PRICE_FIELDS",
    "ROUND158_STAGE_CAPS",
    "Round158CaseCandidate",
    "Round158OverlayAxis",
    "Round158OverlayTarget",
    "Round158OverlayWeightDraft",
    "Round158StageCap",
    "render_round158_price_validation_plan_markdown",
    "render_round158_redteam_gate_plan_markdown",
    "render_round158_summary_markdown",
    "round158_case_candidate_rows",
    "round158_case_records",
    "round158_overlay_axis_rows",
    "round158_price_field_rows",
    "round158_score_profile_rows",
    "round158_stage_date_rows",
    "round158_stage_cap_rows",
    "round158_summary",
    "round158_target_for",
    "write_round158_r13_loop9_reports",
]
