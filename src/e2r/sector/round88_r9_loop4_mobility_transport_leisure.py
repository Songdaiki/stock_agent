"""Round-88 R9 Loop-4 mobility, transport, and leisure pack.

Round 88 tightens the Round-49 R9 pack. It separates auto value-up and
...
ROUND88_SOURCE_ROUND_PATH = "docs/round/round_88.md"
ROUND88_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round88_r9_loop4_mobility_transport_leisure"
ROUND88_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r9_loop4_round88.jsonl"
ROUND88_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round88_r9_loop4_v4.csv"


@dataclass(frozen=True)
class Round88ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round88ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round88ScoreWeightDraft
...
GATE_WEIGHT = Round88ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND88_SCORE_TARGETS: tuple[Round88ScoreTarget, ...] = (
    Round88ScoreTarget(
        "AUTO_MOBILITY_COMPLETED_VEHICLE",
        E2RArchetype.AUTO_MOBILITY_COMPLETED_VEHICLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(20, 18, 10, 15, 17, 10, 5),
    ...
    Round88ScoreTarget(
        ...
        Round88ScoreWeightDraft(21, 20, 11, 15, 17, 10, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(18, 18, 9, 12, 13, 5, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(20, 18, 11, 14, 14, 3, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(21, 19, 14, 14, 13, 2, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(18, 16, 9, 13, 11, 0, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(17, 17, 10, 15, 10, 0, 6),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(17, 12, 12, 10, 9, 2, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(18, 14, 5, 12, 10, 2, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(17, 13, 5, 12, 10, 1, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(18, 13, 5, 12, 10, 2, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round88ScoreWeightDraft(20, 7, 18, 8, 7, 0, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(18, 15, 6, 12, 10, 2, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(15, 12, 6, 10, 8, 1, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round88ScoreWeightDraft(16, 13, 6, 11, 8, 1, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round88ScoreWeightDraft(8, 8, 6, 12, 6, 0, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round88ScoreWeightDraft(14, 13, 8, 12, 9, 0, 5),
    ...
    Round88ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round88ScoreWeightDraft(19, 21, 10, 13, 11, 2, 5),
...
ROUND88_CASE_CANDIDATES: tuple[Round88CaseCandidate, ...] = (
    Round88CaseCandidate(
        ...
        ("round_88.md Reuters Hyundai hybrid expansion and shareholder return",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Hyundai US output and margin goal cut",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Toyota hybrid bottleneck",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Avride Hyundai robotaxi",),
    ...
    Round88CaseCandidate(
        ...
        "robotaxi_operational_reality_check",
        "needs_price_backfill",
        ("round_88.md Reuters Tesla Texas robotaxi wait times",),
    ...
    Round88CaseCandidate(
        ...
        "robotaxi_safety_4c",
        "needs_price_backfill",
        ("round_88.md Reuters Waymo flooded-road recall",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Waymo Houston expansion",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Korean Air record revenue and integration",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters China group visa-free entry",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Maersk unsustainable container rates", "round_88.md Reuters falling ocean rates",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Axios Hertz sells 20,000 EVs",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Michelin annual outlook cut",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Joby discounted offering",),
    ...
    Round88CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_88.md Reuters Lilium cash crunch",),
...
ROUND88_RISK_OVERLAYS: tuple[str, ...] = (
...
def target_for(target_id: str) -> Round88ScoreTarget | None:
...
def round88_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND88_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round88 R9 Loop-4 case for {candidate.target_id}; "
...
def round88_score_profile_rows() -> tuple[dict[str, str], ...]:
        ...
        rows.append(
            {
                ...
                "loop4_penalty_axes": "|".join(target.loop4_penalty_axes),
...
def round88_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND88_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round88_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round88_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round88_backfill": "true"} for field in ROUND88_PRICE_FIELDS)


def round88_summary() -> dict[str, int | bool]:
    records = round88_case_records()
    return {
        "target_count": len(ROUND88_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND88_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND88_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND88_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND88_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round88_r9_loop4_reports(
    *,
    output_directory: str | Path = ROUND88_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND88_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND88_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round88_r9_loop4_mobility_transport_leisure_summary.md",
        "case_matrix": output / "round88_r9_loop4_case_matrix.csv",
        "stage_date_plan": output / "round88_r9_loop4_stage_date_plan.csv",
        "green_guardrails": output / "round88_r9_loop4_green_guardrails.md",
        "risk_overlays": output / "round88_r9_loop4_risk_overlays.md",
        "price_validation_plan": output / "round88_r9_loop4_price_validation_plan.md",
        "price_fields": output / "round88_r9_loop4_price_fields.csv",
    }
    _write_case_jsonl(round88_case_records(), cases)
    _write_rows(round88_score_profile_rows(), score_profiles)
    _write_rows(round88_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round88_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round88_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round88_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round88_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round88_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round88_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round88_summary_markdown() -> str:
    summary = round88_summary()
    lines = [
        "# Round 88 R9 Loop-4 Mobility/Transport/Leisure Summary",
        "",
        "Round 88 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round88_green_guardrail_markdown() -> str:
    lines = [
        "# Round 88 R9 Loop-4 Green Guardrails",
        "",
        "- Do not apply R9 Loop-4 v4.0 weights to production scoring yet.",
...
def render_round88_risk_overlay_markdown() -> str:
    lines = ["# Round 88 R9 Loop-4 Risk Overlays", ""]
    for overlay in ROUND88_RISK_OVERLAYS:
...
def render_round88_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round88_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND88_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round88CaseCandidate) -> str:
...
def _rerating_result(candidate: Round88CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round88ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
