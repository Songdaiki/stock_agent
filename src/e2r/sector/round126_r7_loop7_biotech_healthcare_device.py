"""Round-126 R7 Loop-7 biotech, healthcare, and medical-device pack.

Round 126 tightens the R7 healthcare pack. It separates approvals, clinical
...
ROUND126_SOURCE_ROUND_PATH = "docs/round/round_126.md"
ROUND126_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round126_r7_loop7_biotech_healthcare_device"
ROUND126_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r7_loop7_round126.jsonl"
ROUND126_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round126_r7_loop7_v7.csv"


@dataclass(frozen=True)
class Round126ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round126ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round126ScoreWeightDraft
...
@dataclass(frozen=True)
class Round126ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
GATE_WEIGHT = Round126ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
CAP_WEIGHT = Round126ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND126_BASE_SCORE_WEIGHTS: tuple[Round126BaseScoreWeight, ...] = (
    Round126BaseScoreWeight(
    ...
    Round126BaseScoreWeight(
        ...
        12,
        "Safety, reimbursement, FDA/DOJ, patent litigation, subgroup validation, and disclosure detail decide confidence.",
    ),
)


ROUND126_STAGE_CAPS: tuple[Round126StageCap, ...] = (
    Round126StageCap(
...
ROUND126_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round126ScoreStagePriceAlignment, ...] = (
    Round126ScoreStagePriceAlignment(
...
ROUND126_SCORE_TARGETS: tuple[Round126ScoreTarget, ...] = (
    Round126ScoreTarget(
        "CDMO_HEALTHCARE_CONTRACT",
        E2RArchetype.CDMO_HEALTHCARE_CONTRACT,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round126ScoreWeightDraft(20, 24, 12, 12, 12, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round126ScoreWeightDraft(19, 21, 12, 12, 11, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(19, 20, 11, 12, 10, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(16, 17, 7, 11, 9, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(18, 18, 6, 12, 9, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(16, 15, 5, 11, 8, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(18, 19, 6, 12, 9, 0, 7),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round126ScoreWeightDraft(22, 20, 12, 13, 8, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(21, 20, 11, 13, 9, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(21, 19, 11, 13, 9, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(18, 15, 5, 13, 7, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round126ScoreWeightDraft(7, 10, 8, 9, 5, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round126ScoreWeightDraft(6, 10, 7, 12, 6, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(18, 17, 8, 13, 12, 0, 7),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(16, 16, 8, 13, 11, 0, 7),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(16, 16, 7, 12, 9, 1, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round126ScoreWeightDraft(15, 13, 5, 10, 8, 0, 6),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round126ScoreWeightDraft(20, 22, 13, 14, 12, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round126ScoreWeightDraft(21, 23, 13, 14, 12, 1, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round126ScoreWeightDraft(19, 20, 12, 13, 11, 0, 5),
    ...
    Round126ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round126ScoreWeightDraft(20, 5, 5, 5, 5, 0, 5),
...
ROUND126_CASE_CANDIDATES: tuple[Round126CaseCandidate, ...] = (
    Round126CaseCandidate(
        "samsung_biologics_gsk_us_facility_case",
        "CDMO_US_TARIFF_HEDGE_CAPACITY",
        "207940",
        ...
        ("round_126.md Reuters Samsung Biologics GSK US facility",),
    ...
    Round126CaseCandidate(
        ...
        ("round_126.md Samsung Biologics CDMO structure reference",),
    ...
    Round126CaseCandidate(
        ...
        ("round_126.md Investors Intuitive Surgical Q1 2026",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Straumann dental implant growth",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Lilly oral GLP-1 approval",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Foundayo switch maintenance",),
    ...
    Round126CaseCandidate(
        ...
        ("round_126.md Reuters Humira biosimilar GoodRx access",),
    ...
    Round126CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_126.md Reuters Cigna Humira biosimilar $0 copay",),
    ...
    Round126CaseCandidate(
        ...
        "glp1_4b_to_4c",
        "needs_price_backfill",
        ("round_126.md Reuters Novo 2026 outlook warning",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Hims GLP-1 revenue miss",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Hims compounded GLP-1 crackdown",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters bluebird bio take-private cash crunch",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Charles River forecast cut",),
        "CRO is service revenue, but funding-cycle cuts can break backlog and forecast visibility.",
        (E2RArchetype.CRO_CLINICAL_SERVICE,),
    ),
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Teladoc record low",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md Reuters Recursion Exscientia merger",),
    ...
    Round126CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_126.md arXiv Lunit DBT subgroup performance",),
    ...
    Round126CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_126.md Reuters Amgen Samsung Bioepis patent litigation",),
    ...
    Round126CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_126.md AP FDA unapproved Botox warning",),
...
ROUND126_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round126_target_for(target_id: str) -> Round126ScoreTarget | None:
    for target in ROUND126_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round126_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND126_CASE_CANDIDATES:
        target = round126_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round126 R7 Loop-7 case for {candidate.target_id}; "
...
def round126_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round126_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND126_CASE_CANDIDATES:
        target = round126_target_for(candidate.target_id)
...
def round126_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round126_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round126_backfill": "true"} for field in ROUND126_PRICE_FIELDS)


def round126_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for item in ROUND126_BASE_SCORE_WEIGHTS
    )


def round126_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": item.cap_id,
        ...
        for item in ROUND126_STAGE_CAPS
    )


def round126_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for item in ROUND126_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round126_summary() -> dict[str, int | bool]:
    records = round126_case_records()
    return {
        "target_count": len(ROUND126_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND126_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND126_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND126_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND126_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND126_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND126_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND126_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round126_r7_loop7_reports(
    *,
    output_directory: str | Path = ROUND126_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND126_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND126_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round126_r7_loop7_biotech_healthcare_device_summary.md",
        "case_matrix": output / "round126_r7_loop7_case_matrix.csv",
        "stage_date_plan": output / "round126_r7_loop7_stage_date_plan.csv",
        "green_guardrails": output / "round126_r7_loop7_green_guardrails.md",
        "risk_overlays": output / "round126_r7_loop7_risk_overlays.md",
        "price_validation_plan": output / "round126_r7_loop7_price_validation_plan.md",
        "price_fields": output / "round126_r7_loop7_price_fields.csv",
        "base_score_weights": output / "round126_r7_loop7_base_score_weights.csv",
        "stage_caps": output / "round126_r7_loop7_stage_caps.csv",
        "score_stage_price_alignment": output / "round126_r7_loop7_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round126_r7_loop7_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round126_case_records(), cases)
    _write_rows(round126_score_profile_rows(), score_profiles)
    _write_rows(round126_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round126_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round126_price_field_rows(), paths["price_fields"])
    _write_rows(round126_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round126_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round126_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round126_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round126_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round126_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round126_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round126_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round126_summary_markdown() -> str:
    summary = round126_summary()
    lines = [
        "# Round-126 R7 Loop-7 Biotech / Healthcare / Medical Device Summary",
        "",
        f"- source_round: `{ROUND126_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R7 Loop 7 says approval, clinical success, AI papers, and TAM are not commercialization by themselves.",
...
def render_round126_green_guardrail_markdown() -> str:
    lines = [
        "# Round-126 R7 Loop-7 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R7 Loop-7 v7.0 weights to production scoring yet.",
...
def render_round126_risk_overlay_markdown() -> str:
    lines = [
        "# Round-126 R7 Loop-7 Risk Overlays",
        "",
...
def render_round126_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-126 R7 Loop-7 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round126_case_candidate_rows():
...
def render_round126_score_stage_price_alignment_markdown() -> str:
    lines = [
...
def _score_price_alignment(candidate: Round126CaseCandidate) -> str:
...
def _rerating_result(candidate: Round126CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round126ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND126_BASE_SCORE_WEIGHTS",
    "ROUND126_CASE_CANDIDATES",
    "ROUND126_DEFAULT_CASES_PATH",
    "ROUND126_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND126_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND126_PRICE_FIELDS",
    "ROUND126_SCORE_TARGETS",
    "ROUND126_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND126_STAGE_CAPS",
    "Round126BaseScoreWeight",
    "Round126CaseCandidate",
    "Round126ScoreStagePriceAlignment",
    "Round126ScoreTarget",
    "Round126ScoreWeightDraft",
    "Round126StageCap",
    "render_round126_green_guardrail_markdown",
    "render_round126_price_validation_plan_markdown",
    "render_round126_risk_overlay_markdown",
    "render_round126_score_stage_price_alignment_markdown",
    "render_round126_summary_markdown",
    "round126_base_score_weight_rows",
    "round126_case_candidate_rows",
    "round126_case_records",
    "round126_price_field_rows",
    "round126_score_stage_price_alignment_rows",
    "round126_score_profile_rows",
    "round126_stage_cap_rows",
    "round126_stage_date_rows",
    "round126_summary",
    "round126_target_for",
