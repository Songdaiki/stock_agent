"""Round-101 R9 Loop-5 mobility, transport, and leisure pack.

Round 101 tightens the Round-88 R9 Loop-4 pack. It separates auto value-up and
...
ROUND101_SOURCE_ROUND_PATH = "docs/round/round_101.md"
ROUND101_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round101_r9_loop5_mobility_transport_leisure"
ROUND101_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r9_loop5_round101.jsonl"
ROUND101_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round101_r9_loop5_v5.csv"


@dataclass(frozen=True)
class Round101ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round101ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round101ScoreWeightDraft
...
GATE_WEIGHT = Round101ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND101_SCORE_TARGETS: tuple[Round101ScoreTarget, ...] = (
    Round101ScoreTarget(
        "AUTO_MOBILITY_COMPLETED_VEHICLE",
        E2RArchetype.AUTO_MOBILITY_COMPLETED_VEHICLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(20, 18, 10, 15, 17, 10, 5),
    ...
    Round101ScoreTarget(
        ...
        Round101ScoreWeightDraft(21, 20, 11, 15, 17, 10, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(18, 18, 9, 12, 13, 5, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(20, 18, 11, 14, 14, 3, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(21, 19, 14, 14, 13, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(18, 16, 9, 13, 11, 0, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(17, 17, 10, 15, 10, 0, 6),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(16, 16, 10, 14, 9, 0, 6),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(17, 12, 12, 10, 9, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(18, 14, 5, 12, 10, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(17, 13, 5, 12, 10, 1, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(18, 13, 5, 12, 10, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round101ScoreWeightDraft(20, 7, 18, 8, 7, 0, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(18, 15, 6, 12, 10, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(15, 12, 6, 10, 8, 1, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round101ScoreWeightDraft(16, 13, 6, 11, 8, 1, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round101ScoreWeightDraft(8, 8, 6, 12, 6, 0, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round101ScoreWeightDraft(14, 13, 8, 12, 9, 0, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round101ScoreWeightDraft(19, 21, 10, 13, 11, 2, 5),
    ...
    Round101ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round101ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND101_CASE_CANDIDATES: tuple[Round101CaseCandidate, ...] = (
    Round101CaseCandidate(
        ...
        ("round_101.md Reuters Hyundai hybrid expansion and shareholder return",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Hyundai US output and margin goal cut",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Toyota hybrid bottleneck",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Avride Hyundai robotaxi",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Axios Uber Avride Dallas autonomous rides",),
    ...
    Round101CaseCandidate(
        ...
        "robotaxi_operational_reality_check",
        "needs_price_backfill",
        ("round_101.md Reuters Tesla Texas robotaxi wait times",),
    ...
    Round101CaseCandidate(
        ...
        "robotaxi_safety_4c",
        "needs_price_backfill",
        ("round_101.md Reuters Waymo flooded-road recall",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md The Verge Aurora first driverless delivery Texas",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters GM hires Aurora cofounder as chief product officer",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Korean Air record revenue and integration",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters China group visa-free entry",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters SES airline connectivity",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Maersk unsustainable container rates", "round_101.md Reuters falling ocean rates",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Axios Hertz sells 20,000 EVs",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Michelin annual outlook cut",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Joby discounted offering",),
    ...
    Round101CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_101.md Reuters Lilium cash crunch",),
...
ROUND101_RISK_OVERLAYS: tuple[str, ...] = (
...
def target_for(target_id: str) -> Round101ScoreTarget | None:
    for target in ROUND101_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round101_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND101_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round101 R9 Loop-5 case for {candidate.target_id}; "
...
def round101_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round101_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND101_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round101_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round101_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round101_backfill": "true"} for field in ROUND101_PRICE_FIELDS)


def round101_summary() -> dict[str, int | bool]:
    records = round101_case_records()
    return {
        "target_count": len(ROUND101_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND101_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND101_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND101_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND101_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round101_r9_loop5_reports(
    *,
    output_directory: str | Path = ROUND101_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND101_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND101_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round101_r9_loop5_mobility_transport_leisure_summary.md",
        "case_matrix": output / "round101_r9_loop5_case_matrix.csv",
        "stage_date_plan": output / "round101_r9_loop5_stage_date_plan.csv",
        "green_guardrails": output / "round101_r9_loop5_green_guardrails.md",
        "risk_overlays": output / "round101_r9_loop5_risk_overlays.md",
        "price_validation_plan": output / "round101_r9_loop5_price_validation_plan.md",
        "price_fields": output / "round101_r9_loop5_price_fields.csv",
    }
    _write_case_jsonl(round101_case_records(), cases)
    _write_rows(round101_score_profile_rows(), score_profiles)
    _write_rows(round101_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round101_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round101_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round101_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round101_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round101_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round101_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round101_summary_markdown() -> str:
    summary = round101_summary()
    lines = [
        "# Round 101 R9 Loop-5 Mobility/Transport/Leisure Summary",
        "",
        "Round 101 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round101_green_guardrail_markdown() -> str:
    lines = [
        "# Round 101 R9 Loop-5 Green Guardrails",
        "",
        "- Do not apply R9 Loop-5 v5.0 weights to production scoring yet.",
...
def render_round101_risk_overlay_markdown() -> str:
    lines = ["# Round 101 R9 Loop-5 Risk Overlays", ""]
    for overlay in ROUND101_RISK_OVERLAYS:
...
def render_round101_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 101 R9 Loop-5 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round101_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND101_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round101CaseCandidate) -> str:
...
def _rerating_result(candidate: Round101CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round101ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
